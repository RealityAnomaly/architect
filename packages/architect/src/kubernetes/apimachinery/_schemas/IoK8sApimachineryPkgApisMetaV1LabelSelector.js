...
const schema1 = {"items":{"$ref":"RV9y23WJI2kBEked4bcKFPvspq_6WSWbPBUFjHCHgYY"},"type":"array","nullable":true};
const schema2 = {"$ref":"io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement#"};
const schema3 = {};

import { validate as validate3 } from "./IoK8sApimachineryPkgApisMetaV1LabelSelectorRequirement.js";
...
/*# sourceURL="io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelector" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
...
const _errs1 = errors;
if(!(validate1(data0, {instancePath:instancePath+"/matchExpressions",parentData:data,parentDataProperty:"matchExpressions",rootData}))){
...
const _errs2 = errors;
if(!(validate7(data1, {instancePath:instancePath+"/matchLabels",parentData:data,parentDataProperty:"matchLabels",rootData}))){
