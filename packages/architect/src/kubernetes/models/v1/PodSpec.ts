import { IIoK8sApiCoreV1Affinity } from "./Affinity.ts";
import { IIoK8sApiCoreV1Container } from "./Container.ts";
import { IIoK8sApiCoreV1PodDNSConfig } from "./PodDNSConfig.ts";
import { IIoK8sApiCoreV1EphemeralContainer } from "./EphemeralContainer.ts";
import { IIoK8sApiCoreV1HostAlias } from "./HostAlias.ts";
import { IIoK8sApiCoreV1LocalObjectReference } from "./LocalObjectReference.ts";
import { IIoK8sApiCoreV1PodOS } from "./PodOS.ts";
import { IIoK8sApimachineryPkgApiResourceQuantity } from "../../apimachinery/api/resource/Quantity.ts";
import { IIoK8sApiCoreV1PodReadinessGate } from "./PodReadinessGate.ts";
import { IIoK8sApiCoreV1PodResourceClaim } from "./PodResourceClaim.ts";
import { IIoK8sApiCoreV1ResourceRequirements } from "./ResourceRequirements.ts";
import { IIoK8sApiCoreV1PodSchedulingGate } from "./PodSchedulingGate.ts";
import { IIoK8sApiCoreV1PodSchedulingGroup } from "./PodSchedulingGroup.ts";
import { IIoK8sApiCoreV1PodSecurityContext } from "./PodSecurityContext.ts";
import { IIoK8sApiCoreV1Toleration } from "./Toleration.ts";
import { IIoK8sApiCoreV1TopologySpreadConstraint } from "./TopologySpreadConstraint.ts";
import { IIoK8sApiCoreV1Volume } from "./Volume.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/architect/kubernetes/types/model";
import { ValidateFunc } from "@glassway/architect/kubernetes/validate";
import { validate } from "../_schemas/IoK8sApiCoreV1PodSpec.js";
 ...
 */
"schedulingGroup"?: IIoK8sApiCoreV1PodSchedulingGroup;
/**
 ...
 * PodSpec is a description of a pod.
 */
export class PodSpec extends Model<IPodSpec> implements IPodSpec {
  "activeDeadlineSeconds"?: number;
"affinity"?: IIoK8sApiCoreV1Affinity;
"automountServiceAccountToken"?: boolean;
"containers": Array<IIoK8sApiCoreV1Container>;
...
setValidateFunc(PodSpec, validate as ValidateFunc<IPodSpec>);

export type {
  IPodSpec as IIoK8sApiCoreV1PodSpec,
  PodSpec as IoK8sApiCoreV1PodSpec
};
