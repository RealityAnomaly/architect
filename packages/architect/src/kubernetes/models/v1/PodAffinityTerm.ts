...
import { validate } from "../_schemas/IoK8sApiCoreV1PodAffinityTerm.js";
 ...
 * Defines a set of pods (namely those matching the labelSelector relative to the given namespace(s)) that this pod should be co-located (affinity) or not co-located (anti-affinity) with, where co-located is defined as running on a node whose value of the label with key <topologyKey> matches that of any node on which a pod of the set of pods is running
 */
export class PodAffinityTerm extends Model<IPodAffinityTerm> implements IPodAffinityTerm {
  "labelSelector"?: IIoK8sApimachineryPkgApisMetaV1LabelSelector;
"matchLabelKeys"?: Array<string>;
"mismatchLabelKeys"?: Array<string>;
"namespaceSelector"?: IIoK8sApimachineryPkgApisMetaV1LabelSelector;
...
setValidateFunc(PodAffinityTerm, validate as ValidateFunc<IPodAffinityTerm>);

export type {
  IPodAffinityTerm as IIoK8sApiCoreV1PodAffinityTerm,
  PodAffinityTerm as IoK8sApiCoreV1PodAffinityTerm
};
