...
import { validate } from "../../_schemas/IoK8sApiResourceV1alpha3ResourcePoolStatusRequest.js";
...
static is = createTypeMetaGuard<IResourcePoolStatusRequest>(ResourcePoolStatusRequest);
