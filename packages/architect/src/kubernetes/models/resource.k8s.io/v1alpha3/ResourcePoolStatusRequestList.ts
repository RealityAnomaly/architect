...
import { validate } from "../../_schemas/IoK8sApiResourceV1alpha3ResourcePoolStatusRequestList.js";
...
static is = createTypeMetaGuard<IResourcePoolStatusRequestList>(ResourcePoolStatusRequestList);
