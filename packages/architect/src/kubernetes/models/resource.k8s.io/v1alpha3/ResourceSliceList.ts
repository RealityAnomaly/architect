import { IIoK8sApiResourceV1alpha3ResourceSlice } from "./ResourceSlice.ts";
import { IIoK8sApimachineryPkgApisMetaV1ListMeta } from "../../../apimachinery/apis/meta/v1/ListMeta.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/architect/kubernetes/types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/architect/kubernetes/types/meta";
import { ValidateFunc } from "@glassway/architect/kubernetes/validate";
import { validate } from "../../_schemas/IoK8sApiResourceV1alpha3ResourceSliceList.js";
 ...
 */
"items": Array<IIoK8sApiResourceV1alpha3ResourceSlice>;
...
static apiVersion: IResourceSliceList["apiVersion"] = "resource.k8s.io/v1alpha3";
static kind: IResourceSliceList["kind"] = "ResourceSliceList";
static is = createTypeMetaGuard<IResourceSliceList>(ResourceSliceList);
...
export type {
  IResourceSliceList as IIoK8sApiResourceV1alpha3ResourceSliceList,
  ResourceSliceList as IoK8sApiResourceV1alpha3ResourceSliceList
};
