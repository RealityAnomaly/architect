...
import { validate } from "../../_schemas/IoK8sApiStorageV1beta1StorageClass.js";
...
static apiVersion: IStorageClass["apiVersion"] = "storage.k8s.io/v1beta1";
static kind: IStorageClass["kind"] = "StorageClass";
static is = createTypeMetaGuard<IStorageClass>(StorageClass);
...
export type {
  IStorageClass as IIoK8sApiStorageV1beta1StorageClass,
  StorageClass as IoK8sApiStorageV1beta1StorageClass
};
