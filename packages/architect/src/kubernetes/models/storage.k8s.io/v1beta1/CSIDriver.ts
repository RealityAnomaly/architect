...
import { IIoK8sApiStorageV1beta1CSIDriverSpec } from "./CSIDriverSpec.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/architect/kubernetes/types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/architect/kubernetes/types/meta";
import { ValidateFunc } from "@glassway/architect/kubernetes/validate";
import { validate } from "../../_schemas/IoK8sApiStorageV1beta1CSIDriver.js";
...
static is = createTypeMetaGuard<ICSIDriver>(CSIDriver);
...
export type {
  ICSIDriver as IIoK8sApiStorageV1beta1CSIDriver,
  CSIDriver as IoK8sApiStorageV1beta1CSIDriver
};
