import { IIoK8sApiStorageV1alpha1VolumeAttributesClass } from "./VolumeAttributesClass.ts";
import { IIoK8sApimachineryPkgApisMetaV1ListMeta } from "../../../apimachinery/apis/meta/v1/ListMeta.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/architect/kubernetes/types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/architect/kubernetes/types/meta";
import { ValidateFunc } from "@glassway/architect/kubernetes/validate";
import { validate } from "../../_schemas/IoK8sApiStorageV1alpha1VolumeAttributesClassList.js";
 ...
 */
"items": Array<IIoK8sApiStorageV1alpha1VolumeAttributesClass>;
...
static apiVersion: IVolumeAttributesClassList["apiVersion"] = "storage.k8s.io/v1alpha1";
static kind: IVolumeAttributesClassList["kind"] = "VolumeAttributesClassList";
static is = createTypeMetaGuard<IVolumeAttributesClassList>(VolumeAttributesClassList);
...
export type {
  IVolumeAttributesClassList as IIoK8sApiStorageV1alpha1VolumeAttributesClassList,
  VolumeAttributesClassList as IoK8sApiStorageV1alpha1VolumeAttributesClassList
};
