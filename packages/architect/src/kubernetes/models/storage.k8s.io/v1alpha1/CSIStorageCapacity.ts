...
import { validate } from "../../_schemas/IoK8sApiStorageV1alpha1CSIStorageCapacity.js";
 ...
 * They are consumed by the kube-scheduler if the CSIStorageCapacity beta feature gate is enabled there and a CSI driver opts into capacity-aware scheduling with CSIDriver.StorageCapacity.
 */
export class CSIStorageCapacity extends Model<ICSIStorageCapacity> implements ICSIStorageCapacity {
...
static apiVersion: ICSIStorageCapacity["apiVersion"] = "storage.k8s.io/v1alpha1";
static kind: ICSIStorageCapacity["kind"] = "CSIStorageCapacity";
static is = createTypeMetaGuard<ICSIStorageCapacity>(CSIStorageCapacity);
...
constructor(data?: ModelData<ICSIStorageCapacity>) {
  ...
  this.setDefinedProps({
    ...
    ...data
  } as ICSIStorageCapacity);
}
}

setValidateFunc(CSIStorageCapacity, validate as ValidateFunc<ICSIStorageCapacity>);

export type {
  ICSIStorageCapacity as IIoK8sApiStorageV1alpha1CSIStorageCapacity,
  CSIStorageCapacity as IoK8sApiStorageV1alpha1CSIStorageCapacity
};
