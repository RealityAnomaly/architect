...
import { IIoK8sApiExtensionsV1beta1DeploymentStrategy } from "./DeploymentStrategy.ts";
import { IIoK8sApiCoreV1PodTemplateSpec } from "../../v1/PodTemplateSpec.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/architect/kubernetes/types/model";
import { ValidateFunc } from "@glassway/architect/kubernetes/validate";
import { validate } from "../../_schemas/IoK8sApiExtensionsV1beta1DeploymentSpec.js";
 ...
 * DeploymentSpec is the specification of the desired behavior of the Deployment.
 */
export class DeploymentSpec extends Model<IDeploymentSpec> implements IDeploymentSpec {
  "minReadySeconds"?: number;
"paused"?: boolean;
"progressDeadlineSeconds"?: number;
"replicas"?: number;
...
setValidateFunc(DeploymentSpec, validate as ValidateFunc<IDeploymentSpec>);

export type {
  IDeploymentSpec as IIoK8sApiExtensionsV1beta1DeploymentSpec,
  DeploymentSpec as IoK8sApiExtensionsV1beta1DeploymentSpec
};
