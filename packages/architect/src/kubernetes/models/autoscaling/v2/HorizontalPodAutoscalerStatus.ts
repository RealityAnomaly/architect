import { IIoK8sApiAutoscalingV2HorizontalPodAutoscalerCondition } from "./HorizontalPodAutoscalerCondition.ts";
import { IIoK8sApiAutoscalingV2MetricStatus } from "./MetricStatus.ts";
import { IIoK8sApimachineryPkgApisMetaV1Time } from "../../../apimachinery/apis/meta/v1/Time.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/architect/kubernetes/types/model";
import { ValidateFunc } from "@glassway/architect/kubernetes/validate";
import { validate } from "../../_schemas/IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus.js";
...
export type {
  IHorizontalPodAutoscalerStatus as IIoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus,
  HorizontalPodAutoscalerStatus as IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus
};
