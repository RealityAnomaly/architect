import { IIoK8sApiAutoscalingV2HPAScalingPolicy } from "./HPAScalingPolicy.ts";
import { IIoK8sApimachineryPkgApiResourceQuantity } from "../../../apimachinery/api/resource/Quantity.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/architect/kubernetes/types/model";
import { ValidateFunc } from "@glassway/architect/kubernetes/validate";
import { validate } from "../../_schemas/IoK8sApiAutoscalingV2HPAScalingRules.js";
 ...
 */
"tolerance"?: IIoK8sApimachineryPkgApiResourceQuantity;
}
 ...
 * The tolerance is applied to the metric values and prevents scaling too eagerly for small metric variations. (Note that setting a tolerance requires the beta HPAConfigurableTolerance feature gate to be enabled.)
 */
export class HPAScalingRules extends Model<IHPAScalingRules> implements IHPAScalingRules {
  "policies"?: Array<IIoK8sApiAutoscalingV2HPAScalingPolicy>;
"selectPolicy"?: string;
"stabilizationWindowSeconds"?: number;
"tolerance"?: IIoK8sApimachineryPkgApiResourceQuantity;
...
setValidateFunc(HPAScalingRules, validate as ValidateFunc<IHPAScalingRules>);

export type {
  IHPAScalingRules as IIoK8sApiAutoscalingV2HPAScalingRules,
  HPAScalingRules as IoK8sApiAutoscalingV2HPAScalingRules
};
