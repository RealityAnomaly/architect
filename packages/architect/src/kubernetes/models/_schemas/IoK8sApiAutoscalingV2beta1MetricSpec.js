...
const schema0 = {"properties":{"containerResource":{"$ref":"zlbHC6t7WsAkYOWUMwNG1k1C4Fkcm8izu9b70pFmSvY"},"external":{"$ref":"e-iUgh5uD2BQAJ-HbIgdWywXGQbMr0s4udQqfwJWfw0"},"object":{"$ref":"2J6V8WJWhkv_XbkAf_yVnUBWxEG88iN8rGfrZMLwkFw"},"pods":{"$ref":"VdbW9EcuUTcspSb5cvusEn71LXUrAREgZYpJ5mTFXrc"},"resource":{"$ref":"v-3wOVTgQpnPunLLfH5CnBkx_F_As_kZIohIDxs9dv8"},"type":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"}},"required":["type"],"type":"object","$id":"io.k8s.api.autoscaling.v2beta1.MetricSpec"};
const schema1 = {"nullableRef":"io.k8s.api.autoscaling.v2beta1.ContainerResourceMetricSource#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiAutoscalingV2beta1ContainerResourceMetricSource.js";
...
const schema3 = {"nullableRef":"io.k8s.api.autoscaling.v2beta1.ExternalMetricSource#"};
const schema4 = {};

import { validate as validate6 } from "./IoK8sApiAutoscalingV2beta1ExternalMetricSource.js";
...
const schema5 = {"nullableRef":"io.k8s.api.autoscaling.v2beta1.ObjectMetricSource#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAutoscalingV2beta1ObjectMetricSource.js";
...
const schema7 = {"nullableRef":"io.k8s.api.autoscaling.v2beta1.PodsMetricSource#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAutoscalingV2beta1PodsMetricSource.js";
...
const schema9 = {"nullableRef":"io.k8s.api.autoscaling.v2beta1.ResourceMetricSource#"};
const schema10 = {};

import { validate as validate18 } from "./IoK8sApiAutoscalingV2beta1ResourceMetricSource.js";
