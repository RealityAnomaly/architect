...
const schema0 = {"properties":{"egress":{"$ref":"o9H0FDsG1q8L3gFoxd1PF_OBRhgwoBtA0APGS1QUbDw"},"ingress":{"$ref":"DHkO9T2Cbw7fidIrDFsw1cWnVOmxjQQzn6nIxpNj698"},"podSelector":{"$ref":"v9UPpZq80i3gaZjVxpGblXzp_E4dULDId73TGAJeg5U"},"policyTypes":{"$ref":"uqi-NWpwJAtCtKg340P2GU85hOwdccNKh8Eansj5IGE"}},"required":["podSelector"],"type":"object","$id":"io.k8s.api.extensions.v1beta1.NetworkPolicySpec"};
const schema1 = {"items":{"$ref":"hE3DqWGBt7aYOuRIr1Z89TwrWLF1dq1g-ahr_4KOiDk"},"type":"array","nullable":true};
const schema2 = {"$ref":"io.k8s.api.extensions.v1beta1.NetworkPolicyEgressRule#"};
const schema3 = {};

import { validate as validate3 } from "./IoK8sApiExtensionsV1beta1NetworkPolicyEgressRule.js";
...
const schema4 = {"items":{"$ref":"NxTIzc9uGkZzOt3Sx-k9-PMHZvxVrC73wc98CUpumP4"},"type":"array","nullable":true};
const schema5 = {"$ref":"io.k8s.api.extensions.v1beta1.NetworkPolicyIngressRule#"};
const schema6 = {};

import { validate as validate9 } from "./IoK8sApiExtensionsV1beta1NetworkPolicyIngressRule.js";
...
const err0 = {instancePath,schemaPath:"#/required",keyword:"required",params:{missingProperty: "podSelector"}};
if(vErrors === null){
vErrors = [err0];
}
else {
