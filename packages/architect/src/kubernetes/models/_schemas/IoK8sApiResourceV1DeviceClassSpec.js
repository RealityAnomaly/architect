...
const schema0 = {"properties":{"config":{"$ref":"kA37AEZI_Op1TdpWd2qiLnj90a52hu8WRifmZlM9smo"},"extendedResourceName":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"selectors":{"$ref":"UsYyRAk0ARrj4YEkr-YRdV6jYmCAPw5olGF9WcUwipg"}},"type":"object","$id":"io.k8s.api.resource.v1.DeviceClassSpec"};
const schema1 = {"items":{"$ref":"df-d4d_NL273THVOLJsuvcRg3hqTJJ0gg25CAOdsdKA"},"type":"array","nullable":true};
const schema2 = {"$ref":"io.k8s.api.resource.v1.DeviceClassConfiguration#"};
const schema3 = {};

import { validate as validate3 } from "./IoK8sApiResourceV1DeviceClassConfiguration.js";
...
const schema5 = {"items":{"$ref":"Qibf8gnBEb_7FMZ3UDBqcNC1uVw2ATrDv2vur_KAqO8"},"type":"array","nullable":true};
const schema6 = {"$ref":"io.k8s.api.resource.v1.DeviceSelector#"};
const schema7 = {};

import { validate as validate11 } from "./IoK8sApiResourceV1DeviceSelector.js";
...
/*# sourceURL="io.k8s.api.resource.v1.DeviceClassSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
