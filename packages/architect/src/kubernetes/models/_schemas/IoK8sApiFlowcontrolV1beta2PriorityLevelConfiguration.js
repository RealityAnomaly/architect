...
const schema0 = {"properties":{"apiVersion":{"$ref":"XV7smQLSxxLzFj2neZu2W2wqoEzS94FUJJFPq1jmjXg"},"kind":{"$ref":"MPguM0edzzSpP3z3C_kLTkO8jzvL8OQsSzibfgQ26zE"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"-2Mf13WAlWpLRLve1ksPVDzn9NZD7bNcX2N2lBanAg4"},"status":{"$ref":"okg_r1AHcq4UAjym3SaJReqR4dzTfXXgd5_wMfTZUrg"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.flowcontrol.v1beta2.PriorityLevelConfiguration"};
const schema1 = {"type":"string","enum":["flowcontrol.apiserver.k8s.io/v1beta2"]};
...
if(!(data === "flowcontrol.apiserver.k8s.io/v1beta2")){
...
const schema5 = {"nullableRef":"io.k8s.api.flowcontrol.v1beta2.PriorityLevelConfigurationSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiFlowcontrolV1beta2PriorityLevelConfigurationSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.flowcontrol.v1beta2.PriorityLevelConfigurationStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiFlowcontrolV1beta2PriorityLevelConfigurationStatus.js";
...
/*# sourceURL="io.k8s.api.flowcontrol.v1beta2.PriorityLevelConfiguration" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
