...
const schema1 = {"properties":{"allocationMode":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"capacity":{"$ref":"doCZ_BloTeH2w69UKP_pATMDcEAzEi32ohIJQFKY690"},"count":{"$ref":"otlW-2SioSJxw2ZRa8bQrFi14CUkm_yS2tfdShK98Vk"},"deviceClassName":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"name":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"selectors":{"$ref":"GsVfJpV99HMgf9zno9-ngqar3LPBIsv1TOC9vh__Znk"},"tolerations":{"$ref":"lA3zq3IslDOSKKa4WoZJ4R5IVeXQFtDVqYTqhjL7TpU"}},"required":["name","deviceClassName"],"type":"object","$id":"io.k8s.api.resource.v1beta2.DeviceSubRequest"};
...
import { validate as validate5 } from "./IoK8sApiResourceV1beta2CapacityRequirements.js";
...
const schema6 = {"items":{"$ref":"nXqQ2sNmowLtbnA8TcqPU9mA6sJKRE0kHdB3DvaxysQ"},"type":"array","nullable":true};
const schema7 = {"$ref":"io.k8s.api.resource.v1beta2.DeviceSelector#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiResourceV1beta2DeviceSelector.js";
...
const schema9 = {"items":{"$ref":"hxPiVPDOyDnagyGJ52Sec4dMjcMeIaoA1O45ZFiFcE8"},"type":"array","nullable":true};
const schema10 = {"$ref":"io.k8s.api.resource.v1beta2.DeviceToleration#"};
const schema11 = {};

import { validate as validate20 } from "./IoK8sApiResourceV1beta2DeviceToleration.js";
...
/*# sourceURL="io.k8s.api.resource.v1beta2.DeviceSubRequest" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
