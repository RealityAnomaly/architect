...
const schema0 = {"properties":{"apiVersion":{"$ref":"9m0m8SoyQCy2Bfi718RXr-uTNWFv6wbopxcPn7SIavw"},"kind":{"$ref":"wYF2QCT-9YRbMDuMZUNTiaeFtYwYkg9h3f0qaBuZTlw"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"roleRef":{"$ref":"qaZmtDVVuhmj84KPMwwroQmBZpanyir09yAYUe1zgfI"},"subjects":{"$ref":"j64UhHBbmF3ZApEEG62hTdRKL2PGBNisgcPHqqUQgfE"}},"required":["roleRef","apiVersion","kind"],"type":"object","$id":"io.k8s.api.rbac.v1beta1.RoleBinding"};
...
/*# sourceURL="io.k8s.api.rbac.v1beta1.RoleBinding" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
