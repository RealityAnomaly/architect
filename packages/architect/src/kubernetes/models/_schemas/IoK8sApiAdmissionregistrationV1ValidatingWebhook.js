...
import { validate as validate10 } from "./IoK8sApiAdmissionregistrationV1WebhookClientConfig.js";
...
import { validate as validate16 } from "./IoK8sApiAdmissionregistrationV1MatchCondition.js";
...
import { validate as validate26 } from "./IoK8sApiAdmissionregistrationV1RuleWithOperations.js";
...
/*# sourceURL="io.k8s.api.admissionregistration.v1.ValidatingWebhook" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
const _errs9 = errors;
if(!(validate24(data8, {instancePath:instancePath+"/rules",parentData:data,parentDataProperty:"rules",rootData}))){
...
if(!(validate1(data9, {instancePath:instancePath+"/sideEffects",parentData:data,parentDataProperty:"sideEffects",rootData}))){
vErrors = vErrors === null ? validate1.errors : vErrors.concat(validate1.errors);
errors = vErrors.length;
}
else {
...
if(!(validate31(data10, {instancePath:instancePath+"/timeoutSeconds",parentData:data,parentDataProperty:"timeoutSeconds",rootData}))){
