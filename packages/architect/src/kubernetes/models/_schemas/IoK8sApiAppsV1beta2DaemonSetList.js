...
const schema0 = {"properties":{"apiVersion":{"$ref":"RDQeBsM8HVHjCtmNbr9yR2YpAM4M6c1514F3xJQr2qg"},"items":{"$ref":"ZMQSeovkybYZQTMeLXug3QNgjIIZfhGXS6dT81JHH2s"},"kind":{"$ref":"njcrG5FNQAnh0IvFUwoMgSAYrf7_HpsKpqlHar_86sM"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.apps.v1beta2.DaemonSetList"};
...
const schema2 = {"items":{"$ref":"4kcez-miZrWxl7jXE2QMICCjUa1bkpUFRs727qclpdQ"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.apps.v1beta2.DaemonSet#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiAppsV1beta2DaemonSet.js";
...
const schema5 = {"type":"string","enum":["DaemonSetList"]};
...
/*# sourceURL="io.k8s.api.apps.v1beta2.DaemonSetList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
