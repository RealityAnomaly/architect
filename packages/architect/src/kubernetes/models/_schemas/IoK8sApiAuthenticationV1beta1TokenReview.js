...
const schema0 = {"properties":{"apiVersion":{"$ref":"zF3dereDaUwF8jnOFGHqVQj8USBp1GUyP_XjRNx7wjk"},"kind":{"$ref":"TRN64iKm8K8i2tqTAn5tMS-kFmXd-S7o2-YNWbITB2Y"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"de78qVwLkCTii3Lpb4Yhvtl9FmFCJzHi_31r-4hzs6g"},"status":{"$ref":"Qu2Q0T3aEYQrT1X3cuXEhECcC6BpbBjblVG1ctyANfc"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.authentication.v1beta1.TokenReview"};
const schema1 = {"type":"string","enum":["authentication.k8s.io/v1beta1"]};
...
if(!(data === "authentication.k8s.io/v1beta1")){
...
const schema2 = {"type":"string","enum":["TokenReview"]};
...
const schema5 = {"$ref":"io.k8s.api.authentication.v1beta1.TokenReviewSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAuthenticationV1beta1TokenReviewSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.authentication.v1beta1.TokenReviewStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAuthenticationV1beta1TokenReviewStatus.js";
...
/*# sourceURL="io.k8s.api.authentication.v1beta1.TokenReview" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
