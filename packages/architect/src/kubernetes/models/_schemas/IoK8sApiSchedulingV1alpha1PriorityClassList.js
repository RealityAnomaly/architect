...
const schema0 = {"properties":{"apiVersion":{"$ref":"JDQIB9XvHT_jchenhnqzwx63NXBGMcvKRRQ_Vp8gadM"},"items":{"$ref":"HcshU4Machu6xdDjjYHSk-F4WERcCV8diUABPerOOrY"},"kind":{"$ref":"91L5wWeczYAYXzucOu3DrLH3leT68IuBdENKLJrvW9Y"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.scheduling.v1alpha1.PriorityClassList"};
const schema1 = {"type":"string","enum":["scheduling.k8s.io/v1alpha1"]};
...
if(!(data === "scheduling.k8s.io/v1alpha1")){
...
const schema2 = {"items":{"$ref":"IV3finWYtGlyiFWNiC_9OUni0dapzpPuhPCIXnRsKk4"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.scheduling.v1alpha1.PriorityClass#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiSchedulingV1alpha1PriorityClass.js";
...
const schema5 = {"type":"string","enum":["PriorityClassList"]};
...
/*# sourceURL="io.k8s.api.scheduling.v1alpha1.PriorityClassList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
