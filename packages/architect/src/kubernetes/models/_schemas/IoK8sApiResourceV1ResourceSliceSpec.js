...
const schema1 = {"properties":{"allNodes":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"devices":{"$ref":"T4fcch8uhSJhXRnxWxHz_wiQNfzDHUSMZyXbHpZHF-w"},"driver":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"nodeName":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"nodeSelector":{"$ref":"TkSNaYWIxhO85OVX_cSWzmQgv784eOxf9GMx98WTU1I"},"perDeviceNodeSelection":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"pool":{"$ref":"xgQQ7374hU4VefrN0zpAaubvFQGNdxbhCZKQO5s-exo"},"sharedCounters":{"$ref":"ZsZKDbSUIIHwEQAjOdkmT8mc3_YqxyMdSWZw_r02kOc"}},"required":["driver","pool"],"type":"object","$id":"io.k8s.api.resource.v1.ResourceSliceSpec"};
...
const schema2 = {"items":{"$ref":"u9uCFFWkKOvrIoDHUqZghAvBjph7_PYQ_M-4mec1-9M"},"type":"array","nullable":true};
const schema3 = {"$ref":"io.k8s.api.resource.v1.Device#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiResourceV1Device.js";
...
const schema9 = {"$ref":"io.k8s.api.resource.v1.ResourcePool#"};
const schema10 = {};

import { validate as validate19 } from "./IoK8sApiResourceV1ResourcePool.js";
...
const schema11 = {"items":{"$ref":"pT_kWOA7amL1EbWRia7BoTsIu5gWprpJNSYLIlhhQ4k"},"type":"array","nullable":true};
const schema12 = {"$ref":"io.k8s.api.resource.v1.CounterSet#"};
const schema13 = {};

import { validate as validate24 } from "./IoK8sApiResourceV1CounterSet.js";
...
/*# sourceURL="io.k8s.api.resource.v1.ResourceSliceSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
