...
const schema0 = {"properties":{"apiVersion":{"$ref":"9m0m8SoyQCy2Bfi718RXr-uTNWFv6wbopxcPn7SIavw"},"kind":{"$ref":"Q-524TXDMWO6L5B0t_sxoHaoaAEgmA5leRvegePRPsA"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"rules":{"$ref":"lEGxIyQln-0UTgR17nVCKPJIM1NqEp9KkoGUNTF2P_Y"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.rbac.v1beta1.Role"};
...
const schema2 = {"type":"string","enum":["Role"]};
...
const schema5 = {"items":{"$ref":"Pvv5tt0Trt7EsyjVoyXl-drXgVX7OLBipUSRT6lZttQ"},"type":"array","nullable":true};
const schema6 = {"$ref":"io.k8s.api.rbac.v1beta1.PolicyRule#"};
const schema7 = {};

import { validate as validate11 } from "./IoK8sApiRbacV1beta1PolicyRule.js";
...
/*# sourceURL="io.k8s.api.rbac.v1beta1.Role" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
const _errs4 = errors;
if(!(validate9(data3, {instancePath:instancePath+"/rules",parentData:data,parentDataProperty:"rules",rootData}))){
