...
const schema2 = {"items":{"$ref":"sQPFYW6Udb9LvZCNFq54bMylYafFZH6ZKQ7Xva-QOBk"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.batch.v2alpha1.CronJob#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiBatchV2alpha1CronJob.js";
...
const schema5 = {"type":"string","enum":["CronJobList"]};
...
/*# sourceURL="io.k8s.api.batch.v2alpha1.CronJobList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
