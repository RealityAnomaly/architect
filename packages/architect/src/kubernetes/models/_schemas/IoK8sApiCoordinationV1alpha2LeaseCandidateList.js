...
const schema2 = {"items":{"$ref":"8j7arXGohVHWFsDQkBmYYDnZjGoLMFpDpTJ7SNMkMKw"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.coordination.v1alpha2.LeaseCandidate#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiCoordinationV1alpha2LeaseCandidate.js";
...
/*# sourceURL="io.k8s.api.coordination.v1alpha2.LeaseCandidateList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
