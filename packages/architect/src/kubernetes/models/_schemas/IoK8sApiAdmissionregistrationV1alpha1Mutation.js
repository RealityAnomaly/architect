...
const schema0 = {"properties":{"applyConfiguration":{"$ref":"d5bboD6-t-ttR3seRH--m6yPz82cTVCz5Smx89cTx7s"},"jsonPatch":{"$ref":"tRUMLds66vKUaU0CwMgUVWrz-Kzd_w8YmMqJxmjqx0U"},"patchType":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"}},"required":["patchType"],"type":"object","$id":"io.k8s.api.admissionregistration.v1alpha1.Mutation"};
const schema1 = {"nullableRef":"io.k8s.api.admissionregistration.v1alpha1.ApplyConfiguration#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiAdmissionregistrationV1alpha1ApplyConfiguration.js";
...
const schema3 = {"nullableRef":"io.k8s.api.admissionregistration.v1alpha1.JSONPatch#"};
const schema4 = {};

import { validate as validate6 } from "./IoK8sApiAdmissionregistrationV1alpha1JSONPatch.js";
...
/*# sourceURL="io.k8s.api.admissionregistration.v1alpha1.Mutation" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
