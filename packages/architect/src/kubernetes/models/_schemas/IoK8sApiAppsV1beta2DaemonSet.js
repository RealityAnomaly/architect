...
const schema0 = {"properties":{"apiVersion":{"$ref":"RDQeBsM8HVHjCtmNbr9yR2YpAM4M6c1514F3xJQr2qg"},"kind":{"$ref":"ERvU2QJg1DiCGeZLUZJ8VMl_dVIUGf2Nd4eVT5aB42M"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"_i4lGzgYIyz7q5X8L2Wd0qzoDRrkMx6d4_EWVem2AYg"},"status":{"$ref":"rOqDxU8To2mGWPggIFLR1mO4cgAzQuJIBnjQuUpcoyU"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.apps.v1beta2.DaemonSet"};
...
const schema2 = {"type":"string","enum":["DaemonSet"]};
...
const schema5 = {"nullableRef":"io.k8s.api.apps.v1beta2.DaemonSetSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAppsV1beta2DaemonSetSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.apps.v1beta2.DaemonSetStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAppsV1beta2DaemonSetStatus.js";
...
/*# sourceURL="io.k8s.api.apps.v1beta2.DaemonSet" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
