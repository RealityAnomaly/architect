...
const schema0 = {"properties":{"apiVersion":{"$ref":"k5mDDesRtCFucGllimaaTnNCzeQUUecIZ4YUku2KWxM"},"kind":{"$ref":"3G_d2Z0vTksL0qQ4hI4iOE-_j84LodoQb2ABJaNZCMo"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"zXoLmj335-T7ESg267uss1ZjKff57-xry55wuFtSfjM"},"status":{"$ref":"pFUeF_Y2jMAmLs4Uymen2DtQiKRDHLR7NdYYTOsJ7bU"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.storagemigration.v1beta1.StorageVersionMigration"};
const schema1 = {"type":"string","enum":["storagemigration.k8s.io/v1beta1"]};
...
if(!(data === "storagemigration.k8s.io/v1beta1")){
...
const schema5 = {"nullableRef":"io.k8s.api.storagemigration.v1beta1.StorageVersionMigrationSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiStoragemigrationV1beta1StorageVersionMigrationSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.storagemigration.v1beta1.StorageVersionMigrationStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiStoragemigrationV1beta1StorageVersionMigrationStatus.js";
...
/*# sourceURL="io.k8s.api.storagemigration.v1beta1.StorageVersionMigration" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
