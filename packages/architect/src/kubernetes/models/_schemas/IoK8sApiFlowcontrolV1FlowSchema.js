...
const schema0 = {"properties":{"apiVersion":{"$ref":"cPYs8Mg7G8PjYVVYFezR2JdAAmurCA580nDIbsl_eL8"},"kind":{"$ref":"KznZLkFQwWO593jSmSPCGAI8EpaoEkx-61qxVvue1b4"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"5XuireADDOkxTb7YRf5PcwX4GHiwcfx3YWpYY6mbQ9s"},"status":{"$ref":"a_FLLeasVbEPj4VdmxaYx_2QWSOibVgBCf4hthG8gMQ"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.flowcontrol.v1.FlowSchema"};
...
const schema5 = {"nullableRef":"io.k8s.api.flowcontrol.v1.FlowSchemaSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiFlowcontrolV1FlowSchemaSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.flowcontrol.v1.FlowSchemaStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiFlowcontrolV1FlowSchemaStatus.js";
...
/*# sourceURL="io.k8s.api.flowcontrol.v1.FlowSchema" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
