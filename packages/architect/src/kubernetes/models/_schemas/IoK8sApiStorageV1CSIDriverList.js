...
const schema0 = {"properties":{"apiVersion":{"$ref":"3Lnz3hDGoV6LS117nicS3YoTy1WU2EUGx89iY2NJZb4"},"items":{"$ref":"RL8wRk-XnJlHOJhAua2EPi_T9XbbCd3i72BmYUmamcI"},"kind":{"$ref":"A_I_RJHgMLuwmWHXuPfjUPuCjEJaD-dNHS5AJri6nTY"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.storage.v1.CSIDriverList"};
...
const schema2 = {"items":{"$ref":"G2zhBJPz1dK8g4-7Su1Mi0p3rvt4u2PyrcH8GVVFGqs"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.storage.v1.CSIDriver#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiStorageV1CSIDriver.js";
...
const schema5 = {"type":"string","enum":["CSIDriverList"]};
...
/*# sourceURL="io.k8s.api.storage.v1.CSIDriverList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
