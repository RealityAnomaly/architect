...
const schema0 = {"properties":{"apiVersion":{"$ref":"3Lnz3hDGoV6LS117nicS3YoTy1WU2EUGx89iY2NJZb4"},"items":{"$ref":"QXqrELoIdnoikD4vHViYUBsjEJK6azuoigDV--VNdiY"},"kind":{"$ref":"MwaWuJi-XYeknF8tDccqQ9zmKhHh0npOv05W_3uBNuU"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.storage.v1.VolumeAttributesClassList"};
const schema1 = {"type":"string","enum":["storage.k8s.io/v1"]};
...
const schema2 = {"items":{"$ref":"dJAIa_neodV8dxenGTOtJoCnVCrguBP9I-M4K8BUEQ0"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.storage.v1.VolumeAttributesClass#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiStorageV1VolumeAttributesClass.js";
...
const schema5 = {"type":"string","enum":["VolumeAttributesClassList"]};
...
if(!(data === "VolumeAttributesClassList")){
...
/*# sourceURL="io.k8s.api.storage.v1.VolumeAttributesClassList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
