...
const schema5 = {"properties":{"$ref":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"$schema":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"additionalItems":{"$ref":"yspi5XUFtotT90RyoIF7caVDXTSqRPylA8ephrGZHBQ"},"additionalProperties":{"$ref":"yspi5XUFtotT90RyoIF7caVDXTSqRPylA8ephrGZHBQ"},"allOf":{"$ref":"eC0IxHw1dyjQ_y-hiyesfoO5sPsWAdraJYM9sH1yxwU"},"anyOf":{"items":{"$ref":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps#"},"type":"array","nullable":true},"default":{"nullableRef":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSON#"},"definitions":{"additionalProperties":{"$ref":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps#"},"type":"object","nullable":true},"dependencies":{"additionalProperties":{"$ref":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaPropsOrStringArray#"},"type":"object","nullable":true},"enum":{"items":{"$ref":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSON#"},"type":"array","nullable":true},"example":{"nullableRef":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSON#"},"exclusiveMaximum":{"type":"boolean","nullable":true},"exclusiveMinimum":{"type":"boolean","nullable":true},"externalDocs":{"nullableRef":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.ExternalDocumentation#"},"format":{"type":"string","nullable":true},"id":{"type":"string","nullable":true},"items":{"nullableRef":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaPropsOrArray#"},"maxItems":{"format":"int64","type":"integer","nullable":true},"maxLength":{"format":"int64","type":"integer","nullable":true},"maxProperties":{"format":"int64","type":"integer","nullable":true},"maximum":{"format":"double","type":"number","nullable":true},"minItems":{"format":"int64","type":"integer","nullable":true},"minLength":{"format":"int64","type":"integer","nullable":true},"minProperties":{"format":"int64","type":"integer","nullable":true},"minimum":{"format":"double","type":"number","nullable":true},"multipleOf":{"format":"double","type":"number","nullable":true},"not":{"nullableRef":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps#"},"nullable":{"type":"boolean","nullable":true},"oneOf":{"items":{"$ref":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps#"},"type":"array","nullable":true},"pattern":{"type":"string","nullable":true},"patternProperties":{"additionalProperties":{"$ref":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps#"},"type":"object","nullable":true},"properties":{"additionalProperties":{"$ref":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps#"},"type":"object","nullable":true},"required":{"items":{"type":"string"},"type":"array","nullable":true},"title":{"type":"string","nullable":true},"type":{"type":"string","nullable":true},"uniqueItems":{"type":"boolean","nullable":true}},"type":"object","$id":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps"};
...
const schema1 = {"nullableRef":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaPropsOrBool#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiextensionsApiserverPkgApisApiextensionsV1JSONSchemaPropsOrBool.js";
...
import { validate as validate11 } from "./IoK8sApiextensionsApiserverPkgApisApiextensionsV1JSON.js";

const schema7 = {};

import { validate as validate13 } from "./IoK8sApiextensionsApiserverPkgApisApiextensionsV1JSONSchemaPropsOrStringArray.js";

const schema8 = {};

import { validate as validate17 } from "./IoK8sApiextensionsApiserverPkgApisApiextensionsV1ExternalDocumentation.js";

const schema9 = {};

import { validate as validate19 } from "./IoK8sApiextensionsApiserverPkgApisApiextensionsV1JSONSchemaPropsOrArray.js";

const wrapper0 = {validate: validate4};
const schema3 = {"items":{"$ref":"1VQWyWdLsdulvdUeexpvnOs2Hk5tVc9JBn-4QSEo5Lg"},"type":"array","nullable":true};
const schema4 = {"$ref":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.JSONSchemaProps#"};
