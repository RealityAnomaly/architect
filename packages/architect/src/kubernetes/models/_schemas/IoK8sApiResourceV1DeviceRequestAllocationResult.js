...
import { validate as validate10 } from "./../../apimachinery/_schemas/IoK8sApimachineryPkgApiResourceQuantity.js";
...
const schema8 = {"items":{"$ref":"Oeg0HZldl0CuOkhH2lLHngbMC3E5dDbPOtSfm2cKawc"},"type":"array","nullable":true};
const schema9 = {"$ref":"io.k8s.api.resource.v1.DeviceToleration#"};
const schema10 = {};

import { validate as validate22 } from "./IoK8sApiResourceV1DeviceToleration.js";
...
/*# sourceURL="io.k8s.api.resource.v1.DeviceRequestAllocationResult" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
