...
const schema0 = {"properties":{"apiVersion":{"$ref":"JhWvHbSFO3ELsap4IWTkIXEjLRfpdwhmVqXnItVBFvQ"},"kind":{"$ref":"hPd33e6PZbotO8RUW1q4WY_uKbXKl3ikZ-g-DKmLMl8"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"jDybx1iwISNzmFJjXlWMQDf7PeqaBO6MvEqj1VGKYhk"},"status":{"$ref":"06e3xfRrmZBq6WweWPifkHcV1FedyScyk6PZLLcEyy4"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.resource.v1alpha3.DeviceTaintRule"};
const schema1 = {"type":"string","enum":["resource.k8s.io/v1alpha3"]};
...
if(!(data === "resource.k8s.io/v1alpha3")){
...
const schema2 = {"type":"string","enum":["DeviceTaintRule"]};
...
const schema5 = {"$ref":"io.k8s.api.resource.v1alpha3.DeviceTaintRuleSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiResourceV1alpha3DeviceTaintRuleSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.resource.v1alpha3.DeviceTaintRuleStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiResourceV1alpha3DeviceTaintRuleStatus.js";
...
/*# sourceURL="io.k8s.api.resource.v1alpha3.DeviceTaintRule" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
