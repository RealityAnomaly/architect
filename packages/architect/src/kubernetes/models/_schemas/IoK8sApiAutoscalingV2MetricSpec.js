...
const schema0 = {"properties":{"containerResource":{"$ref":"qKqPxRQvJaRJ8JKDfxarqAZisOnEkLH7scRrY9PO14w"},"external":{"$ref":"1nqOUXJqa3ovjmZc1QsPx1zXu9tbteHVZ76_7PSPorQ"},"object":{"$ref":"C0_XqEZpwDZBu5OfLG6UEbu1FopjQWtPGVbrE3VFof0"},"pods":{"$ref":"MnqafrO79rowMRaSn7TrI0x-oqVqHClrJvb-ZkI8DXE"},"resource":{"$ref":"Zft2O2i8F6jlBXsKiu90_tgknC-jCeipg3YeoJ4Lais"},"type":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"}},"required":["type"],"type":"object","$id":"io.k8s.api.autoscaling.v2.MetricSpec"};
const schema1 = {"nullableRef":"io.k8s.api.autoscaling.v2.ContainerResourceMetricSource#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiAutoscalingV2ContainerResourceMetricSource.js";
...
const schema3 = {"nullableRef":"io.k8s.api.autoscaling.v2.ExternalMetricSource#"};
const schema4 = {};

import { validate as validate6 } from "./IoK8sApiAutoscalingV2ExternalMetricSource.js";
...
const schema5 = {"nullableRef":"io.k8s.api.autoscaling.v2.ObjectMetricSource#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAutoscalingV2ObjectMetricSource.js";
...
const schema7 = {"nullableRef":"io.k8s.api.autoscaling.v2.PodsMetricSource#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAutoscalingV2PodsMetricSource.js";
...
const schema9 = {"nullableRef":"io.k8s.api.autoscaling.v2.ResourceMetricSource#"};
const schema10 = {};

import { validate as validate18 } from "./IoK8sApiAutoscalingV2ResourceMetricSource.js";
...
/*# sourceURL="io.k8s.api.autoscaling.v2.MetricSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
