...
const schema2 = {"properties":{"maxSurge":{"$ref":"0Ic74D7DBbilZPLlK8sD9BMBs_dQWTMr2-XowApJQb0"},"maxUnavailable":{"$ref":"0Ic74D7DBbilZPLlK8sD9BMBs_dQWTMr2-XowApJQb0"}},"type":"object","$id":"io.k8s.api.apps.v1.RollingUpdateDaemonSet"};
...
/*# sourceURL="io.k8s.api.apps.v1.RollingUpdateDaemonSet" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
