...
const schema0 = {"properties":{"current":{"$ref":"Sd-dcUbA0TL7oZp5fmtDBLHIG0jkAJjU29O4p-Jjvq4"},"describedObject":{"$ref":"E2l06yuqoLv6uh8rsLN_0_gEKLk6SfvWTk4e_GHebmw"},"metric":{"$ref":"HhIW3eWSXOltn7SemUIsPuCS7UE0PSh1IWsMg8ta2ZE"}},"required":["metric","current","describedObject"],"type":"object","$id":"io.k8s.api.autoscaling.v2.ObjectMetricStatus"};
const schema1 = {"$ref":"io.k8s.api.autoscaling.v2.MetricValueStatus#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiAutoscalingV2MetricValueStatus.js";
...
const schema3 = {"$ref":"io.k8s.api.autoscaling.v2.CrossVersionObjectReference#"};
const schema4 = {};

import { validate as validate6 } from "./IoK8sApiAutoscalingV2CrossVersionObjectReference.js";
...
const schema5 = {"$ref":"io.k8s.api.autoscaling.v2.MetricIdentifier#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAutoscalingV2MetricIdentifier.js";
...
/*# sourceURL="io.k8s.api.autoscaling.v2.ObjectMetricStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
