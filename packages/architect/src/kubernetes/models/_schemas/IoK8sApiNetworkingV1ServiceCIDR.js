...
const schema0 = {"properties":{"apiVersion":{"$ref":"bmUSx3GwTpT_skQdL_E-LdWligvUQoO8M-V4fX8HBv0"},"kind":{"$ref":"WNXACaX6otAkV_a7bvN38K4BIiMuxMsRih1RN-IOd7M"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"0g7iAZ5X_SCQIHfNqbKbhbOP_fR4u_Bj9M9T2e78bII"},"status":{"$ref":"zTsJRP1vxQgF10qj0z0I4GTj5ZnpIl24Z-QuyT_syic"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.networking.v1.ServiceCIDR"};
const schema1 = {"type":"string","enum":["networking.k8s.io/v1"]};
...
const schema5 = {"nullableRef":"io.k8s.api.networking.v1.ServiceCIDRSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiNetworkingV1ServiceCIDRSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.networking.v1.ServiceCIDRStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiNetworkingV1ServiceCIDRStatus.js";
...
/*# sourceURL="io.k8s.api.networking.v1.ServiceCIDR" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
