...
const schema1 = {"items":{"$ref":"dqVmBudiYwzrCotRD1DgxJB6DN3phtU3WoFFqUktum8"},"type":"array"};
const schema2 = {"$ref":"io.k8s.api.batch.v1.SuccessPolicyRule#"};
const schema3 = {};

import { validate as validate3 } from "./IoK8sApiBatchV1SuccessPolicyRule.js";
...
/*# sourceURL="io.k8s.api.batch.v1.SuccessPolicy" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
