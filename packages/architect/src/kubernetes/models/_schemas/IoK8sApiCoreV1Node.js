...
const schema0 = {"properties":{"apiVersion":{"$ref":"_-ZvS-rLxHiNEArQOhevVo83klxV-qnul8X_v4BZ4M4"},"kind":{"$ref":"JNQhjbvdoLOKq5EQgy-RNoHS1eKG3X7HqQDB3yaxhiM"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"fhoKq6Q-c4jXOlL51BT-j9ih6-N_gYDFmM90rfO9CIs"},"status":{"$ref":"ZprRi9v1anSziiOtLB00km1EECKfS3czAFMlAyVE0N0"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.core.v1.Node"};
...
const schema2 = {"type":"string","enum":["Node"]};
...
const schema5 = {"nullableRef":"io.k8s.api.core.v1.NodeSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiCoreV1NodeSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.core.v1.NodeStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiCoreV1NodeStatus.js";
...
/*# sourceURL="io.k8s.api.core.v1.Node" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
