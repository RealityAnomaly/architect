...
const schema2 = {"properties":{"max":{"$ref":"pp_xaFlNXkKoD6DTqyaUAeP7lGItJ9_hKwPxmHYeCNA"},"min":{"$ref":"VKZPUldlWDa056CXEqKHCNMaIxOA7qIsmePtey64Cuk"},"step":{"$ref":"pp_xaFlNXkKoD6DTqyaUAeP7lGItJ9_hKwPxmHYeCNA"}},"required":["min"],"type":"object","$id":"io.k8s.api.resource.v1beta2.CapacityRequestPolicyRange"};
...
/*# sourceURL="io.k8s.api.resource.v1beta2.CapacityRequestPolicyRange" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
