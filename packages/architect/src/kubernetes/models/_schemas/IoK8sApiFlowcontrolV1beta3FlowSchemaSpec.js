...
const schema0 = {"properties":{"distinguisherMethod":{"$ref":"OmpfLOJzvchd1f9SDYmxAEEoR6jwB9jDjT-1sL7kghw"},"matchingPrecedence":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"priorityLevelConfiguration":{"$ref":"oR7wJFGLmEzgJbQkakH1-zNrqn4ZesgrgeENqudpa-k"},"rules":{"$ref":"JuLgcOuNXC36lvmccvOn9Q7HSZzQC-kuLHC7b06xPl8"}},"required":["priorityLevelConfiguration"],"type":"object","$id":"io.k8s.api.flowcontrol.v1beta3.FlowSchemaSpec"};
const schema1 = {"nullableRef":"io.k8s.api.flowcontrol.v1beta3.FlowDistinguisherMethod#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiFlowcontrolV1beta3FlowDistinguisherMethod.js";
...
const schema4 = {"$ref":"io.k8s.api.flowcontrol.v1beta3.PriorityLevelConfigurationReference#"};
const schema5 = {};

import { validate as validate8 } from "./IoK8sApiFlowcontrolV1beta3PriorityLevelConfigurationReference.js";
...
const schema6 = {"items":{"$ref":"CvHm9jpnQJlGed13LNabGql6EvcwYVNmUyeHG2Io3oo"},"type":"array","nullable":true};
const schema7 = {"$ref":"io.k8s.api.flowcontrol.v1beta3.PolicyRulesWithSubjects#"};
const schema8 = {};

import { validate as validate13 } from "./IoK8sApiFlowcontrolV1beta3PolicyRulesWithSubjects.js";
...
/*# sourceURL="io.k8s.api.flowcontrol.v1beta3.FlowSchemaSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
