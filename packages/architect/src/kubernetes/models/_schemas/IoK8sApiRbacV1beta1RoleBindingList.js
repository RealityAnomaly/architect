...
const schema0 = {"properties":{"apiVersion":{"$ref":"9m0m8SoyQCy2Bfi718RXr-uTNWFv6wbopxcPn7SIavw"},"items":{"$ref":"lqCYoNZd5DL_lW0rP-viVjVWRM_RBE8AhpVEgpb_-po"},"kind":{"$ref":"wK85Fl6PH_8ZieP1NC3yMKiUyuykge9ahnial2Jggas"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.rbac.v1beta1.RoleBindingList"};
...
const schema2 = {"items":{"$ref":"w1eGybIRV26xmtaXkdro2jnwjPKIaqp7IS6QgXOsXV8"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.rbac.v1beta1.RoleBinding#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiRbacV1beta1RoleBinding.js";
...
const schema5 = {"type":"string","enum":["RoleBindingList"]};
...
/*# sourceURL="io.k8s.api.rbac.v1beta1.RoleBindingList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
