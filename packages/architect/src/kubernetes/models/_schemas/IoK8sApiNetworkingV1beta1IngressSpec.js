...
const schema0 = {"properties":{"backend":{"$ref":"DmpL6ZbxXxLKBW3lZipTYxND8irHl_2ONsPGanGhReY"},"ingressClassName":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"rules":{"$ref":"N73sZ9v1WoqmSr9qjLfgoVwkb503_ovZSs5hSjfcuNY"},"tls":{"$ref":"80G1RGB7cjQ1CZTEK8PYn_pwEpIG43IkysVUgWPAbfI"}},"type":"object","$id":"io.k8s.api.networking.v1beta1.IngressSpec"};
const schema1 = {"nullableRef":"io.k8s.api.networking.v1beta1.IngressBackend#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiNetworkingV1beta1IngressBackend.js";
...
const schema4 = {"items":{"$ref":"CXCUVx5tOe8zrOWhMb8GYzbU9x9_JyvTC4HQnQhV9Zw"},"type":"array","nullable":true};
const schema5 = {"$ref":"io.k8s.api.networking.v1beta1.IngressRule#"};
const schema6 = {};

import { validate as validate9 } from "./IoK8sApiNetworkingV1beta1IngressRule.js";
...
const schema7 = {"items":{"$ref":"vYLDlFifCVYFSQuFiI1BirzNm_m2zlDUNB84V0hNl-I"},"type":"array","nullable":true};
const schema8 = {"$ref":"io.k8s.api.networking.v1beta1.IngressTLS#"};
const schema9 = {};

import { validate as validate15 } from "./IoK8sApiNetworkingV1beta1IngressTLS.js";
...
/*# sourceURL="io.k8s.api.networking.v1beta1.IngressSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
