...
const schema0 = {"properties":{"apiVersion":{"$ref":"yAY_1MoU303aAtcQvMdhbOYMuzjr4eot9RMpeMMUNiw"},"items":{"$ref":"4bgMtMx6TmQJFyVlPz9g4svsuZexOAkTkLDWEB3mxok"},"kind":{"$ref":"JeVhGgtNU5tDQEtQ44PZ-CVWN6USGwMdSANGJUnxBig"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceList"};
...
const schema2 = {"items":{"$ref":"Az6yga1qBT4JNhwGuDA2lslwkH7MhjmOOw6ERwnkFwA"},"type":"array"};
const schema3 = {"$ref":"io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIService#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sKubeAggregatorPkgApisApiregistrationV1APIService.js";
...
/*# sourceURL="io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
