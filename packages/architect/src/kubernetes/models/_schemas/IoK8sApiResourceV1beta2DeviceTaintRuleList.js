...
const schema2 = {"items":{"$ref":"TBXfkS0E_uPTQnNznNWHbuYsHx0dsUGTztMdHdNNg_E"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.resource.v1beta2.DeviceTaintRule#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiResourceV1beta2DeviceTaintRule.js";
...
/*# sourceURL="io.k8s.api.resource.v1beta2.DeviceTaintRuleList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
