...
const schema1 = {"type":"string","enum":["internal.apiserver.k8s.io/v1alpha1"]};
...
if(!(data === "internal.apiserver.k8s.io/v1alpha1")){
...
const schema2 = {"type":"string","enum":["StorageVersion"]};
...
const schema5 = {"nullableRef":"io.k8s.api.apiserverinternal.v1alpha1.StorageVersionSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiApiserverinternalV1alpha1StorageVersionSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.apiserverinternal.v1alpha1.StorageVersionStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiApiserverinternalV1alpha1StorageVersionStatus.js";
...
/*# sourceURL="io.k8s.api.apiserverinternal.v1alpha1.StorageVersion" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
