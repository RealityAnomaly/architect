...
const schema0 = {"properties":{"apiVersion":{"$ref":"RDQeBsM8HVHjCtmNbr9yR2YpAM4M6c1514F3xJQr2qg"},"kind":{"$ref":"SVoKHjRckHCUboDv3OeN9mW5U39F_OkRSP2GGEua6HU"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"9CET7HsiqsGcDu1l5gAM9C-s0e1MlHI49tgR7vWVSKw"},"status":{"$ref":"eRb8_oAJBPcQE-PfvQQs19uq4p-kfhmB3brrKo5Jui4"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.apps.v1beta2.ReplicaSet"};
...
const schema2 = {"type":"string","enum":["ReplicaSet"]};
...
const schema5 = {"nullableRef":"io.k8s.api.apps.v1beta2.ReplicaSetSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAppsV1beta2ReplicaSetSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.apps.v1beta2.ReplicaSetStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAppsV1beta2ReplicaSetStatus.js";
...
/*# sourceURL="io.k8s.api.apps.v1beta2.ReplicaSet" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
