...
const schema0 = {"properties":{"apiVersion":{"$ref":"3Lr76d5ZyoHerMLHe6eY12g9lT6ufICgqZ21TQshLE8"},"kind":{"$ref":"BQDBlxaEjzkRd4MSIrIl2tFwXLmqm5cOBwGe8KXUGeo"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"47G7jdexWHv1dsz5qd1C3I-EV_FuooYvESVhR7dU9UU"},"status":{"$ref":"1l_s3utUrKePQ2jbMGvaFIgtvj3qcu0MAnSkESp8Ew8"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.authorization.v1.SelfSubjectAccessReview"};
const schema1 = {"type":"string","enum":["authorization.k8s.io/v1"]};
...
if(!(data === "authorization.k8s.io/v1")){
...
const schema5 = {"$ref":"io.k8s.api.authorization.v1.SelfSubjectAccessReviewSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAuthorizationV1SelfSubjectAccessReviewSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.authorization.v1.SubjectAccessReviewStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAuthorizationV1SubjectAccessReviewStatus.js";
...
/*# sourceURL="io.k8s.api.authorization.v1.SelfSubjectAccessReview" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
