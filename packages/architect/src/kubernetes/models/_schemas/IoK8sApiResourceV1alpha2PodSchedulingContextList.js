...
const schema2 = {"items":{"$ref":"K5CTqi2UFtz5r4MTYK-ihxMLsRB4QIxulRwHiB0f2-c"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.resource.v1alpha2.PodSchedulingContext#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiResourceV1alpha2PodSchedulingContext.js";
...
const schema5 = {"type":"string","enum":["PodSchedulingContextList"]};
...
if(!(data === "PodSchedulingContextList")){
...
/*# sourceURL="io.k8s.api.resource.v1alpha2.PodSchedulingContextList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
