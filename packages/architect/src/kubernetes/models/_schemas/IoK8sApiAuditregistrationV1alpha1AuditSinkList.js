...
const schema0 = {"properties":{"apiVersion":{"$ref":"KKUVc08cEf5IhomO94XUOBMoEH-xrEj2wQ6O6w93owU"},"items":{"$ref":"mZCsN_I44mj8bwQz6ew4vI6QUDcW8kIsNE_hYRn27cA"},"kind":{"$ref":"tknVU40dwoTlW_hdPHqKUPKVCb5K_P-GiMPxYiwElTo"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.auditregistration.v1alpha1.AuditSinkList"};
const schema1 = {"type":"string","enum":["auditregistration.k8s.io/v1alpha1"]};
...
if(!(data === "auditregistration.k8s.io/v1alpha1")){
...
const schema2 = {"items":{"$ref":"ONL2TniBmr45TcRYsPnxWTR93pmH2KK-dVMNn6vyKGQ"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.auditregistration.v1alpha1.AuditSink#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiAuditregistrationV1alpha1AuditSink.js";
...
const schema5 = {"type":"string","enum":["AuditSinkList"]};
...
/*# sourceURL="io.k8s.api.auditregistration.v1alpha1.AuditSinkList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
