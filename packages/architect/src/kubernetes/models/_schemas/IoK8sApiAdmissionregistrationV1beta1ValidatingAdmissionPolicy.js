...
const schema0 = {"properties":{"apiVersion":{"$ref":"KmJtbxjKRbXdsyADIcJYH0lVv-K8B7QYvkcPlXiYrvM"},"kind":{"$ref":"DIF_tgKsUhbsV2OXL070IEWKOHfD4sT5VzJLD8xF66U"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"8K__Bz2Hc5oDwOLXBY9iWfAO4J7NZPFx9AItRVF2pIQ"},"status":{"$ref":"_G96i7584bE7Wujox2PUX_dv0iacBGJGPSbiRko8mDM"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicy"};
const schema1 = {"type":"string","enum":["admissionregistration.k8s.io/v1beta1"]};
...
if(!(data === "admissionregistration.k8s.io/v1beta1")){
...
const schema5 = {"nullableRef":"io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicySpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicySpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicyStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicyStatus.js";
...
/*# sourceURL="io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicy" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
