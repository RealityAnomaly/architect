...
const schema0 = {"properties":{"distinguisherMethod":{"$ref":"knydwwGKq1_mYg1Q_xqPGDeav8fRrKnoFvDPIuPbLfg"},"matchingPrecedence":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"priorityLevelConfiguration":{"$ref":"45YIoTIgh7o8J_y_RW0TTNDsmzbGJfgOaY3IANGXNNU"},"rules":{"$ref":"OSbXPQ3TuvgnKDd0DPF2PPJbfmPg0rqe8mfBLK7DLws"}},"required":["priorityLevelConfiguration"],"type":"object","$id":"io.k8s.api.flowcontrol.v1.FlowSchemaSpec"};
const schema1 = {"nullableRef":"io.k8s.api.flowcontrol.v1.FlowDistinguisherMethod#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiFlowcontrolV1FlowDistinguisherMethod.js";
...
const schema4 = {"$ref":"io.k8s.api.flowcontrol.v1.PriorityLevelConfigurationReference#"};
const schema5 = {};

import { validate as validate8 } from "./IoK8sApiFlowcontrolV1PriorityLevelConfigurationReference.js";
...
const schema6 = {"items":{"$ref":"5DCf6yGMuPAhQ71pR2sC7JmovoTcxVxEC5quE7_JGtU"},"type":"array","nullable":true};
const schema7 = {"$ref":"io.k8s.api.flowcontrol.v1.PolicyRulesWithSubjects#"};
const schema8 = {};

import { validate as validate13 } from "./IoK8sApiFlowcontrolV1PolicyRulesWithSubjects.js";
...
/*# sourceURL="io.k8s.api.flowcontrol.v1.FlowSchemaSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
