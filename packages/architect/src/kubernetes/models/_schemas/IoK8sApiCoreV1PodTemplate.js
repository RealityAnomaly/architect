...
const schema0 = {"properties":{"apiVersion":{"$ref":"_-ZvS-rLxHiNEArQOhevVo83klxV-qnul8X_v4BZ4M4"},"kind":{"$ref":"owInpwutPLLWKX-lLzVaO2yPOuCGIPXaZ7fcqFa2YXI"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"template":{"$ref":"trtzTcIsxeXk13WCzQpY_Zt3woih-nHQQGJY4vO3rEM"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.core.v1.PodTemplate"};
...
const schema2 = {"type":"string","enum":["PodTemplate"]};
...
const schema5 = {"nullableRef":"io.k8s.api.core.v1.PodTemplateSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiCoreV1PodTemplateSpec.js";
...
/*# sourceURL="io.k8s.api.core.v1.PodTemplate" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
const _errs4 = errors;
if(!(validate9(data3, {instancePath:instancePath+"/template",parentData:data,parentDataProperty:"template",rootData}))){
