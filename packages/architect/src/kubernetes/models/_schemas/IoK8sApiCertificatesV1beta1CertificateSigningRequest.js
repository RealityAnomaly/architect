...
const schema0 = {"properties":{"apiVersion":{"$ref":"kdF3Htu-APfgwC7VUX7AOjVhkUGR76mpFE8nNN6FKJk"},"kind":{"$ref":"MYcmnu7x4Ms9B4PNBtv_05Wgu7YNVsjUM8WzH4Fc3zA"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"vqU96P2uTx9_d-McW-ajnKv2k3ui8k9R6NrfZl8mEH4"},"status":{"$ref":"If8LvXdrUKQ0wlIT8SII78jI0u6w3CvhHIsBJrUvyh8"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.certificates.v1beta1.CertificateSigningRequest"};
...
const schema5 = {"nullableRef":"io.k8s.api.certificates.v1beta1.CertificateSigningRequestSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiCertificatesV1beta1CertificateSigningRequestSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.certificates.v1beta1.CertificateSigningRequestStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiCertificatesV1beta1CertificateSigningRequestStatus.js";
...
/*# sourceURL="io.k8s.api.certificates.v1beta1.CertificateSigningRequest" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
