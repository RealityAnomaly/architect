...
const schema2 = {"items":{"$ref":"-iW3U7ccced4Xs2cnkWmxP7vMfgGSAg4e-DeYYX5tRo"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.rbac.v1alpha1.ClusterRoleBinding#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiRbacV1alpha1ClusterRoleBinding.js";
...
/*# sourceURL="io.k8s.api.rbac.v1alpha1.ClusterRoleBindingList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
