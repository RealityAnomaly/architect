...
const schema0 = {"properties":{"apiVersion":{"$ref":"oE84494_ZXZLZbFDlR1EbfFCxiH-x4diD63lGEBEW3Q"},"items":{"$ref":"L3rtbuvxYJAYjo5AZ2KgRfllUrAyGj3Dbbty12uXQWg"},"kind":{"$ref":"JeVhGgtNU5tDQEtQ44PZ-CVWN6USGwMdSANGJUnxBig"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.kube-aggregator.pkg.apis.apiregistration.v1beta1.APIServiceList"};
...
const schema2 = {"items":{"$ref":"JCjnk4u3a4bYEilDjjcRGbZTIfv1JhNaatpeHN_AVZs"},"type":"array"};
const schema3 = {"$ref":"io.k8s.kube-aggregator.pkg.apis.apiregistration.v1beta1.APIService#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIService.js";
...
const schema5 = {"type":"string","enum":["APIServiceList"]};
...
/*# sourceURL="io.k8s.kube-aggregator.pkg.apis.apiregistration.v1beta1.APIServiceList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
