...
const schema0 = {"properties":{"nonResourceRules":{"$ref":"3TAlsnOzDS96bEW_ESUtJii1f6mIffVcPbUXPw-UJiU"},"resourceRules":{"$ref":"wCcJBeMMj-TNrGQ2DdfthZBUrHoEYTfuPzEPPKxcnNY"},"subjects":{"$ref":"tfhhYd2kniWVQHpeqjAHH5AqRBvwRRAsFjwqfLdbQz4"}},"required":["subjects"],"type":"object","$id":"io.k8s.api.flowcontrol.v1.PolicyRulesWithSubjects"};
const schema1 = {"items":{"$ref":"tQPjkvgBvoi7dV0pfDj-OVEL4U9zK3prlFyZMwmMGQ0"},"type":"array","nullable":true};
const schema2 = {"$ref":"io.k8s.api.flowcontrol.v1.NonResourcePolicyRule#"};
const schema3 = {};

import { validate as validate3 } from "./IoK8sApiFlowcontrolV1NonResourcePolicyRule.js";
...
const schema4 = {"items":{"$ref":"lZwPuTXsBSEL2MUjLOZQIM1DxWFH9JYs_yUC9LnrRQc"},"type":"array","nullable":true};
const schema5 = {"$ref":"io.k8s.api.flowcontrol.v1.ResourcePolicyRule#"};
const schema6 = {};

import { validate as validate9 } from "./IoK8sApiFlowcontrolV1ResourcePolicyRule.js";
...
const schema7 = {"items":{"$ref":"QmIfRUeZRDBh7gmgK_ctYXK4oMURchhls2wSpegAIBM"},"type":"array"};
const schema8 = {"$ref":"io.k8s.api.flowcontrol.v1.Subject#"};
const schema9 = {};

import { validate as validate15 } from "./IoK8sApiFlowcontrolV1Subject.js";
...
/*# sourceURL="io.k8s.api.flowcontrol.v1.PolicyRulesWithSubjects" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
