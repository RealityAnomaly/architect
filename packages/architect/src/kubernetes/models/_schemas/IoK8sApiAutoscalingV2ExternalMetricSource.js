...
const schema0 = {"properties":{"metric":{"$ref":"HhIW3eWSXOltn7SemUIsPuCS7UE0PSh1IWsMg8ta2ZE"},"target":{"$ref":"xjHD2zXMIlooXvmTxXzwc4ktFagRb6fAYasSY0Yuq7k"}},"required":["metric","target"],"type":"object","$id":"io.k8s.api.autoscaling.v2.ExternalMetricSource"};
const schema1 = {"$ref":"io.k8s.api.autoscaling.v2.MetricIdentifier#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiAutoscalingV2MetricIdentifier.js";
...
const schema3 = {"$ref":"io.k8s.api.autoscaling.v2.MetricTarget#"};
const schema4 = {};

import { validate as validate6 } from "./IoK8sApiAutoscalingV2MetricTarget.js";
