...
const schema0 = {"properties":{"apiVersion":{"$ref":"yAY_1MoU303aAtcQvMdhbOYMuzjr4eot9RMpeMMUNiw"},"kind":{"$ref":"zoVP92hWGZHWooNY3_wJmhG9u6f56ehIo6ungpSqVpE"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"EOKpQGOZ4omwSb0QknWFtRJ5mHELyeJ7LqGwJwZRfWE"},"status":{"$ref":"PsYQ8Cy0UAJ7xL2Y7x98meMC-gdW46oW9PZ1_Hk3a7c"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIService"};
const schema1 = {"type":"string","enum":["apiregistration.k8s.io/v1"]};
...
if(!(data === "apiregistration.k8s.io/v1")){
...
const schema5 = {"nullableRef":"io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIServiceStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sKubeAggregatorPkgApisApiregistrationV1APIServiceStatus.js";
...
/*# sourceURL="io.k8s.kube-aggregator.pkg.apis.apiregistration.v1.APIService" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
