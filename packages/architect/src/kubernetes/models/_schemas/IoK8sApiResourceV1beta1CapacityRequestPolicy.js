...
const schema0 = {"properties":{"default":{"$ref":"pp_xaFlNXkKoD6DTqyaUAeP7lGItJ9_hKwPxmHYeCNA"},"validRange":{"$ref":"5Bl4xiP2XnfrJP0h7_wEI58BbjpSrNkrkQ7mr9zKE2E"},"validValues":{"$ref":"wTSPP-ovF8Joa5mZZqgkMv-4MHc_K-tIJpjRmF_KYe8"}},"type":"object","$id":"io.k8s.api.resource.v1beta1.CapacityRequestPolicy"};
...
const schema3 = {"nullableRef":"io.k8s.api.resource.v1beta1.CapacityRequestPolicyRange#"};
const schema4 = {};

import { validate as validate6 } from "./IoK8sApiResourceV1beta1CapacityRequestPolicyRange.js";
...
/*# sourceURL="io.k8s.api.resource.v1beta1.CapacityRequestPolicy" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
