...
const schema0 = {"properties":{"apiVersion":{"$ref":"5pY-oklhJpKtSHNMeCeDBPhql0poW2YUEPr4Nv9aMyI"},"kind":{"$ref":"xIEUd4mio-0IuwvGm1vqGkAnPh_XO5GHVCrQ7EQs3Eg"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"20zFcF37zJfBLRVCmkZrtb4IxBEMtmVMB_nR1PH0c1M"},"status":{"$ref":"ai-lSAfyUygpX5_EIwu-dj30BSXSQoKKEuOawDjRChY"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.scheduling.v1alpha2.PodGroup"};
...
const schema2 = {"type":"string","enum":["PodGroup"]};
...
const schema5 = {"$ref":"io.k8s.api.scheduling.v1alpha2.PodGroupSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiSchedulingV1alpha2PodGroupSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.scheduling.v1alpha2.PodGroupStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiSchedulingV1alpha2PodGroupStatus.js";
...
/*# sourceURL="io.k8s.api.scheduling.v1alpha2.PodGroup" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
