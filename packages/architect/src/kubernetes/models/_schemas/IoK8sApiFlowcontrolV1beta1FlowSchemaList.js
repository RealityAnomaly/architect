...
const schema0 = {"properties":{"apiVersion":{"$ref":"Gg_wMmraQeeX_qlRWo7nMtRGqgTAwGq14mnrWWoJrts"},"items":{"$ref":"69Kj6MRAKlzjUs449ZV7WyRQReJb5S8WMJeL1x9wka0"},"kind":{"$ref":"Xvy4EaWfNkXjLpKWbTzAQIZIsHScpVnZCELiteAHIaY"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.flowcontrol.v1beta1.FlowSchemaList"};
...
const schema2 = {"items":{"$ref":"N-42dSGPOAXQDJAJ-TujeiPEeEw2Zz8gDqpA_yNMY2U"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.flowcontrol.v1beta1.FlowSchema#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiFlowcontrolV1beta1FlowSchema.js";
...
const schema5 = {"type":"string","enum":["FlowSchemaList"]};
...
/*# sourceURL="io.k8s.api.flowcontrol.v1beta1.FlowSchemaList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
