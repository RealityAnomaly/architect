...
const schema1 = {"properties":{"failurePolicy":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"matchConditions":{"$ref":"O75pOHlRNVvuYKje6cXJ0CnsLAadOqtU8sbhm5NoavE"},"matchConstraints":{"$ref":"73ALkj3Px5oyNUnchRkDz-wTuW7-nl6Zflwnowe4c3c"},"mutations":{"$ref":"baAqjyRT54mKAAXXqjkUSq_b8OnSqrVhUA_qGrSFzMk"},"paramKind":{"$ref":"wnpy33SNdMuWIIBlxNFQrLHtG_qcaN2vX5dzntxV_mk"},"reinvocationPolicy":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"variables":{"$ref":"0p5nzESQUGHrn7qBUGmAMi9Eaz_73G5LzB5vxPc3Upc"}},"type":"object","$id":"io.k8s.api.admissionregistration.v1.MutatingAdmissionPolicySpec"};
...
const schema2 = {"items":{"$ref":"U9y3_uQNyUW85_S0jZjMrwRdfL3bM2BqurnENuMBmD8"},"type":"array","nullable":true};
const schema3 = {"$ref":"io.k8s.api.admissionregistration.v1.MatchCondition#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiAdmissionregistrationV1MatchCondition.js";
...
const schema5 = {"nullableRef":"io.k8s.api.admissionregistration.v1.MatchResources#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAdmissionregistrationV1MatchResources.js";
...
const schema7 = {"items":{"$ref":"VnHE0oUEJ-IrruUYs3MSUK9bfMP3fOTC7cyqdT4O55I"},"type":"array","nullable":true};
const schema8 = {"$ref":"io.k8s.api.admissionregistration.v1.Mutation#"};
const schema9 = {};

import { validate as validate15 } from "./IoK8sApiAdmissionregistrationV1Mutation.js";
...
import { validate as validate20 } from "./IoK8sApiAdmissionregistrationV1ParamKind.js";
...
const schema12 = {"items":{"$ref":"B7ZitJNSpt2pnvKNM5CCUYV5jKWa6DQ6gbbqg9U5T5c"},"type":"array","nullable":true};
const schema13 = {"$ref":"io.k8s.api.admissionregistration.v1.Variable#"};
const schema14 = {};

import { validate as validate26 } from "./IoK8sApiAdmissionregistrationV1Variable.js";
...
/*# sourceURL="io.k8s.api.admissionregistration.v1.MutatingAdmissionPolicySpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
