...
const schema0 = {"properties":{"apiVersion":{"$ref":"I2rC4AZeN16vyliIXvprq-UnxvxFKXyEtwjcNn0IxB8"},"kind":{"$ref":"CSn1Q6fmcnNYjabUOkwjTd_rKNrQGxHh8S_J2NkueDg"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"webhooks":{"$ref":"2wmJpfdEZaT7w7tFxSx4aGKTANs0ex6zSRaqrAjvSCk"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.admissionregistration.v1.MutatingWebhookConfiguration"};
...
const schema2 = {"type":"string","enum":["MutatingWebhookConfiguration"]};
...
if(!(data === "MutatingWebhookConfiguration")){
...
const schema5 = {"items":{"$ref":"Err4_1Lo81lVAerkfShbdBhCNCNcUH6pRgBxbuHpYIo"},"type":"array","nullable":true};
const schema6 = {"$ref":"io.k8s.api.admissionregistration.v1.MutatingWebhook#"};
const schema7 = {};

import { validate as validate11 } from "./IoK8sApiAdmissionregistrationV1MutatingWebhook.js";
...
/*# sourceURL="io.k8s.api.admissionregistration.v1.MutatingWebhookConfiguration" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
