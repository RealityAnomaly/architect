...
const schema2 = {"nullableRef":"io.k8s.api.core.v1.ContainerRestartRuleOnExitCodes#"};
const schema3 = {};

import { validate as validate4 } from "./IoK8sApiCoreV1ContainerRestartRuleOnExitCodes.js";
...
/*# sourceURL="io.k8s.api.core.v1.ContainerRestartRule" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
if(data.exitCodes !== undefined){
let data1 = data.exitCodes;
const _errs2 = errors;
if(!(validate3(data1, {instancePath:instancePath+"/exitCodes",parentData:data,parentDataProperty:"exitCodes",rootData}))){
