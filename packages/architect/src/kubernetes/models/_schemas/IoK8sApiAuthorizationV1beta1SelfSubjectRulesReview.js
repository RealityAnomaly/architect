...
const schema0 = {"properties":{"apiVersion":{"$ref":"g9DqmMmk-diVp4D1OdEMO9poINNywrXd8nQgI_yuOFA"},"kind":{"$ref":"qxW2I_xIzZAQGv4T3-r-oRT20x3wv51myp9IiksF1Uw"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"uP6uRXDxtczelworU-1moem_K5sZnTWdNC0OuiNdigo"},"status":{"$ref":"c__usdR9rQV6BSKlxFXI-swYzm6Fvps-WmtFuKlEhwE"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.authorization.v1beta1.SelfSubjectRulesReview"};
const schema1 = {"type":"string","enum":["authorization.k8s.io/v1beta1"]};
...
if(!(data === "authorization.k8s.io/v1beta1")){
...
const schema2 = {"type":"string","enum":["SelfSubjectRulesReview"]};
...
if(!(data === "SelfSubjectRulesReview")){
...
const schema5 = {"$ref":"io.k8s.api.authorization.v1beta1.SelfSubjectRulesReviewSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAuthorizationV1beta1SelfSubjectRulesReviewSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.authorization.v1beta1.SubjectRulesReviewStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAuthorizationV1beta1SubjectRulesReviewStatus.js";
...
/*# sourceURL="io.k8s.api.authorization.v1beta1.SelfSubjectRulesReview" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
