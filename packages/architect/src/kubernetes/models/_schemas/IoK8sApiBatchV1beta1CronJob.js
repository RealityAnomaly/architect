...
const schema0 = {"properties":{"apiVersion":{"$ref":"mb4inw4IOYliJ7sqiWtMD81XC-naOYycLFCLbNXK-rg"},"kind":{"$ref":"6xKv4pTdDB3wRvkqcIHiD8rkKZyVB7ADkjUy8OUN6Ao"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"QEngJyBaeoC-naYbw3ykgiMj6deKjLoB4QvPwv8UpsY"},"status":{"$ref":"swMTZV4i9ykJDQwyrcC7IDwbF1RLbkBfUZqUWINcG0w"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.batch.v1beta1.CronJob"};
const schema1 = {"type":"string","enum":["batch/v1beta1"]};
...
const schema5 = {"nullableRef":"io.k8s.api.batch.v1beta1.CronJobSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiBatchV1beta1CronJobSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.batch.v1beta1.CronJobStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiBatchV1beta1CronJobStatus.js";
...
/*# sourceURL="io.k8s.api.batch.v1beta1.CronJob" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
