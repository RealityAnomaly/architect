...
const schema3 = {"items":{"$ref":"yCWob0T3CkQ0xoWhxeT5jjuQT0wWJKZlP8WliFZ8LTs"},"type":"array","nullable":true};
const schema4 = {"$ref":"io.k8s.api.apps.v1beta2.StatefulSetCondition#"};
const schema5 = {};

import { validate as validate6 } from "./IoK8sApiAppsV1beta2StatefulSetCondition.js";
...
/*# sourceURL="io.k8s.api.apps.v1beta2.StatefulSetStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
