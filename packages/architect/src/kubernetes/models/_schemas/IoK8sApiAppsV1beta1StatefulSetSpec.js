...
const schema1 = {"properties":{"podManagementPolicy":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"replicas":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"revisionHistoryLimit":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"selector":{"$ref":"ft7HGURTbPyh-vhzFAYgnhVehb5DIkOC1Qu-kP-9F84"},"serviceName":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"template":{"$ref":"SbN1rvaZBSVKM0AiyQONz32lv4L14pFnWFUIJk4xq20"},"updateStrategy":{"$ref":"ESPWXma2uwvMXxSJVxsFP64Ksvi2D6ALeVY05yeZKm8"},"volumeClaimTemplates":{"$ref":"KIL9btdFjuKTaXZZbgZ0ski4OsEpHWRevPJV_rv7LJ8"}},"required":["template","serviceName"],"type":"object","$id":"io.k8s.api.apps.v1beta1.StatefulSetSpec"};
...
import { validate as validate7 } from "./../../apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1LabelSelector.js";
...
import { validate as validate13 } from "./IoK8sApiCoreV1PodTemplateSpec.js";
...
const schema8 = {"nullableRef":"io.k8s.api.apps.v1beta1.StatefulSetUpdateStrategy#"};
const schema9 = {};

import { validate as validate17 } from "./IoK8sApiAppsV1beta1StatefulSetUpdateStrategy.js";
...
import { validate as validate22 } from "./IoK8sApiCoreV1PersistentVolumeClaim.js";
...
/*# sourceURL="io.k8s.api.apps.v1beta1.StatefulSetSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
const err1 = {instancePath,schemaPath:"#/required",keyword:"required",params:{missingProperty: "serviceName"}};
if(vErrors === null){
vErrors = [err1];
}
else {
