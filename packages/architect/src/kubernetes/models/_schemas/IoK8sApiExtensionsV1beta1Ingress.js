...
const schema0 = {"properties":{"apiVersion":{"$ref":"7jsfkhcEDyoudlBfDD9y8QHrxewtIHKzZK30E_TSwdk"},"kind":{"$ref":"xjHI2o0rUoP8LyH-DWsGATiTRHPrbYwPedmnsrNachI"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"uftRRNQwk7ho5b1fJmAoILnI6z7ZUQkjnAsbly5ZlYk"},"status":{"$ref":"ZObEe98a02VHHWLuVv3BcF2M9luAjVEJElRSOrE4ZVA"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.extensions.v1beta1.Ingress"};
...
const schema5 = {"nullableRef":"io.k8s.api.extensions.v1beta1.IngressSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiExtensionsV1beta1IngressSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.extensions.v1beta1.IngressStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiExtensionsV1beta1IngressStatus.js";
...
/*# sourceURL="io.k8s.api.extensions.v1beta1.Ingress" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
