...
const schema0 = {"properties":{"apiVersion":{"$ref":"HpsEyiWOInqhlY0dIoLKmMEFK0Hs6s0dhtLNqVM-2Fk"},"items":{"$ref":"7L_tMpsoyhVSgFQLKgPxgBtLR11joUE44gIwQi5mTDw"},"kind":{"$ref":"91L5wWeczYAYXzucOu3DrLH3leT68IuBdENKLJrvW9Y"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.scheduling.v1.PriorityClassList"};
const schema1 = {"type":"string","enum":["scheduling.k8s.io/v1"]};
...
const schema2 = {"items":{"$ref":"0Ror_CKYNI44ZbFu1m7JVTsbpK7QIBMhBGdH3xBv8mo"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.scheduling.v1.PriorityClass#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiSchedulingV1PriorityClass.js";
...
/*# sourceURL="io.k8s.api.scheduling.v1.PriorityClassList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
