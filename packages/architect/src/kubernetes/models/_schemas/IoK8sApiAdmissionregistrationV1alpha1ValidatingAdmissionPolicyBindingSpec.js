...
const schema0 = {"properties":{"matchResources":{"$ref":"z2uclWS4Axm5lAAiAJuQlWwMKHxj93Oi06AP-8J4EFQ"},"paramRef":{"$ref":"0zEUWYwerYbs_qQtJ31c6u78b3pkfG0wQDggUyYr-u8"},"policyName":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"validationActions":{"$ref":"uqi-NWpwJAtCtKg340P2GU85hOwdccNKh8Eansj5IGE"}},"type":"object","$id":"io.k8s.api.admissionregistration.v1alpha1.ValidatingAdmissionPolicyBindingSpec"};
const schema1 = {"nullableRef":"io.k8s.api.admissionregistration.v1alpha1.MatchResources#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiAdmissionregistrationV1alpha1MatchResources.js";
...
import { validate as validate6 } from "./IoK8sApiAdmissionregistrationV1alpha1ParamRef.js";
...
/*# sourceURL="io.k8s.api.admissionregistration.v1alpha1.ValidatingAdmissionPolicyBindingSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
