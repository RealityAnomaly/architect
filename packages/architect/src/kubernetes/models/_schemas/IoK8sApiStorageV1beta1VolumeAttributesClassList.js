...
const schema0 = {"properties":{"apiVersion":{"$ref":"VqCulr_ZES6zbEl6HyGvOlGSJNmM2F7NvLFbdnOvTVs"},"items":{"$ref":"MAz2H85wbFCM99QKOskK9se0AGiFcaeg_Z5QrgADjz4"},"kind":{"$ref":"MwaWuJi-XYeknF8tDccqQ9zmKhHh0npOv05W_3uBNuU"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.storage.v1beta1.VolumeAttributesClassList"};
const schema1 = {"type":"string","enum":["storage.k8s.io/v1beta1"]};
...
const schema2 = {"items":{"$ref":"RB8g857ne5nyy3xz8572luac9T6F4B_VvoZ-lhGuIOQ"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.storage.v1beta1.VolumeAttributesClass#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiStorageV1beta1VolumeAttributesClass.js";
...
/*# sourceURL="io.k8s.api.storage.v1beta1.VolumeAttributesClassList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
