...
const schema2 = {"items":{"$ref":"-iFpL4OINxRJEKZa8RpR3jQO1sVJk_Pc5l88HlUZIng"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.core.v1.EphemeralContainer#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiCoreV1EphemeralContainer.js";
...
const schema5 = {"type":"string","enum":["EphemeralContainers"]};
...
/*# sourceURL="io.k8s.api.core.v1.EphemeralContainers" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
if(data.ephemeralContainers === undefined){
const err0 = {instancePath,schemaPath:"#/required",keyword:"required",params:{missingProperty: "ephemeralContainers"}};
if(vErrors === null){
vErrors = [err0];
}
else {
...
if(data.ephemeralContainers !== undefined){
let data1 = data.ephemeralContainers;
const _errs2 = errors;
if(!(validate3(data1, {instancePath:instancePath+"/ephemeralContainers",parentData:data,parentDataProperty:"ephemeralContainers",rootData}))){
