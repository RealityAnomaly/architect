...
const schema0 = {"properties":{"apiVersion":{"$ref":"EPmww6ScpIdrvGZbecHxe5rkgzG-onx3jmIyKzecIzE"},"items":{"$ref":"L0tJp7SFeR8zEexIHbulVm__R1wm0uT0-9lEGckFWps"},"kind":{"$ref":"SYxG3vye-NG_RVGIh56O9MZAJmeeCWkOSPQLVQiJVvQ"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerList"};
...
const schema2 = {"items":{"$ref":"kqROKrHWA59M_4y4sHiHKuJxM-B2kGZHtdG6HvO-Pg4"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.autoscaling.v2.HorizontalPodAutoscaler#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiAutoscalingV2HorizontalPodAutoscaler.js";
...
/*# sourceURL="io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
