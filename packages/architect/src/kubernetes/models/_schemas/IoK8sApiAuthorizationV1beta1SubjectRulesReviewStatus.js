...
const schema0 = {"properties":{"evaluationError":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"incomplete":{"$ref":"C6hei-tisjs1kz7xDhDJSDhsoUlCo3cumzNSDD7Je7A"},"nonResourceRules":{"$ref":"RM_lOxC3a1MP-0wBlviwyqMXj3RlO9Q7zsnDRcArtTo"},"resourceRules":{"$ref":"3LBJndOQYwTidUvZnlWFyTvJIxEp9afrbK3Ex3vrM9A"}},"required":["resourceRules","nonResourceRules","incomplete"],"type":"object","$id":"io.k8s.api.authorization.v1beta1.SubjectRulesReviewStatus"};
...
const schema3 = {"items":{"$ref":"fMom4kE6Zj9MIlLHx0DuDlCDmZpuzpVVIQgWOXoQ2NQ"},"type":"array"};
const schema4 = {"$ref":"io.k8s.api.authorization.v1beta1.NonResourceRule#"};
const schema5 = {};

import { validate as validate7 } from "./IoK8sApiAuthorizationV1beta1NonResourceRule.js";
...
const schema6 = {"items":{"$ref":"W-AyRWOb1XeDw5xXhud4bPmVd0fJX0rE472WuZFAhF8"},"type":"array"};
const schema7 = {"$ref":"io.k8s.api.authorization.v1beta1.ResourceRule#"};
const schema8 = {};

import { validate as validate13 } from "./IoK8sApiAuthorizationV1beta1ResourceRule.js";
