...
const schema2 = {"type":"string","enum":["ResourcePoolStatusRequest"]};
...
if(!(data === "ResourcePoolStatusRequest")){
...
const schema3 = {"$ref":"io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta#"};
const schema4 = {};
...
const schema5 = {"$ref":"io.k8s.api.resource.v1alpha3.ResourcePoolStatusRequestSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiResourceV1alpha3ResourcePoolStatusRequestSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.resource.v1alpha3.ResourcePoolStatusRequestStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiResourceV1alpha3ResourcePoolStatusRequestStatus.js";
...
/*# sourceURL="io.k8s.api.resource.v1alpha3.ResourcePoolStatusRequest" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
