...
const schema0 = {"properties":{"apiVersion":{"$ref":"qFxjlRgnFy8rsS3DXNoRWXTbA1LI5QMudW7t-VRniiY"},"kind":{"$ref":"J3uRFMHCV0jmjCaeTp4-SvJUxwZmlvS-TBRqF5nI0kM"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"vhMzOIuYzthmTP05Hn7F0ctsaVazsqEMn_sB05ugqNg"},"status":{"$ref":"BFOm4wOEKCI86ueDA5lYWoSuKTB_zXA-CuKZVvxXJX8"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.resource.v1alpha1.ResourceClaim"};
...
const schema5 = {"$ref":"io.k8s.api.resource.v1alpha1.ResourceClaimSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiResourceV1alpha1ResourceClaimSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.resource.v1alpha1.ResourceClaimStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiResourceV1alpha1ResourceClaimStatus.js";
...
/*# sourceURL="io.k8s.api.resource.v1alpha1.ResourceClaim" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
