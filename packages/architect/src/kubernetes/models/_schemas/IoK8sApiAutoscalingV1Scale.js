...
const schema0 = {"properties":{"apiVersion":{"$ref":"KtZhGzAR3p1yw0aXv-HtzSXiQeG9-uEC_mdFCrutAwM"},"kind":{"$ref":"le0TeL8UrjqhxeMR_MNM4DpQMFgQCtj-jSqubpcDHsw"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"5v-1-nf2vmD_DAbi2x6rk29e7bDp8b-e0s8Jz0XwK9E"},"status":{"$ref":"u6YFHZZA1tGTu6OkYIVu0b19yEBYRWtpIX7cw-uoCgA"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.autoscaling.v1.Scale"};
...
const schema2 = {"type":"string","enum":["Scale"]};
...
const schema5 = {"nullableRef":"io.k8s.api.autoscaling.v1.ScaleSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAutoscalingV1ScaleSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.autoscaling.v1.ScaleStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAutoscalingV1ScaleStatus.js";
...
/*# sourceURL="io.k8s.api.autoscaling.v1.Scale" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
