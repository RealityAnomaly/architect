...
const schema0 = {"properties":{"nonResourceRules":{"$ref":"zJWdCGdSon1mNoEBt5ymm8HhAxLC-fQLdQL5BZoJNN8"},"resourceRules":{"$ref":"iOoElfSK89q3FToZ7iFn41CBerYbr64MluTTPtJ9O_o"},"subjects":{"$ref":"w8LmzA0HMSY56j4XpV5iDUsD8Q8A0ilKwsfpmnZzhDg"}},"required":["subjects"],"type":"object","$id":"io.k8s.api.flowcontrol.v1beta1.PolicyRulesWithSubjects"};
const schema1 = {"items":{"$ref":"8ofsusjy8ns2P_at1oKaAAPn2rtCuHMEhpFk-YKOMeY"},"type":"array","nullable":true};
const schema2 = {"$ref":"io.k8s.api.flowcontrol.v1beta1.NonResourcePolicyRule#"};
const schema3 = {};

import { validate as validate3 } from "./IoK8sApiFlowcontrolV1beta1NonResourcePolicyRule.js";
...
const schema4 = {"items":{"$ref":"6Im5Y7mbg8EF0EWq_PR5drGKRPjiujATDQJuMVknNE4"},"type":"array","nullable":true};
const schema5 = {"$ref":"io.k8s.api.flowcontrol.v1beta1.ResourcePolicyRule#"};
const schema6 = {};

import { validate as validate9 } from "./IoK8sApiFlowcontrolV1beta1ResourcePolicyRule.js";
...
const schema7 = {"items":{"$ref":"yqiuHQX7y0rrD1Oy9HhGEcMMslPSQXMT_aSJDHTq5Ts"},"type":"array"};
const schema8 = {"$ref":"io.k8s.api.flowcontrol.v1beta1.Subject#"};
const schema9 = {};

import { validate as validate15 } from "./IoK8sApiFlowcontrolV1beta1Subject.js";
