...
const schema0 = {"properties":{"allocationMultiplier":{"$ref":"pp_xaFlNXkKoD6DTqyaUAeP7lGItJ9_hKwPxmHYeCNA"},"capacityKey":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"}},"type":"object","$id":"io.k8s.api.resource.v1beta2.NodeAllocatableResourceMapping"};
...
/*# sourceURL="io.k8s.api.resource.v1beta2.NodeAllocatableResourceMapping" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
