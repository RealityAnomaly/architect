...
import { validate as validate7 } from "./IoK8sApiCoreV1TopologySelectorTerm.js";
...
const schema7 = {"type":"string","enum":["storage.k8s.io/v1"]};
...
import { validate as validate16 } from "./../../apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta.js";
...
/*# sourceURL="io.k8s.api.storage.v1.StorageClass" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
