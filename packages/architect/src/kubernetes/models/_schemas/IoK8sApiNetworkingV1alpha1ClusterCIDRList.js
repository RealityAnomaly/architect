...
const schema2 = {"items":{"$ref":"PIzTBDuVzzwmxvw5oDRm4zICe7_1avzXIuHE7R6-rfo"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.networking.v1alpha1.ClusterCIDR#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiNetworkingV1alpha1ClusterCIDR.js";
...
const schema5 = {"type":"string","enum":["ClusterCIDRList"]};
...
/*# sourceURL="io.k8s.api.networking.v1alpha1.ClusterCIDRList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
