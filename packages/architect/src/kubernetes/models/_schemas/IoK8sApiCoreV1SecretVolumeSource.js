...
const schema0 = {"properties":{"defaultMode":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"items":{"$ref":"8Wk-ynTc2BelUMN7bDaYKIeocW_gQ6wQLUVlv5vFw4M"},"optional":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"secretName":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"}},"type":"object","$id":"io.k8s.api.core.v1.SecretVolumeSource"};
...
import { validate as validate5 } from "./IoK8sApiCoreV1KeyToPath.js";
...
/*# sourceURL="io.k8s.api.core.v1.SecretVolumeSource" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
let data3 = data.secretName;
const _errs4 = errors;
if(!(validate11(data3, {instancePath:instancePath+"/secretName",parentData:data,parentDataProperty:"secretName",rootData}))){
