...
const schema8 = {"items":{"$ref":"hxPiVPDOyDnagyGJ52Sec4dMjcMeIaoA1O45ZFiFcE8"},"type":"array","nullable":true};
const schema9 = {"$ref":"io.k8s.api.resource.v1beta2.DeviceToleration#"};
const schema10 = {};

import { validate as validate22 } from "./IoK8sApiResourceV1beta2DeviceToleration.js";
...
/*# sourceURL="io.k8s.api.resource.v1beta2.DeviceRequestAllocationResult" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
