...
const schema0 = {"properties":{"apiVersion":{"$ref":"Gg_wMmraQeeX_qlRWo7nMtRGqgTAwGq14mnrWWoJrts"},"kind":{"$ref":"KznZLkFQwWO593jSmSPCGAI8EpaoEkx-61qxVvue1b4"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"Qmynla8ZQNWIgd09Cpr3izQpKgi4Jor59BUeTy1lO6I"},"status":{"$ref":"48v_xZcy9uQA9aSjLhJyZ5dXjGwNomPBwvMNkDHlkm8"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.flowcontrol.v1beta1.FlowSchema"};
...
const schema5 = {"nullableRef":"io.k8s.api.flowcontrol.v1beta1.FlowSchemaSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiFlowcontrolV1beta1FlowSchemaSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.flowcontrol.v1beta1.FlowSchemaStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiFlowcontrolV1beta1FlowSchemaStatus.js";
...
/*# sourceURL="io.k8s.api.flowcontrol.v1beta1.FlowSchema" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
