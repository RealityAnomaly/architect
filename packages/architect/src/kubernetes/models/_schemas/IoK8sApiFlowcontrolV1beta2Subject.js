...
const schema0 = {"properties":{"group":{"$ref":"l1wQjPCo_toxWSHuORtsEmg5Bfl_fWafL5-X1TKpQFU"},"kind":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"serviceAccount":{"$ref":"9CgSjv94yjOGJgi1QjoeiMyACD38ng4rAoqbS6-q66c"},"user":{"$ref":"VnVEqGbdHGP319UotrVTAV6bRTPkRVyTRtMLEVNa2Og"}},"required":["kind"],"type":"object","$id":"io.k8s.api.flowcontrol.v1beta2.Subject"};
const schema1 = {"nullableRef":"io.k8s.api.flowcontrol.v1beta2.GroupSubject#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiFlowcontrolV1beta2GroupSubject.js";
...
const schema4 = {"nullableRef":"io.k8s.api.flowcontrol.v1beta2.ServiceAccountSubject#"};
const schema5 = {};

import { validate as validate8 } from "./IoK8sApiFlowcontrolV1beta2ServiceAccountSubject.js";
...
const schema6 = {"nullableRef":"io.k8s.api.flowcontrol.v1beta2.UserSubject#"};
const schema7 = {};

import { validate as validate12 } from "./IoK8sApiFlowcontrolV1beta2UserSubject.js";
