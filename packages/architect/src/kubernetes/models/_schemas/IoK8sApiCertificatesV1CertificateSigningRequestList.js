...
const schema0 = {"properties":{"apiVersion":{"$ref":"Sra-NRo7CefYbfypn7c7Pu1mjpat95wYOHmqlWMFPSo"},"items":{"$ref":"zfrUkbf_NvQ_44NxbcKoHsec2o6DzJuVfSKZi28-I1E"},"kind":{"$ref":"4hmxu7xXxbh7ojSoqNgvfmiQLLawbO0rLoLZDKu-Bsk"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.certificates.v1.CertificateSigningRequestList"};
...
const schema2 = {"items":{"$ref":"dPEhLcPQHyKxcC49uMivqJilJXWT1oJt8cRt78gZxZQ"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.certificates.v1.CertificateSigningRequest#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiCertificatesV1CertificateSigningRequest.js";
...
const schema5 = {"type":"string","enum":["CertificateSigningRequestList"]};
...
if(!(data === "CertificateSigningRequestList")){
...
/*# sourceURL="io.k8s.api.certificates.v1.CertificateSigningRequestList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
