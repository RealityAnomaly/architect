...
const schema0 = {"properties":{"apiVersion":{"$ref":"_yBre2qde2l7-bZOH_E8tgLpNgX1ojdqcMWkg1LnigI"},"kind":{"$ref":"J3uRFMHCV0jmjCaeTp4-SvJUxwZmlvS-TBRqF5nI0kM"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"maCfrHbaLIhQc8aW5m2Y9jeq62WH9NMF6wHZnZTksjc"},"status":{"$ref":"H5uMLyaIbHB6tM1q2Q2ujfYN44IVIvOHOkF9tr53H-E"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.resource.v1beta2.ResourceClaim"};
const schema1 = {"type":"string","enum":["resource.k8s.io/v1beta2"]};
...
if(!(data === "resource.k8s.io/v1beta2")){
...
const schema5 = {"$ref":"io.k8s.api.resource.v1beta2.ResourceClaimSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiResourceV1beta2ResourceClaimSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.resource.v1beta2.ResourceClaimStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiResourceV1beta2ResourceClaimStatus.js";
...
/*# sourceURL="io.k8s.api.resource.v1beta2.ResourceClaim" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
