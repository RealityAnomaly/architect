...
const schema0 = {"properties":{"apiVersion":{"$ref":"9m0m8SoyQCy2Bfi718RXr-uTNWFv6wbopxcPn7SIavw"},"items":{"$ref":"t6Wb71DsT62Tz7r1TneGOAYPkvDJeR-q3EgnDA43elU"},"kind":{"$ref":"84nsQthInRF5rkqBuWsPpLcjWIrqBGejE1pM3M_JkZE"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.rbac.v1beta1.ClusterRoleBindingList"};
...
const schema2 = {"items":{"$ref":"CjH8YE-fELUO64_Oxpqxx_vnkOkXJJ5wjyFUxoU9MO0"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.rbac.v1beta1.ClusterRoleBinding#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiRbacV1beta1ClusterRoleBinding.js";
...
const schema5 = {"type":"string","enum":["ClusterRoleBindingList"]};
...
if(!(data === "ClusterRoleBindingList")){
...
/*# sourceURL="io.k8s.api.rbac.v1beta1.ClusterRoleBindingList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
