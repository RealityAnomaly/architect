...
const schema0 = {"properties":{"caBundle":{"$ref":"-qMnViG9CEC-V8_TFn4WYpvO2NOwI2XARBIst170yi0"},"service":{"$ref":"e7JSV2xlrn4_7vIcOMsMbR_P92zl8KrlFvGWu-knfTg"},"url":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"}},"type":"object","$id":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.WebhookClientConfig"};
...
const schema2 = {"nullableRef":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.ServiceReference#"};
const schema3 = {};

import { validate as validate4 } from "./IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1ServiceReference.js";
...
/*# sourceURL="io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.WebhookClientConfig" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
