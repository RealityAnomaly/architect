...
const schema0 = {"properties":{"applyConfiguration":{"$ref":"tUh2yrSUPIQJlwjWrFgvfZfu4u3ADcuYZnBF1uzLLCc"},"jsonPatch":{"$ref":"xRuz4LoFqqqGSoB7CnEwaCbDSt6No8ttIK39oNxCSiM"},"patchType":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"}},"required":["patchType"],"type":"object","$id":"io.k8s.api.admissionregistration.v1.Mutation"};
const schema1 = {"nullableRef":"io.k8s.api.admissionregistration.v1.ApplyConfiguration#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiAdmissionregistrationV1ApplyConfiguration.js";
...
const schema3 = {"nullableRef":"io.k8s.api.admissionregistration.v1.JSONPatch#"};
const schema4 = {};

import { validate as validate6 } from "./IoK8sApiAdmissionregistrationV1JSONPatch.js";
...
/*# sourceURL="io.k8s.api.admissionregistration.v1.Mutation" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
