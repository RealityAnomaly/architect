...
const schema1 = {"properties":{"allNodes":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"devices":{"$ref":"4yt2q4Q-_cc7kq2ASI9_fIfTuSd4jSuKbGlfNAYSRko"},"driver":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"nodeName":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"nodeSelector":{"$ref":"TkSNaYWIxhO85OVX_cSWzmQgv784eOxf9GMx98WTU1I"},"perDeviceNodeSelection":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"pool":{"$ref":"qRD9sR7_hdwnGjozOeu41lT7Sm_fAsnWcqUj62NLmpM"},"sharedCounters":{"$ref":"eo0s0WQoTxrdvIs37E8tEfl8s3das_eP9xDDl0x0gxE"}},"required":["driver","pool"],"type":"object","$id":"io.k8s.api.resource.v1beta1.ResourceSliceSpec"};
...
const schema2 = {"items":{"$ref":"KoZLL6TtBCEw3lt384YWsohPpvqH9yVs6VjIK3ooDRQ"},"type":"array","nullable":true};
const schema3 = {"$ref":"io.k8s.api.resource.v1beta1.Device#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiResourceV1beta1Device.js";
...
import { validate as validate14 } from "./IoK8sApiCoreV1NodeSelector.js";
...
const schema9 = {"$ref":"io.k8s.api.resource.v1beta1.ResourcePool#"};
const schema10 = {};

import { validate as validate19 } from "./IoK8sApiResourceV1beta1ResourcePool.js";
...
const schema11 = {"items":{"$ref":"IXsbU3fDNcIz0Wd3E19nF6323i-wzFi3TMssHrWOfOM"},"type":"array","nullable":true};
const schema12 = {"$ref":"io.k8s.api.resource.v1beta1.CounterSet#"};
const schema13 = {};

import { validate as validate24 } from "./IoK8sApiResourceV1beta1CounterSet.js";
...
/*# sourceURL="io.k8s.api.resource.v1beta1.ResourceSliceSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
