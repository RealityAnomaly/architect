...
const schema6 = {"properties":{"args":{"$ref":"uqi-NWpwJAtCtKg340P2GU85hOwdccNKh8Eansj5IGE"},"command":{"$ref":"uqi-NWpwJAtCtKg340P2GU85hOwdccNKh8Eansj5IGE"},"env":{"$ref":"tOvEOomFPQ11DQqhf-xjojT7Ag-xLjHW5nGYKYeaI_I"},"envFrom":{"$ref":"gWXSiRLIsl74n2BsEeonPQPvsBAUaLSJnw2Y47GiYSA"},"image":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"imagePullPolicy":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"lifecycle":{"$ref":"k63Lwaih-8VRlDKNVGz_QAtT2RdonzODqIwyXWTsJaE"},"livenessProbe":{"$ref":"1tfqPVU_qoMsGFMyOVh2kv-2hebwFnlRcgt89nVIEYU"},"name":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"ports":{"$ref":"n15VzIDDlfdmQKpJlPY3rY7T9yzotLgvU-EKobeebzY"},"readinessProbe":{"$ref":"1tfqPVU_qoMsGFMyOVh2kv-2hebwFnlRcgt89nVIEYU"},"resizePolicy":{"$ref":"Xg8GzaHkGqFhhR0ur-iLjKitodM6swNUXK1TDviV0VM"},"resources":{"$ref":"YJRTEWaEMMAL2EbRfoDU21RN4Ki3OAwPZa2m9VFEL8U"},"restartPolicy":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"restartPolicyRules":{"$ref":"HKn41UBVos3nSzZdJ8G_RtYYFz5utDtj31-D8QZJ9IY"},"securityContext":{"$ref":"X_uPdWt3XYGe8rFu7uPRzGQB_kqHFe5JpZoDpeC38SU"},"startupProbe":{"$ref":"1tfqPVU_qoMsGFMyOVh2kv-2hebwFnlRcgt89nVIEYU"},"stdin":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"stdinOnce":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"terminationMessagePath":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"terminationMessagePolicy":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"tty":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"volumeDevices":{"$ref":"u28fm44SLPyNkJk3LYIppL99gVuc9lsYfdGIoJeWfBk"},"volumeMounts":{"$ref":"usBZjbtoQnfcayV0LpyAqd7GDbxbzL1_cSYXig8l_pY"},"workingDir":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"}},"required":["name"],"type":"object","$id":"io.k8s.api.core.v1.Container"};
...
import { validate as validate13 } from "./IoK8sApiCoreV1EnvVar.js";
...
import { validate as validate19 } from "./IoK8sApiCoreV1EnvFromSource.js";
...
import { validate as validate26 } from "./IoK8sApiCoreV1Lifecycle.js";
...
import { validate as validate5 } from "./IoK8sApiCoreV1Probe.js";
...
import { validate as validate33 } from "./IoK8sApiCoreV1ContainerPort.js";
...
import { validate as validate40 } from "./IoK8sApiCoreV1ContainerResizePolicy.js";
...
import { validate as validate45 } from "./IoK8sApiCoreV1ResourceRequirements.js";
...
import { validate as validate51 } from "./IoK8sApiCoreV1ContainerRestartRule.js";
...
import { validate as validate56 } from "./IoK8sApiCoreV1SecurityContext.js";
...
import { validate as validate67 } from "./IoK8sApiCoreV1VolumeDevice.js";
...
import { validate as validate73 } from "./IoK8sApiCoreV1VolumeMount.js";
...
let data0 = data[i0];
const _errs2 = errors;
if(!(validate72(data0, {instancePath:instancePath+"/" + i0,parentData:data,parentDataProperty:i0,rootData}))){
...
/*# sourceURL="io.k8s.api.core.v1.Container" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
let data19 = data.terminationMessagePath;
const _errs20 = errors;
if(!(validate3(data19, {instancePath:instancePath+"/terminationMessagePath",parentData:data,parentDataProperty:"terminationMessagePath",rootData}))){
vErrors = vErrors === null ? validate3.errors : vErrors.concat(validate3.errors);
errors = vErrors.length;
}
else {
...
let data20 = data.terminationMessagePolicy;
const _errs21 = errors;
if(!(validate3(data20, {instancePath:instancePath+"/terminationMessagePolicy",parentData:data,parentDataProperty:"terminationMessagePolicy",rootData}))){
vErrors = vErrors === null ? validate3.errors : vErrors.concat(validate3.errors);
errors = vErrors.length;
}
else {
...
if(!(validate7(data21, {instancePath:instancePath+"/tty",parentData:data,parentDataProperty:"tty",rootData}))){
vErrors = vErrors === null ? validate7.errors : vErrors.concat(validate7.errors);
errors = vErrors.length;
}
else {
...
let data22 = data.volumeDevices;
const _errs23 = errors;
if(!(validate65(data22, {instancePath:instancePath+"/volumeDevices",parentData:data,parentDataProperty:"volumeDevices",rootData}))){
...
let data23 = data.volumeMounts;
const _errs24 = errors;
if(!(validate71(data23, {instancePath:instancePath+"/volumeMounts",parentData:data,parentDataProperty:"volumeMounts",rootData}))){
...
let data24 = data.workingDir;
const _errs25 = errors;
if(!(validate3(data24, {instancePath:instancePath+"/workingDir",parentData:data,parentDataProperty:"workingDir",rootData}))){
vErrors = vErrors === null ? validate3.errors : vErrors.concat(validate3.errors);
errors = vErrors.length;
}
else {
