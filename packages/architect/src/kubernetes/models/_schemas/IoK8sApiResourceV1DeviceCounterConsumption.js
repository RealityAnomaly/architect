...
const schema2 = {"additionalProperties":{"$ref":"iN8PeO7XOs97pc3Lnr1PBlJs5JinWRTdRTqIXUG4FdY"},"type":"object"};
const schema3 = {"$ref":"io.k8s.api.resource.v1.Counter#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiResourceV1Counter.js";
...
/*# sourceURL="io.k8s.api.resource.v1.DeviceCounterConsumption" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
