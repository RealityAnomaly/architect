...
const schema0 = {"properties":{"apiVersion":{"$ref":"U1DMoQ7fxmVPq6YAHUbj-ImNhNPiB0ln4S2gwI_B3RI"},"kind":{"$ref":"TsDFHmgoNOM6biY3WjZaYrfqcS795wROaRKTBXw4qiw"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"dQpnyq2qjH7ux_QVD0thTtkBAmfBUohtTR0fPhGqhHg"},"status":{"$ref":"-ec3YN_XJxf-o8cNmVidZjmym_cABeQLDr6Unri6u_E"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.autoscaling.v2beta1.HorizontalPodAutoscaler"};
const schema1 = {"type":"string","enum":["autoscaling/v2beta1"]};
...
const schema5 = {"nullableRef":"io.k8s.api.autoscaling.v2beta1.HorizontalPodAutoscalerSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.autoscaling.v2beta1.HorizontalPodAutoscalerStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAutoscalingV2beta1HorizontalPodAutoscalerStatus.js";
...
/*# sourceURL="io.k8s.api.autoscaling.v2beta1.HorizontalPodAutoscaler" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
