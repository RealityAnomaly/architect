...
const schema2 = {"items":{"$ref":"wJcwkQNnQ4U8iUXBkvohTZUeSmi9zf_JeYBHc3GS8V4"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.batch.v1beta1.CronJob#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiBatchV1beta1CronJob.js";
...
/*# sourceURL="io.k8s.api.batch.v1beta1.CronJobList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
