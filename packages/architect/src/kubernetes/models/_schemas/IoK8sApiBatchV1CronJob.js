...
const schema0 = {"properties":{"apiVersion":{"$ref":"FgIYb3fE7bKYdUE9nA-p-zAk13Ajzu9FvWgcmKhMCK8"},"kind":{"$ref":"6xKv4pTdDB3wRvkqcIHiD8rkKZyVB7ADkjUy8OUN6Ao"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"x-frqFSIjBesCKgz-3S7djP-u6U8BSn2L5gHamfv09g"},"status":{"$ref":"0GDczpHk_df9V3bPKEfoUNgJa18yP4g0UOg8wiM_jJ0"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.batch.v1.CronJob"};
const schema1 = {"type":"string","enum":["batch/v1"]};
...
const schema5 = {"$ref":"io.k8s.api.batch.v1.CronJobSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiBatchV1CronJobSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.batch.v1.CronJobStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiBatchV1CronJobStatus.js";
...
/*# sourceURL="io.k8s.api.batch.v1.CronJob" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
