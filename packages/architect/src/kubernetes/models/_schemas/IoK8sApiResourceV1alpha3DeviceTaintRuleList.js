...
const schema0 = {"properties":{"apiVersion":{"$ref":"JhWvHbSFO3ELsap4IWTkIXEjLRfpdwhmVqXnItVBFvQ"},"items":{"$ref":"DM-MZtz65_Bhm6MGhFNUuBOIDH3QJbqcvXPLC1s2NP8"},"kind":{"$ref":"KBXrqlJN5iMfw4UcSEX45j1Tt7PH1K-xLIHPRGbS0sI"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.resource.v1alpha3.DeviceTaintRuleList"};
...
const schema2 = {"items":{"$ref":"0DijHg0hAKpfbw3x3R7sJotTURpU-_W6k_-PGvh6XRc"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.resource.v1alpha3.DeviceTaintRule#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiResourceV1alpha3DeviceTaintRule.js";
...
const schema5 = {"type":"string","enum":["DeviceTaintRuleList"]};
...
/*# sourceURL="io.k8s.api.resource.v1alpha3.DeviceTaintRuleList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
