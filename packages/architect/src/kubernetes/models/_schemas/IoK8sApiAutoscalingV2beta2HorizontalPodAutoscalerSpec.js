...
const schema0 = {"properties":{"behavior":{"$ref":"-TapD-oVSLBW76q8k8445Ne7vDj8IbJ3QD9SGHbsmXc"},"maxReplicas":{"$ref":"6VbGrbfqnPJ4dMmNewHbRn4M59VZOmu0uhV1edBN8qE"},"metrics":{"$ref":"HChmsZejyFCsbQ8ipsoqq6eiLiyAGyaBrDoR_62dSMc"},"minReplicas":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"scaleTargetRef":{"$ref":"hFdL5OyfzttaYZxGu3oOaufCq84UntPUcV0bnxsh6QA"}},"required":["scaleTargetRef","maxReplicas"],"type":"object","$id":"io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscalerSpec"};
const schema1 = {"nullableRef":"io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscalerBehavior#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiAutoscalingV2beta2HorizontalPodAutoscalerBehavior.js";
...
const schema4 = {"items":{"$ref":"WiNYI3A-pGoKDoDprnfQorjpz9tqzURe2YepermVjX8"},"type":"array","nullable":true};
const schema5 = {"$ref":"io.k8s.api.autoscaling.v2beta2.MetricSpec#"};
const schema6 = {};

import { validate as validate9 } from "./IoK8sApiAutoscalingV2beta2MetricSpec.js";
...
const schema8 = {"$ref":"io.k8s.api.autoscaling.v2beta2.CrossVersionObjectReference#"};
const schema9 = {};

import { validate as validate16 } from "./IoK8sApiAutoscalingV2beta2CrossVersionObjectReference.js";
...
/*# sourceURL="io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscalerSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
