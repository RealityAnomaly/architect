...
const schema0 = {"properties":{"apiVersion":{"$ref":"VNCjMUmpUTHhXie3V65B9vagOlLL1JQoY6SzNxwGrKY"},"kind":{"$ref":"3G_d2Z0vTksL0qQ4hI4iOE-_j84LodoQb2ABJaNZCMo"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"xCibcsjnmOKbEu2QT5i1rxh2b3CIBG0jjvtbJ-nkjqI"},"status":{"$ref":"Rb-R2FUtP3nhKhGygJXwUA8fVBkV30bK4C4tpGaJFeM"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.storagemigration.v1alpha1.StorageVersionMigration"};
const schema1 = {"type":"string","enum":["storagemigration.k8s.io/v1alpha1"]};
...
if(!(data === "storagemigration.k8s.io/v1alpha1")){
...
const schema2 = {"type":"string","enum":["StorageVersionMigration"]};
...
if(!(data === "StorageVersionMigration")){
...
const schema5 = {"nullableRef":"io.k8s.api.storagemigration.v1alpha1.StorageVersionMigrationSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiStoragemigrationV1alpha1StorageVersionMigrationSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.storagemigration.v1alpha1.StorageVersionMigrationStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiStoragemigrationV1alpha1StorageVersionMigrationStatus.js";
...
/*# sourceURL="io.k8s.api.storagemigration.v1alpha1.StorageVersionMigration" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
