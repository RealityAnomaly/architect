...
const schema0 = {"properties":{"apiVersion":{"$ref":"bmUSx3GwTpT_skQdL_E-LdWligvUQoO8M-V4fX8HBv0"},"items":{"$ref":"DpvLYLC4ydQsfu-ednUnqS50Yo5dEdPV_yd80eW_JJE"},"kind":{"$ref":"wzbCht4ZjZ7oxafPpE4RQ1Mz3OqYyX70bs2EySUNWfs"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.networking.v1.NetworkPolicyList"};
...
const schema2 = {"items":{"$ref":"64TygujknfhM-QSzrjGs51QWGgl7TWJiAwTgRba9qe4"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.networking.v1.NetworkPolicy#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiNetworkingV1NetworkPolicy.js";
...
const schema5 = {"type":"string","enum":["NetworkPolicyList"]};
...
/*# sourceURL="io.k8s.api.networking.v1.NetworkPolicyList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
