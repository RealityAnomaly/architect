...
const schema0 = {"properties":{"apiVersion":{"$ref":"_-ZvS-rLxHiNEArQOhevVo83klxV-qnul8X_v4BZ4M4"},"kind":{"$ref":"97KBz98JZajX6Gt8P9evjg-f-1QpfgUgf9qi1jV-nrc"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"GJG6DU-r9Ll88IDUd8sCFAdS8DYKqfGSqPQb3BefAVY"},"status":{"$ref":"m6fWerDYVnu7_YQ8d9l2xAbA9Hxp9mgFHguDCPqdgoM"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.core.v1.Pod"};
...
const schema2 = {"type":"string","enum":["Pod"]};
...
const schema5 = {"nullableRef":"io.k8s.api.core.v1.PodSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiCoreV1PodSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.core.v1.PodStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiCoreV1PodStatus.js";
...
/*# sourceURL="io.k8s.api.core.v1.Pod" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
