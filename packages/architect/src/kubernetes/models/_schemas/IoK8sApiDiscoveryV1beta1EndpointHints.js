...
const schema1 = {"items":{"$ref":"FJv_3Qqw7h8x-yH8idAkA66W-b_tn08n-LuZvhsFgNU"},"type":"array","nullable":true};
const schema2 = {"$ref":"io.k8s.api.discovery.v1beta1.ForZone#"};
const schema3 = {};

import { validate as validate3 } from "./IoK8sApiDiscoveryV1beta1ForZone.js";
...
let data0 = data.forZones;
const _errs1 = errors;
if(!(validate1(data0, {instancePath:instancePath+"/forZones",parentData:data,parentDataProperty:"forZones",rootData}))){
