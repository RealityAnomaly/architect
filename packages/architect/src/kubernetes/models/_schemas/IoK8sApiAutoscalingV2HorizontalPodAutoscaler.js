...
const schema0 = {"properties":{"apiVersion":{"$ref":"EPmww6ScpIdrvGZbecHxe5rkgzG-onx3jmIyKzecIzE"},"kind":{"$ref":"TsDFHmgoNOM6biY3WjZaYrfqcS795wROaRKTBXw4qiw"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"II-rns9jZQa-wmkSV7MJb4Jj0i4WEeGHLKzAx05E2Lw"},"status":{"$ref":"XGru6pijvP66I2WWk7lP5rWfLvWFxOaaMXHyePQ5JxA"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.autoscaling.v2.HorizontalPodAutoscaler"};
const schema1 = {"type":"string","enum":["autoscaling/v2"]};
...
const schema5 = {"$ref":"io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAutoscalingV2HorizontalPodAutoscalerSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.autoscaling.v2.HorizontalPodAutoscalerStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAutoscalingV2HorizontalPodAutoscalerStatus.js";
...
/*# sourceURL="io.k8s.api.autoscaling.v2.HorizontalPodAutoscaler" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
