...
const schema1 = {"items":{"$ref":"C0VfKSM6rboUlWbk0K5ySwSHFiWPMQjRd44xo671iw0"},"type":"array","nullable":true};
const schema2 = {"$ref":"io.k8s.api.resource.v1.DeviceAllocationConfiguration#"};
const schema3 = {};

import { validate as validate3 } from "./IoK8sApiResourceV1DeviceAllocationConfiguration.js";
...
const schema4 = {"items":{"$ref":"5kU8KwJzGsF_Zt4h6rtYZp9rtUA64r_xVLtyxnORbVU"},"type":"array","nullable":true};
const schema5 = {"$ref":"io.k8s.api.resource.v1.DeviceRequestAllocationResult#"};
const schema6 = {};

import { validate as validate9 } from "./IoK8sApiResourceV1DeviceRequestAllocationResult.js";
...
/*# sourceURL="io.k8s.api.resource.v1.DeviceAllocationResult" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
