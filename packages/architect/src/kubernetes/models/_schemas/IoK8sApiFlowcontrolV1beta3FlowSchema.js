...
const schema0 = {"properties":{"apiVersion":{"$ref":"zYcO_GfmnrPKeQxbxlWAolDPmzdfu9A3kxUQ3jlqozM"},"kind":{"$ref":"KznZLkFQwWO593jSmSPCGAI8EpaoEkx-61qxVvue1b4"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"QfqFoB1LgSm0FrHPvJq-9WnyqyFfaVVCzb1kgv7JyJI"},"status":{"$ref":"OhOK3d2JogdkSQCjjXWTlruaxCSWWQ-F_LW9Z8mCxIk"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.flowcontrol.v1beta3.FlowSchema"};
const schema1 = {"type":"string","enum":["flowcontrol.apiserver.k8s.io/v1beta3"]};
...
if(!(data === "flowcontrol.apiserver.k8s.io/v1beta3")){
...
const schema2 = {"type":"string","enum":["FlowSchema"]};
...
const schema5 = {"nullableRef":"io.k8s.api.flowcontrol.v1beta3.FlowSchemaSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiFlowcontrolV1beta3FlowSchemaSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.flowcontrol.v1beta3.FlowSchemaStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiFlowcontrolV1beta3FlowSchemaStatus.js";
...
/*# sourceURL="io.k8s.api.flowcontrol.v1beta3.FlowSchema" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
