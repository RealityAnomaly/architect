...
const schema0 = {"properties":{"apiVersion":{"$ref":"V0kdriyJuy8zv8O9_pOx8g8ttBGtflJF22NqriWy6DQ"},"kind":{"$ref":"hwZ2OxtHhLORLL_CF4hdmhWp6kVzDic51LrLM7mFm7Q"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"4yIDNkwMDm6oSRH0zSBvNV_TvBZKRtB87p_c-S4LRN4"},"status":{"$ref":"kX2yv5vC-KMe3rp0yVhfqZXARar8fOmxxZNSUIVRGD0"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.CustomResourceDefinition"};
...
const schema2 = {"type":"string","enum":["CustomResourceDefinition"]};
...
if(!(data === "CustomResourceDefinition")){
...
const schema5 = {"$ref":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.CustomResourceDefinitionSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.CustomResourceDefinitionStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiextensionsApiserverPkgApisApiextensionsV1beta1CustomResourceDefinitionStatus.js";
...
/*# sourceURL="io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1beta1.CustomResourceDefinition" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
