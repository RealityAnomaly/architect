...
const schema0 = {"properties":{"apiVersion":{"$ref":"WcwYpFackugTb3qkllsMerGdSg9RV7slBmfbySA2Mk4"},"kind":{"$ref":"SOq1HEuRf1gNHwENyMMPnDqPCNiii09tvV36JshjeJw"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"roleRef":{"$ref":"CaCDHiF6bL0eT5_VBgF6eBDq-Qj1sd8D0HKjisN-goY"},"subjects":{"$ref":"5hI9cgUDRXKpZsjWQTeQeo7YPU5JwKqFBWBLAJdJ5Dg"}},"required":["roleRef","apiVersion","kind"],"type":"object","$id":"io.k8s.api.rbac.v1.ClusterRoleBinding"};
const schema1 = {"type":"string","enum":["rbac.authorization.k8s.io/v1"]};
...
const schema5 = {"$ref":"io.k8s.api.rbac.v1.RoleRef#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiRbacV1RoleRef.js";
...
const schema7 = {"items":{"$ref":"1PhyoASZeoU_vpcrJI9hkG_ERTZKZHpIdH7-56ntJgo"},"type":"array","nullable":true};
const schema8 = {"$ref":"io.k8s.api.rbac.v1.Subject#"};
const schema9 = {};

import { validate as validate15 } from "./IoK8sApiRbacV1Subject.js";
...
/*# sourceURL="io.k8s.api.rbac.v1.ClusterRoleBinding" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
