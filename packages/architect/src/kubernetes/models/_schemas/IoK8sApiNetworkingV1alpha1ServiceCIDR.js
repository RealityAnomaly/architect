...
const schema0 = {"properties":{"apiVersion":{"$ref":"DlbjdwhcgPShUYV5CRpqDAAPQLWHQuum_f1JjlWSxbk"},"kind":{"$ref":"WNXACaX6otAkV_a7bvN38K4BIiMuxMsRih1RN-IOd7M"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"mZlWRtSlZUTXGVlU4e_uDz1ZD_OfajAeSr9YMeNPbgE"},"status":{"$ref":"U_MOeU_4vsSpCmeSxbgwRth9H-K7KJ5zIH4ru41CDsk"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.networking.v1alpha1.ServiceCIDR"};
const schema1 = {"type":"string","enum":["networking.k8s.io/v1alpha1"]};
...
if(!(data === "networking.k8s.io/v1alpha1")){
...
const schema2 = {"type":"string","enum":["ServiceCIDR"]};
...
const schema5 = {"nullableRef":"io.k8s.api.networking.v1alpha1.ServiceCIDRSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiNetworkingV1alpha1ServiceCIDRSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.networking.v1alpha1.ServiceCIDRStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiNetworkingV1alpha1ServiceCIDRStatus.js";
...
/*# sourceURL="io.k8s.api.networking.v1alpha1.ServiceCIDR" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
