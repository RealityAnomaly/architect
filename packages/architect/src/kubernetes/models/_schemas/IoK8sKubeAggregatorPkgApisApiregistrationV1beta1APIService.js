...
const schema0 = {"properties":{"apiVersion":{"$ref":"oE84494_ZXZLZbFDlR1EbfFCxiH-x4diD63lGEBEW3Q"},"kind":{"$ref":"zoVP92hWGZHWooNY3_wJmhG9u6f56ehIo6ungpSqVpE"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"Zu26cVOKFDjkjfcWDXenRjpIzUHeaYMURh1ztGAaXs4"},"status":{"$ref":"Wk_cabyqjbeQ60gY4GNJxu4AsLIAdLaSXF27ft7Nqxc"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.kube-aggregator.pkg.apis.apiregistration.v1beta1.APIService"};
const schema1 = {"type":"string","enum":["apiregistration.k8s.io/v1beta1"]};
...
if(!(data === "apiregistration.k8s.io/v1beta1")){
...
const schema2 = {"type":"string","enum":["APIService"]};
...
const schema5 = {"nullableRef":"io.k8s.kube-aggregator.pkg.apis.apiregistration.v1beta1.APIServiceSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIServiceSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.kube-aggregator.pkg.apis.apiregistration.v1beta1.APIServiceStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sKubeAggregatorPkgApisApiregistrationV1beta1APIServiceStatus.js";
...
/*# sourceURL="io.k8s.kube-aggregator.pkg.apis.apiregistration.v1beta1.APIService" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
