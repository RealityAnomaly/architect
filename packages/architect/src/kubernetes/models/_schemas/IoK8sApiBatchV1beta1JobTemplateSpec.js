...
const schema0 = {"properties":{"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"d-JzwUT8sG4qrx16RWVfPLyu1TPI5DxDFTV0RubqEeo"}},"type":"object","$id":"io.k8s.api.batch.v1beta1.JobTemplateSpec"};
...
import { validate as validate6 } from "./IoK8sApiBatchV1JobSpec.js";
...
/*# sourceURL="io.k8s.api.batch.v1beta1.JobTemplateSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
