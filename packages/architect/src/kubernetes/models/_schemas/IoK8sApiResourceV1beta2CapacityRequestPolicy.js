...
const schema0 = {"properties":{"default":{"$ref":"pp_xaFlNXkKoD6DTqyaUAeP7lGItJ9_hKwPxmHYeCNA"},"validRange":{"$ref":"KnG1_a9sonKkj7eUR37Z9X_kmH0ldRlbBoYYTgN8lbc"},"validValues":{"$ref":"wTSPP-ovF8Joa5mZZqgkMv-4MHc_K-tIJpjRmF_KYe8"}},"type":"object","$id":"io.k8s.api.resource.v1beta2.CapacityRequestPolicy"};
...
const schema3 = {"nullableRef":"io.k8s.api.resource.v1beta2.CapacityRequestPolicyRange#"};
const schema4 = {};

import { validate as validate6 } from "./IoK8sApiResourceV1beta2CapacityRequestPolicyRange.js";
...
/*# sourceURL="io.k8s.api.resource.v1beta2.CapacityRequestPolicy" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
