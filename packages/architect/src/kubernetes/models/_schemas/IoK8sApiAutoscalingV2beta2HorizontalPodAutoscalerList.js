...
const schema0 = {"properties":{"apiVersion":{"$ref":"LeHv01E2N8rX_KeP6q9SVduDUVSquyA0ocBBp1YuKBM"},"items":{"$ref":"c6tbuBAq0lUDEDUy_6sA7Oj09O4ak1XQpF0mBM3YJAY"},"kind":{"$ref":"SYxG3vye-NG_RVGIh56O9MZAJmeeCWkOSPQLVQiJVvQ"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscalerList"};
...
const schema2 = {"items":{"$ref":"Gnjg51rFppnDGkCEGrhynTaQohuW0-Mat2cvP_mmsjI"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscaler#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiAutoscalingV2beta2HorizontalPodAutoscaler.js";
...
const schema5 = {"type":"string","enum":["HorizontalPodAutoscalerList"]};
...
if(!(data === "HorizontalPodAutoscalerList")){
...
/*# sourceURL="io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscalerList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
