...
const schema0 = {"properties":{"apiVersion":{"$ref":"cPYs8Mg7G8PjYVVYFezR2JdAAmurCA580nDIbsl_eL8"},"kind":{"$ref":"MPguM0edzzSpP3z3C_kLTkO8jzvL8OQsSzibfgQ26zE"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"-ZSbF2fEWu9t3JWUcFRMwtVsdtbiozWDsjU7K6ZYJNE"},"status":{"$ref":"Hkqxb1gUdY6AAtywa2I9VHth5nhebifjLEW4gWG_3Gs"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.flowcontrol.v1.PriorityLevelConfiguration"};
const schema1 = {"type":"string","enum":["flowcontrol.apiserver.k8s.io/v1"]};
...
if(!(data === "flowcontrol.apiserver.k8s.io/v1")){
...
const schema5 = {"nullableRef":"io.k8s.api.flowcontrol.v1.PriorityLevelConfigurationSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiFlowcontrolV1PriorityLevelConfigurationSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.flowcontrol.v1.PriorityLevelConfigurationStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiFlowcontrolV1PriorityLevelConfigurationStatus.js";
...
/*# sourceURL="io.k8s.api.flowcontrol.v1.PriorityLevelConfiguration" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
