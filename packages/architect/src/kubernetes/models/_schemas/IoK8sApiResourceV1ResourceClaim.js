...
const schema0 = {"properties":{"apiVersion":{"$ref":"r5slmBzt4gwD9IfCYEHurvJ8bcGL1iYKjzPe5Eec0DI"},"kind":{"$ref":"J3uRFMHCV0jmjCaeTp4-SvJUxwZmlvS-TBRqF5nI0kM"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"3FOjPxnok40qYyK5LKOO25wAb_GwRVWP1yASpjzRvRE"},"status":{"$ref":"5BLR6yHc0JEO-UlgoikdToo1hHIXpaIfJBlfKsKoIzY"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.resource.v1.ResourceClaim"};
const schema1 = {"type":"string","enum":["resource.k8s.io/v1"]};
...
const schema5 = {"$ref":"io.k8s.api.resource.v1.ResourceClaimSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiResourceV1ResourceClaimSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.resource.v1.ResourceClaimStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiResourceV1ResourceClaimStatus.js";
...
/*# sourceURL="io.k8s.api.resource.v1.ResourceClaim" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
