...
const schema2 = {"items":{"$ref":"7KauDJYeVuasR7UwPZ90JyUHNyijgXXzxUNyDkSdiZc"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.storage.v1alpha1.VolumeAttributesClass#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiStorageV1alpha1VolumeAttributesClass.js";
...
/*# sourceURL="io.k8s.api.storage.v1alpha1.VolumeAttributesClassList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
