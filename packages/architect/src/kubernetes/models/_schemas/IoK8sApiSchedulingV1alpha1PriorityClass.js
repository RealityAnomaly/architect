...
const schema0 = {"properties":{"apiVersion":{"$ref":"JDQIB9XvHT_jchenhnqzwx63NXBGMcvKRRQ_Vp8gadM"},"globalDefault":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"kind":{"$ref":"Q_eeCZFPdLzMy7d8cyQqYjBcqmeO5n6A27fy6Q5A9r4"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"preemptionPolicy":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"value":{"$ref":"6VbGrbfqnPJ4dMmNewHbRn4M59VZOmu0uhV1edBN8qE"}},"required":["value","apiVersion","kind"],"type":"object","$id":"io.k8s.api.scheduling.v1alpha1.PriorityClass"};
...
/*# sourceURL="io.k8s.api.scheduling.v1alpha1.PriorityClass" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
