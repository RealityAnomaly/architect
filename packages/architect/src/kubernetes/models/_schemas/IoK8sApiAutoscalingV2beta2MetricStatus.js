...
const schema0 = {"properties":{"containerResource":{"$ref":"4vQzwJfMObf7zXKBk2rJ950-L8kCCtmHONZFLPHF5s4"},"external":{"$ref":"2Fv7pIkVy0gO8g1t1l4P0pHfS8nrYaiV0cnDjRaksEE"},"object":{"$ref":"fye8GjFRFOFqvqc9PtadkbnGlCIPw5esEUycxRmJwxw"},"pods":{"$ref":"wXMP7lXX-tb7kyBo5WxwWL_EREeLEvxJw_Tz7Dob-pg"},"resource":{"$ref":"CRn7gXN0NsMra-EdQaBA59WprAKDcAPjlk-8BESwe_0"},"type":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"}},"required":["type"],"type":"object","$id":"io.k8s.api.autoscaling.v2beta2.MetricStatus"};
const schema1 = {"nullableRef":"io.k8s.api.autoscaling.v2beta2.ContainerResourceMetricStatus#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiAutoscalingV2beta2ContainerResourceMetricStatus.js";
...
const schema3 = {"nullableRef":"io.k8s.api.autoscaling.v2beta2.ExternalMetricStatus#"};
const schema4 = {};

import { validate as validate6 } from "./IoK8sApiAutoscalingV2beta2ExternalMetricStatus.js";
...
const schema5 = {"nullableRef":"io.k8s.api.autoscaling.v2beta2.ObjectMetricStatus#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAutoscalingV2beta2ObjectMetricStatus.js";
...
const schema7 = {"nullableRef":"io.k8s.api.autoscaling.v2beta2.PodsMetricStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAutoscalingV2beta2PodsMetricStatus.js";
...
const schema9 = {"nullableRef":"io.k8s.api.autoscaling.v2beta2.ResourceMetricStatus#"};
const schema10 = {};

import { validate as validate18 } from "./IoK8sApiAutoscalingV2beta2ResourceMetricStatus.js";
...
/*# sourceURL="io.k8s.api.autoscaling.v2beta2.MetricStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
