...
const schema0 = {"properties":{"apiVersion":{"$ref":"S8fQs5b8d_o6Mwyyipqll0kFyW-w4flYhC3Wcb4vRpg"},"kind":{"$ref":"J3uRFMHCV0jmjCaeTp4-SvJUxwZmlvS-TBRqF5nI0kM"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"Cb1iKxah_S42AKC_8o-2c_BMSSxZhJvTzCSTe_AGMck"},"status":{"$ref":"9WoBNuYVTrg_00Qg4yI-tbDsrQWRVz513WjchFujTbc"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.resource.v1alpha2.ResourceClaim"};
...
const schema5 = {"$ref":"io.k8s.api.resource.v1alpha2.ResourceClaimSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiResourceV1alpha2ResourceClaimSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.resource.v1alpha2.ResourceClaimStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiResourceV1alpha2ResourceClaimStatus.js";
...
/*# sourceURL="io.k8s.api.resource.v1alpha2.ResourceClaim" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
