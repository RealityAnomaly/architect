...
const schema0 = {"properties":{"resource":{"$ref":"gNEfkjpSaoArCZJB8LjjteziH_lHn9X0rfNecp1th_o"},"serviceName":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"servicePort":{"$ref":"0Ic74D7DBbilZPLlK8sD9BMBs_dQWTMr2-XowApJQb0"}},"type":"object","$id":"io.k8s.api.networking.v1beta1.IngressBackend"};
const schema1 = {"nullableRef":"io.k8s.api.core.v1.TypedLocalObjectReference#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiCoreV1TypedLocalObjectReference.js";
...
import { validate as validate8 } from "./../../apimachinery/_schemas/IoK8sApimachineryPkgUtilIntstrIntOrString.js";
...
/*# sourceURL="io.k8s.api.networking.v1beta1.IngressBackend" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
