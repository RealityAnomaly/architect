...
const schema0 = {"properties":{"apiVersion":{"$ref":"3Lnz3hDGoV6LS117nicS3YoTy1WU2EUGx89iY2NJZb4"},"items":{"$ref":"EeTNU6qFYe36Fm17zZp2R_IcUIMkTgNtV0aZcJyi3Ik"},"kind":{"$ref":"VUYCBBjtOuLUpJr171GSFpyPB-Wr1gwnMGUU22hpeIo"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.storage.v1.CSIStorageCapacityList"};
...
const schema2 = {"items":{"$ref":"q-9QSUhilc4BFEp8YMPyhfeeqGIdKEs4RLNOy8oOxDU"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.storage.v1.CSIStorageCapacity#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiStorageV1CSIStorageCapacity.js";
...
const schema5 = {"type":"string","enum":["CSIStorageCapacityList"]};
...
if(!(data === "CSIStorageCapacityList")){
...
/*# sourceURL="io.k8s.api.storage.v1.CSIStorageCapacityList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
