...
const schema0 = {"properties":{"ranges":{"$ref":"qi6VckmDbosM0Fj48Sr0LGPWeUAMhaoJmsMaeJWOf78"},"rule":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"}},"required":["rule"],"type":"object","$id":"io.k8s.api.policy.v1beta1.RunAsGroupStrategyOptions"};
...
/*# sourceURL="io.k8s.api.policy.v1beta1.RunAsGroupStrategyOptions" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
