...
const schema0 = {"properties":{"apiVersion":{"$ref":"JhWvHbSFO3ELsap4IWTkIXEjLRfpdwhmVqXnItVBFvQ"},"items":{"$ref":"6ZxyXUpD0b815qU-gYyXdri6aIHaT0m-QVHP-qF9C8A"},"kind":{"$ref":"g6DkHxsCYevFodBHrMr4DMcirB8aWqHpd5Jr_IYtDNc"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.resource.v1alpha3.ResourceClaimTemplateList"};
...
const schema2 = {"items":{"$ref":"vE7Sy0xk449TyTgZ-BEE9o4YC5Nn3R20y_vj1-E34PM"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.resource.v1alpha3.ResourceClaimTemplate#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiResourceV1alpha3ResourceClaimTemplate.js";
...
const schema5 = {"type":"string","enum":["ResourceClaimTemplateList"]};
...
if(!(data === "ResourceClaimTemplateList")){
...
/*# sourceURL="io.k8s.api.resource.v1alpha3.ResourceClaimTemplateList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
