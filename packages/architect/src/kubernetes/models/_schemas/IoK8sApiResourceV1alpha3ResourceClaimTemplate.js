...
const schema0 = {"properties":{"apiVersion":{"$ref":"JhWvHbSFO3ELsap4IWTkIXEjLRfpdwhmVqXnItVBFvQ"},"kind":{"$ref":"U3yXXqonuCBv3AL5Xb3UXMsIaOd1V5l6D8sO3C2W9IQ"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"jXv2Cp_lLZBTLXDc4t5qY5BvGvUptsByOwh6LnMOnlU"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.resource.v1alpha3.ResourceClaimTemplate"};
...
const schema5 = {"$ref":"io.k8s.api.resource.v1alpha3.ResourceClaimTemplateSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiResourceV1alpha3ResourceClaimTemplateSpec.js";
...
/*# sourceURL="io.k8s.api.resource.v1alpha3.ResourceClaimTemplate" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
