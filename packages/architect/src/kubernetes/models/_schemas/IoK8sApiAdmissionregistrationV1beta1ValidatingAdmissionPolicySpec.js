...
const schema0 = {"properties":{"auditAnnotations":{"$ref":"fHGjANdzsV8EXtMBxsJvWAEu1HbZW8ljrXuqJwq6f9w"},"failurePolicy":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"matchConditions":{"$ref":"c9ppsGuxDGyfkEFRCYzjmqPU71CJ-ANdkLo6OV3SBkQ"},"matchConstraints":{"$ref":"_NtCloUFDKjl1lGJbn-gATEs-QayZB4VyyTq7sQ9cHs"},"paramKind":{"$ref":"LWAiu6H4ldg0HKmlouQ9syDTVKsy8JP_7x9mfih-luA"},"validations":{"$ref":"Hn6FB59rzudL6Bx5viSv5ggryx-YridNYhOP_2ry6oY"},"variables":{"$ref":"KWkhgPwChdCeksXM4gpv9qdnHvNXSJ0oKo-vPjiUo_o"}},"type":"object","$id":"io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicySpec"};
const schema1 = {"items":{"$ref":"ADxM4I4J0T_RVokzAEes_yg6tiCi6B7Q8fktmg4g1cg"},"type":"array","nullable":true};
const schema2 = {"$ref":"io.k8s.api.admissionregistration.v1beta1.AuditAnnotation#"};
const schema3 = {};

import { validate as validate3 } from "./IoK8sApiAdmissionregistrationV1beta1AuditAnnotation.js";
...
const schema5 = {"items":{"$ref":"CqMgCzUcfMdEyRbTaoUfzNs46cjd_Nef4hYhvKczaus"},"type":"array","nullable":true};
const schema6 = {"$ref":"io.k8s.api.admissionregistration.v1beta1.MatchCondition#"};
const schema7 = {};

import { validate as validate11 } from "./IoK8sApiAdmissionregistrationV1beta1MatchCondition.js";
...
const schema8 = {"nullableRef":"io.k8s.api.admissionregistration.v1beta1.MatchResources#"};
const schema9 = {};

import { validate as validate16 } from "./IoK8sApiAdmissionregistrationV1beta1MatchResources.js";
...
import { validate as validate20 } from "./IoK8sApiAdmissionregistrationV1beta1ParamKind.js";
...
const schema12 = {"items":{"$ref":"V7mwlwlSDdxNC1GyjUz3MmxXKGMS6tf84O8mNMA30SU"},"type":"array","nullable":true};
const schema13 = {"$ref":"io.k8s.api.admissionregistration.v1beta1.Validation#"};
const schema14 = {};

import { validate as validate25 } from "./IoK8sApiAdmissionregistrationV1beta1Validation.js";
...
const schema15 = {"items":{"$ref":"B_lw2Vcv0H2_-DfI8pEx8lQyKkBpkqedWeLAdxb7T0Q"},"type":"array","nullable":true};
const schema16 = {"$ref":"io.k8s.api.admissionregistration.v1beta1.Variable#"};
const schema17 = {};

import { validate as validate31 } from "./IoK8sApiAdmissionregistrationV1beta1Variable.js";
...
/*# sourceURL="io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicySpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
