...
const schema2 = {"properties":{"maxSurge":{"$ref":"0Ic74D7DBbilZPLlK8sD9BMBs_dQWTMr2-XowApJQb0"},"maxUnavailable":{"$ref":"0Ic74D7DBbilZPLlK8sD9BMBs_dQWTMr2-XowApJQb0"}},"type":"object","$id":"io.k8s.api.apps.v1beta2.RollingUpdateDeployment"};
const schema0 = {"nullableRef":"io.k8s.apimachinery.pkg.util.intstr.IntOrString#"};
const schema1 = {};

import { validate as validate1 } from "./../../apimachinery/_schemas/IoK8sApimachineryPkgUtilIntstrIntOrString.js";
...
/*# sourceURL="io.k8s.api.apps.v1beta2.RollingUpdateDeployment" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
