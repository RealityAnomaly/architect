...
const schema0 = {"properties":{"allocation":{"$ref":"zGFPEAruOBZKGP1ftNQV-iiL5yiayndGl5sGHRKQ_Bw"},"deallocationRequested":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"driverName":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"reservedFor":{"$ref":"rq1gtc_Ln-O1iE-6UYoeLvSVdaf-WjuG-pmeVMD_nwA"}},"type":"object","$id":"io.k8s.api.resource.v1alpha2.ResourceClaimStatus"};
const schema1 = {"nullableRef":"io.k8s.api.resource.v1alpha2.AllocationResult#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiResourceV1alpha2AllocationResult.js";
...
const schema5 = {"items":{"$ref":"G-GF21V4nnAutFyHyyeh0wz9Df70LVCN_Ap1GPpVXXs"},"type":"array","nullable":true};
const schema6 = {"$ref":"io.k8s.api.resource.v1alpha2.ResourceClaimConsumerReference#"};
const schema7 = {};

import { validate as validate11 } from "./IoK8sApiResourceV1alpha2ResourceClaimConsumerReference.js";
...
/*# sourceURL="io.k8s.api.resource.v1alpha2.ResourceClaimStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
