...
const schema0 = {"properties":{"apiVersion":{"$ref":"7jsfkhcEDyoudlBfDD9y8QHrxewtIHKzZK30E_TSwdk"},"kind":{"$ref":"RyClP_2_iBvUTlJwucfnnIVcfim6G7-jVKCo2X5Ze8I"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"mtgzDSfv36ll1pfIrY1Qa7UdAHmF5lWMNhuTYokbkRg"},"status":{"$ref":"sg1KCfKQFvo2d4LkwaUEESXd-enqhHgz9I9tLaBlAvU"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.extensions.v1beta1.Deployment"};
const schema1 = {"type":"string","enum":["extensions/v1beta1"]};
...
const schema5 = {"nullableRef":"io.k8s.api.extensions.v1beta1.DeploymentSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiExtensionsV1beta1DeploymentSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.extensions.v1beta1.DeploymentStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiExtensionsV1beta1DeploymentStatus.js";
...
/*# sourceURL="io.k8s.api.extensions.v1beta1.Deployment" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
