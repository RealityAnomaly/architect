...
const schema0 = {"properties":{"apiVersion":{"$ref":"KtZhGzAR3p1yw0aXv-HtzSXiQeG9-uEC_mdFCrutAwM"},"kind":{"$ref":"TsDFHmgoNOM6biY3WjZaYrfqcS795wROaRKTBXw4qiw"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"0AMUiE9CGub5q6QHvcTvKhrQ4-nWh5CFKQB4vgfooeM"},"status":{"$ref":"hKrCzAXGgrn3gvKJR4uvIW0UKeU1SggX_NZRcUS_-6Y"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.autoscaling.v1.HorizontalPodAutoscaler"};
const schema1 = {"type":"string","enum":["autoscaling/v1"]};
...
const schema2 = {"type":"string","enum":["HorizontalPodAutoscaler"]};
...
if(!(data === "HorizontalPodAutoscaler")){
...
const schema5 = {"$ref":"io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAutoscalingV1HorizontalPodAutoscalerSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAutoscalingV1HorizontalPodAutoscalerStatus.js";
...
/*# sourceURL="io.k8s.api.autoscaling.v1.HorizontalPodAutoscaler" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
