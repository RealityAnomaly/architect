...
const schema0 = {"properties":{"adminAccess":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"allocationMode":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"capacity":{"$ref":"doCZ_BloTeH2w69UKP_pATMDcEAzEi32ohIJQFKY690"},"count":{"$ref":"otlW-2SioSJxw2ZRa8bQrFi14CUkm_yS2tfdShK98Vk"},"deviceClassName":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"selectors":{"$ref":"GsVfJpV99HMgf9zno9-ngqar3LPBIsv1TOC9vh__Znk"},"tolerations":{"$ref":"lA3zq3IslDOSKKa4WoZJ4R5IVeXQFtDVqYTqhjL7TpU"}},"required":["deviceClassName"],"type":"object","$id":"io.k8s.api.resource.v1beta2.ExactDeviceRequest"};
...
const schema3 = {"nullableRef":"io.k8s.api.resource.v1beta2.CapacityRequirements#"};
const schema4 = {};

import { validate as validate6 } from "./IoK8sApiResourceV1beta2CapacityRequirements.js";
...
const schema7 = {"items":{"$ref":"nXqQ2sNmowLtbnA8TcqPU9mA6sJKRE0kHdB3DvaxysQ"},"type":"array","nullable":true};
const schema8 = {"$ref":"io.k8s.api.resource.v1beta2.DeviceSelector#"};
const schema9 = {};

import { validate as validate15 } from "./IoK8sApiResourceV1beta2DeviceSelector.js";
...
const schema10 = {"items":{"$ref":"hxPiVPDOyDnagyGJ52Sec4dMjcMeIaoA1O45ZFiFcE8"},"type":"array","nullable":true};
const schema11 = {"$ref":"io.k8s.api.resource.v1beta2.DeviceToleration#"};
const schema12 = {};

import { validate as validate21 } from "./IoK8sApiResourceV1beta2DeviceToleration.js";
...
/*# sourceURL="io.k8s.api.resource.v1beta2.ExactDeviceRequest" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
