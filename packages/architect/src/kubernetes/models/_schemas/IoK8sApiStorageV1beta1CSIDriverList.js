...
const schema2 = {"items":{"$ref":"7Hl0Qt-zn4T5Df-_ApdPsk2B7TL3LTrZE1Pm-9OowJA"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.storage.v1beta1.CSIDriver#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiStorageV1beta1CSIDriver.js";
...
/*# sourceURL="io.k8s.api.storage.v1beta1.CSIDriverList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
