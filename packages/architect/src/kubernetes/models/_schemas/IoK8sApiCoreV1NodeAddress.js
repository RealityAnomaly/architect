...
/*# sourceURL="io.k8s.api.core.v1.NodeAddress" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
const err1 = {instancePath,schemaPath:"#/required",keyword:"required",params:{missingProperty: "address"}};
if(vErrors === null){
vErrors = [err1];
}
else {
...
let data1 = data.type;
const _errs2 = errors;
if(!(validate0(data1, {instancePath:instancePath+"/type",parentData:data,parentDataProperty:"type",rootData}))){
vErrors = vErrors === null ? validate0.errors : vErrors.concat(validate0.errors);
errors = vErrors.length;
}
else {
