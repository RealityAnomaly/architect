...
const schema0 = {"properties":{"nonResourceRules":{"$ref":"4AiRQWsqLLl6yhCtghK7Z94GxKJBH5dYfW74VFmmjGs"},"resourceRules":{"$ref":"9J4XB6X_9uDovkeP7panHT2VMyZTLEq0YQq2hwZGEt0"},"subjects":{"$ref":"LjYYNpS4jVUAN8lzaqh-fbsSAdIXYCczVcY2y_fGANM"}},"required":["subjects"],"type":"object","$id":"io.k8s.api.flowcontrol.v1beta3.PolicyRulesWithSubjects"};
const schema1 = {"items":{"$ref":"ts8Mgikn_Fa2YfobV1x__DLTuYo7GIKHsBKCg5I77bw"},"type":"array","nullable":true};
const schema2 = {"$ref":"io.k8s.api.flowcontrol.v1beta3.NonResourcePolicyRule#"};
const schema3 = {};

import { validate as validate3 } from "./IoK8sApiFlowcontrolV1beta3NonResourcePolicyRule.js";
...
const schema4 = {"items":{"$ref":"WSiLsIxlAmJJNTq7LTn1FEldcggBpgcsesOfXGpxxdw"},"type":"array","nullable":true};
const schema5 = {"$ref":"io.k8s.api.flowcontrol.v1beta3.ResourcePolicyRule#"};
const schema6 = {};

import { validate as validate9 } from "./IoK8sApiFlowcontrolV1beta3ResourcePolicyRule.js";
...
const schema7 = {"items":{"$ref":"7NRgx6Lr0hvAVLIRIU5Y3qAkZ1JUEo4PSyw88htQGzM"},"type":"array"};
const schema8 = {"$ref":"io.k8s.api.flowcontrol.v1beta3.Subject#"};
const schema9 = {};

import { validate as validate15 } from "./IoK8sApiFlowcontrolV1beta3Subject.js";
