...
const schema0 = {"properties":{"apiVersion":{"$ref":"AQZUoOwUCFleCmlTcOS9fxXU0JUglrqyoUtFIjArlEA"},"items":{"$ref":"R2wCeK3V3hlgOjge_Bx3r_amUV6dkZ7XkuHVcXKn7j8"},"kind":{"$ref":"GSfnIw8flALlGVuW3v3KqBUyAS8MychAyioXvK58Ejg"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.CustomResourceDefinitionList"};
...
const schema2 = {"items":{"$ref":"cCOy9Bd4Z9QwjrOaAPQa5o1dvzSeLACD3Moy4I7GdV4"},"type":"array"};
const schema3 = {"$ref":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.CustomResourceDefinition#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiextensionsApiserverPkgApisApiextensionsV1CustomResourceDefinition.js";
...
/*# sourceURL="io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.CustomResourceDefinitionList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
