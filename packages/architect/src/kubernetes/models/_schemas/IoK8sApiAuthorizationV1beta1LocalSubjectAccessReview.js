...
const schema0 = {"properties":{"apiVersion":{"$ref":"g9DqmMmk-diVp4D1OdEMO9poINNywrXd8nQgI_yuOFA"},"kind":{"$ref":"_Upfb7XloXCy52HegNDftQetxWwXjc5FJADl0_YZwH8"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"CiFIoBeT5cKin1QBCmVeeZDl5x4n2w47WiGHWNS3ygc"},"status":{"$ref":"XgP6LmnOTIGOVxRYr7RZweAY2tVd8T3JUaAtp9BTDQs"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.authorization.v1beta1.LocalSubjectAccessReview"};
...
const schema2 = {"type":"string","enum":["LocalSubjectAccessReview"]};
...
if(!(data === "LocalSubjectAccessReview")){
...
const schema5 = {"$ref":"io.k8s.api.authorization.v1beta1.SubjectAccessReviewSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAuthorizationV1beta1SubjectAccessReviewSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.authorization.v1beta1.SubjectAccessReviewStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAuthorizationV1beta1SubjectAccessReviewStatus.js";
...
/*# sourceURL="io.k8s.api.authorization.v1beta1.LocalSubjectAccessReview" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
