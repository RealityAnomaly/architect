...
const schema2 = {"items":{"$ref":"c901c_JkEueLwDJIG-tPxnKqWLUfGrfb58eMNsmqDiY"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.scheduling.v1alpha2.Workload#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiSchedulingV1alpha2Workload.js";
...
const schema5 = {"type":"string","enum":["WorkloadList"]};
...
/*# sourceURL="io.k8s.api.scheduling.v1alpha2.WorkloadList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
