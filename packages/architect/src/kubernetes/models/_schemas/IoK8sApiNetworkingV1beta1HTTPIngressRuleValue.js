...
const schema0 = {"properties":{"paths":{"$ref":"Kr1AEeFE6zyHXKgv5RxF4NHQduIdDTJj5p_8RDNlBos"}},"required":["paths"],"type":"object","$id":"io.k8s.api.networking.v1beta1.HTTPIngressRuleValue"};
const schema1 = {"items":{"$ref":"WKrxdPfLzPEPqzQmtG-9r-VK6ug0s-FPIzCaZR4rm8k"},"type":"array"};
const schema2 = {"$ref":"io.k8s.api.networking.v1beta1.HTTPIngressPath#"};
const schema3 = {};

import { validate as validate3 } from "./IoK8sApiNetworkingV1beta1HTTPIngressPath.js";
