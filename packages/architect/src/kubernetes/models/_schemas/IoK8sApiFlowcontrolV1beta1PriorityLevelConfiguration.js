...
const schema0 = {"properties":{"apiVersion":{"$ref":"Gg_wMmraQeeX_qlRWo7nMtRGqgTAwGq14mnrWWoJrts"},"kind":{"$ref":"MPguM0edzzSpP3z3C_kLTkO8jzvL8OQsSzibfgQ26zE"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"YXls8zlQceTfp_LSsvefZ7LmbSs5Qf0z1WLCt43waRU"},"status":{"$ref":"ohcAwxV1usY9HpZ13Io2ZtB86xhaaQG4bo_w7-PXayE"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.flowcontrol.v1beta1.PriorityLevelConfiguration"};
const schema1 = {"type":"string","enum":["flowcontrol.apiserver.k8s.io/v1beta1"]};
...
if(!(data === "flowcontrol.apiserver.k8s.io/v1beta1")){
...
const schema2 = {"type":"string","enum":["PriorityLevelConfiguration"]};
...
if(!(data === "PriorityLevelConfiguration")){
...
const schema5 = {"nullableRef":"io.k8s.api.flowcontrol.v1beta1.PriorityLevelConfigurationSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiFlowcontrolV1beta1PriorityLevelConfigurationSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.flowcontrol.v1beta1.PriorityLevelConfigurationStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiFlowcontrolV1beta1PriorityLevelConfigurationStatus.js";
...
/*# sourceURL="io.k8s.api.flowcontrol.v1beta1.PriorityLevelConfiguration" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
