...
const schema0 = {"properties":{"apiVersion":{"$ref":"NbOU3CLJOC5Y8-4b4BzjKPMTo0cEHwubLgw1tvnm2mw"},"kind":{"$ref":"xjHI2o0rUoP8LyH-DWsGATiTRHPrbYwPedmnsrNachI"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"KEEiRmWRRfjqFizSrHk080aYDmYPNNyQqQH5fxVGiBo"},"status":{"$ref":"ZzjfvwLH7FR55jhq-j3rr0LuxDQQqHxRtqZpB2JTUB4"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.networking.v1beta1.Ingress"};
const schema1 = {"type":"string","enum":["networking.k8s.io/v1beta1"]};
...
if(!(data === "networking.k8s.io/v1beta1")){
...
const schema2 = {"type":"string","enum":["Ingress"]};
...
const schema5 = {"nullableRef":"io.k8s.api.networking.v1beta1.IngressSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiNetworkingV1beta1IngressSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.networking.v1beta1.IngressStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiNetworkingV1beta1IngressStatus.js";
...
/*# sourceURL="io.k8s.api.networking.v1beta1.Ingress" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
