...
const schema0 = {"properties":{"apiVersion":{"$ref":"JhWvHbSFO3ELsap4IWTkIXEjLRfpdwhmVqXnItVBFvQ"},"kind":{"$ref":"J3uRFMHCV0jmjCaeTp4-SvJUxwZmlvS-TBRqF5nI0kM"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"LbWt7Y58rL1zJkA3b5KfG3lmoJ80ubljFGxrAlkSM2g"},"status":{"$ref":"N9djHdeDz4DDHo6F4l3-hcRD_pcMsn02JMrGD4_xtlw"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.resource.v1alpha3.ResourceClaim"};
...
const schema2 = {"type":"string","enum":["ResourceClaim"]};
...
const schema5 = {"$ref":"io.k8s.api.resource.v1alpha3.ResourceClaimSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiResourceV1alpha3ResourceClaimSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.resource.v1alpha3.ResourceClaimStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiResourceV1alpha3ResourceClaimStatus.js";
...
/*# sourceURL="io.k8s.api.resource.v1alpha3.ResourceClaim" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
