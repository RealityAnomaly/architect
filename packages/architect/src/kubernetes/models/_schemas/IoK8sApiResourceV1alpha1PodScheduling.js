...
const schema0 = {"properties":{"apiVersion":{"$ref":"qFxjlRgnFy8rsS3DXNoRWXTbA1LI5QMudW7t-VRniiY"},"kind":{"$ref":"fxXE39-yXqNzNkTLcM-yoKlOtap0gn_n08yfePGlpGA"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"p1iYxF55Ko07bqliWsAkar1IRF10V312PcUC5mReRh8"},"status":{"$ref":"1Eh1QwSTMfoHw0CWl7EnyO0LsB8NklAmO8Sr_kiyrAY"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.resource.v1alpha1.PodScheduling"};
const schema1 = {"type":"string","enum":["resource.k8s.io/v1alpha1"]};
...
if(!(data === "resource.k8s.io/v1alpha1")){
...
const schema2 = {"type":"string","enum":["PodScheduling"]};
...
const schema5 = {"$ref":"io.k8s.api.resource.v1alpha1.PodSchedulingSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiResourceV1alpha1PodSchedulingSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.resource.v1alpha1.PodSchedulingStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiResourceV1alpha1PodSchedulingStatus.js";
...
/*# sourceURL="io.k8s.api.resource.v1alpha1.PodScheduling" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
