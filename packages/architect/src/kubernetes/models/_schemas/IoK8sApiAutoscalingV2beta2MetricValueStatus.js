...
const schema2 = {"properties":{"averageUtilization":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"averageValue":{"$ref":"pp_xaFlNXkKoD6DTqyaUAeP7lGItJ9_hKwPxmHYeCNA"},"value":{"$ref":"pp_xaFlNXkKoD6DTqyaUAeP7lGItJ9_hKwPxmHYeCNA"}},"type":"object","$id":"io.k8s.api.autoscaling.v2beta2.MetricValueStatus"};
...
/*# sourceURL="io.k8s.api.autoscaling.v2beta2.MetricValueStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
