...
const schema0 = {"properties":{"apiVersion":{"$ref":"9m0m8SoyQCy2Bfi718RXr-uTNWFv6wbopxcPn7SIavw"},"kind":{"$ref":"SOq1HEuRf1gNHwENyMMPnDqPCNiii09tvV36JshjeJw"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"roleRef":{"$ref":"qaZmtDVVuhmj84KPMwwroQmBZpanyir09yAYUe1zgfI"},"subjects":{"$ref":"j64UhHBbmF3ZApEEG62hTdRKL2PGBNisgcPHqqUQgfE"}},"required":["roleRef","apiVersion","kind"],"type":"object","$id":"io.k8s.api.rbac.v1beta1.ClusterRoleBinding"};
const schema1 = {"type":"string","enum":["rbac.authorization.k8s.io/v1beta1"]};
...
if(!(data === "rbac.authorization.k8s.io/v1beta1")){
...
const schema2 = {"type":"string","enum":["ClusterRoleBinding"]};
...
const schema5 = {"$ref":"io.k8s.api.rbac.v1beta1.RoleRef#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiRbacV1beta1RoleRef.js";
...
const schema7 = {"items":{"$ref":"O_K-xuyoWnS4xDR7WWTj_I2JayYqLZsHSCZ5LMqz8L0"},"type":"array","nullable":true};
const schema8 = {"$ref":"io.k8s.api.rbac.v1beta1.Subject#"};
const schema9 = {};

import { validate as validate15 } from "./IoK8sApiRbacV1beta1Subject.js";
...
/*# sourceURL="io.k8s.api.rbac.v1beta1.ClusterRoleBinding" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
