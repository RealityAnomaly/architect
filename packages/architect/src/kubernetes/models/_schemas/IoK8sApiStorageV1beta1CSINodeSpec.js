...
const schema1 = {"items":{"$ref":"1GCjYOlEEwxeR5MwqQF-gnR5FbGhCnh_AjizXBL-lNs"},"type":"array"};
const schema2 = {"$ref":"io.k8s.api.storage.v1beta1.CSINodeDriver#"};
const schema3 = {};

import { validate as validate3 } from "./IoK8sApiStorageV1beta1CSINodeDriver.js";
...
/*# sourceURL="io.k8s.api.storage.v1beta1.CSINodeSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
