...
const schema0 = {"properties":{"apiVersion":{"$ref":"KtZhGzAR3p1yw0aXv-HtzSXiQeG9-uEC_mdFCrutAwM"},"items":{"$ref":"_lMUoeEeUCqzimKsXQoQ058HiEcRvftn9mjOt8ohQSw"},"kind":{"$ref":"SYxG3vye-NG_RVGIh56O9MZAJmeeCWkOSPQLVQiJVvQ"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerList"};
...
const schema2 = {"items":{"$ref":"woW67Bxh5eeBXM8tS0ZeTfbbjxtHQW0ppUbB-yoTUEs"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.autoscaling.v1.HorizontalPodAutoscaler#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiAutoscalingV1HorizontalPodAutoscaler.js";
...
/*# sourceURL="io.k8s.api.autoscaling.v1.HorizontalPodAutoscalerList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
