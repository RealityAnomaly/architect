...
const schema3 = {"properties":{"allNodes":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"allowMultipleAllocations":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"attributes":{"$ref":"YTsDANgvK5tA7CLOZLhWJhBVx9tiHUZxD20EtS8FP4E"},"bindingConditions":{"$ref":"uqi-NWpwJAtCtKg340P2GU85hOwdccNKh8Eansj5IGE"},"bindingFailureConditions":{"$ref":"uqi-NWpwJAtCtKg340P2GU85hOwdccNKh8Eansj5IGE"},"bindsToNode":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"capacity":{"$ref":"0ChAIjegqi7DQ4xcb-1jeH3lmfbp18A9clBOxVV48dM"},"consumesCounters":{"$ref":"ZV_cNRU1yKyS89UMsOIhctZFeuLvvxskZIzlXN8E81g"},"name":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"nodeAllocatableResourceMappings":{"$ref":"HgMChMLObdVRzBtFFdntQ3sve6R_8Yi_UGh-yP4nSds"},"nodeName":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"nodeSelector":{"$ref":"TkSNaYWIxhO85OVX_cSWzmQgv784eOxf9GMx98WTU1I"},"taints":{"$ref":"5nItuF_QfyY0EuNOEnzA7N9aESJZ2000Ef-MRljnvCE"}},"required":["name"],"type":"object","$id":"io.k8s.api.resource.v1beta2.Device"};
...
const schema4 = {"additionalProperties":{"$ref":"TENz_6QhUl_ZeBNuzKKthISPNVR73uLxIdJnz5JzW54"},"type":"object","nullable":true};
const schema5 = {"$ref":"io.k8s.api.resource.v1beta2.DeviceAttribute#"};
const schema6 = {};

import { validate as validate9 } from "./IoK8sApiResourceV1beta2DeviceAttribute.js";
...
const schema7 = {"additionalProperties":{"$ref":"RjVSodbrK6DMy_QESjtrd6iKa2Iqpa94Oar4QkPlgaU"},"type":"object","nullable":true};
const schema8 = {"$ref":"io.k8s.api.resource.v1beta2.DeviceCapacity#"};
const schema9 = {};

import { validate as validate18 } from "./IoK8sApiResourceV1beta2DeviceCapacity.js";
...
const schema10 = {"items":{"$ref":"NCWGbe5SI_wmZ7-29V_PS6niVkHWph8SYORiPjQedpA"},"type":"array","nullable":true};
const schema11 = {"$ref":"io.k8s.api.resource.v1beta2.DeviceCounterConsumption#"};
const schema12 = {};

import { validate as validate24 } from "./IoK8sApiResourceV1beta2DeviceCounterConsumption.js";
...
const schema13 = {"additionalProperties":{"$ref":"sVFxyK1TTyJZG7KKuhRo0CgUlyEllHh4MNpfNhbSRsg"},"type":"object","nullable":true};
const schema14 = {"$ref":"io.k8s.api.resource.v1beta2.NodeAllocatableResourceMapping#"};
const schema15 = {};

import { validate as validate31 } from "./IoK8sApiResourceV1beta2NodeAllocatableResourceMapping.js";
...
import { validate as validate38 } from "./IoK8sApiCoreV1NodeSelector.js";
...
const schema19 = {"items":{"$ref":"lapJ34WtTGTjLmJMDPw8x5jdawYdAytsV4rjwFdihEA"},"type":"array","nullable":true};
const schema20 = {"$ref":"io.k8s.api.resource.v1beta2.DeviceTaint#"};
const schema21 = {};

import { validate as validate43 } from "./IoK8sApiResourceV1beta2DeviceTaint.js";
...
/*# sourceURL="io.k8s.api.resource.v1beta2.Device" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
