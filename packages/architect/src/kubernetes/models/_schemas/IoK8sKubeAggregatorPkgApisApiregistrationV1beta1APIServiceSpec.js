...
const schema2 = {"properties":{"caBundle":{"$ref":"-qMnViG9CEC-V8_TFn4WYpvO2NOwI2XARBIst170yi0"},"group":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"groupPriorityMinimum":{"$ref":"6VbGrbfqnPJ4dMmNewHbRn4M59VZOmu0uhV1edBN8qE"},"insecureSkipTLSVerify":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"service":{"$ref":"qHuX9MKSBqH3d0NsJUUJ5AxUBUVRp-d4zyQ5GhromVk"},"version":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"versionPriority":{"$ref":"6VbGrbfqnPJ4dMmNewHbRn4M59VZOmu0uhV1edBN8qE"}},"required":["groupPriorityMinimum","versionPriority"],"type":"object","$id":"io.k8s.kube-aggregator.pkg.apis.apiregistration.v1beta1.APIServiceSpec"};
...
const schema5 = {"nullableRef":"io.k8s.kube-aggregator.pkg.apis.apiregistration.v1beta1.ServiceReference#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sKubeAggregatorPkgApisApiregistrationV1beta1ServiceReference.js";
...
/*# sourceURL="io.k8s.kube-aggregator.pkg.apis.apiregistration.v1beta1.APIServiceSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
