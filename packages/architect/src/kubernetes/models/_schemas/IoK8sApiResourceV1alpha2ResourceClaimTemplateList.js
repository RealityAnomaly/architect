...
const schema0 = {"properties":{"apiVersion":{"$ref":"S8fQs5b8d_o6Mwyyipqll0kFyW-w4flYhC3Wcb4vRpg"},"items":{"$ref":"eyS9Wv5tLqds2NC_RbWZY3ZTxwau6_ooUw_u8mPPhIk"},"kind":{"$ref":"g6DkHxsCYevFodBHrMr4DMcirB8aWqHpd5Jr_IYtDNc"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.resource.v1alpha2.ResourceClaimTemplateList"};
...
const schema2 = {"items":{"$ref":"5gHZ-VQVeopc2lW131psj47UWAPiOEySNb5LOWsobeU"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.resource.v1alpha2.ResourceClaimTemplate#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiResourceV1alpha2ResourceClaimTemplate.js";
...
/*# sourceURL="io.k8s.api.resource.v1alpha2.ResourceClaimTemplateList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
