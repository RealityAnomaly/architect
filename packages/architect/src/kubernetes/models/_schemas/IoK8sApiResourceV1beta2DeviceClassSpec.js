...
const schema0 = {"properties":{"config":{"$ref":"AwHlkW3dfIvH5vqkx0tDA7i55h3wa3SFiHqW6cjRYSE"},"extendedResourceName":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"selectors":{"$ref":"GsVfJpV99HMgf9zno9-ngqar3LPBIsv1TOC9vh__Znk"}},"type":"object","$id":"io.k8s.api.resource.v1beta2.DeviceClassSpec"};
const schema1 = {"items":{"$ref":"VuR-HP3BBF4vUq-yqsi5aL4J9a0MEwx7h041Wf2JHdI"},"type":"array","nullable":true};
const schema2 = {"$ref":"io.k8s.api.resource.v1beta2.DeviceClassConfiguration#"};
const schema3 = {};

import { validate as validate3 } from "./IoK8sApiResourceV1beta2DeviceClassConfiguration.js";
...
const schema5 = {"items":{"$ref":"nXqQ2sNmowLtbnA8TcqPU9mA6sJKRE0kHdB3DvaxysQ"},"type":"array","nullable":true};
const schema6 = {"$ref":"io.k8s.api.resource.v1beta2.DeviceSelector#"};
const schema7 = {};

import { validate as validate11 } from "./IoK8sApiResourceV1beta2DeviceSelector.js";
...
/*# sourceURL="io.k8s.api.resource.v1beta2.DeviceClassSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
