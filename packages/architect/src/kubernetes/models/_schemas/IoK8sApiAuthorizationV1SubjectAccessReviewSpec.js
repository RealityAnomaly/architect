...
const schema2 = {"properties":{"extra":{"$ref":"cbHjaL27bsYoB-250qBeBZFfFlksf9O0Kclh9RM5vSg"},"groups":{"$ref":"uqi-NWpwJAtCtKg340P2GU85hOwdccNKh8Eansj5IGE"},"nonResourceAttributes":{"$ref":"GNjm9MTw7kU2Tem12W7ISFV1QklmzRlwv2StLDqRTM4"},"resourceAttributes":{"$ref":"fZ8vizP_MjwB__cpgB7W0YtSupTRCRlJVlZro9jxb6A"},"uid":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"user":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"}},"type":"object","$id":"io.k8s.api.authorization.v1.SubjectAccessReviewSpec"};
...
const schema6 = {"nullableRef":"io.k8s.api.authorization.v1.NonResourceAttributes#"};
const schema7 = {};

import { validate as validate12 } from "./IoK8sApiAuthorizationV1NonResourceAttributes.js";
...
const schema8 = {"nullableRef":"io.k8s.api.authorization.v1.ResourceAttributes#"};
const schema9 = {};

import { validate as validate16 } from "./IoK8sApiAuthorizationV1ResourceAttributes.js";
...
/*# sourceURL="io.k8s.api.authorization.v1.SubjectAccessReviewSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
...
const _errs2 = errors;
if(!(validate8(data1, {instancePath:instancePath+"/groups",parentData:data,parentDataProperty:"groups",rootData}))){
