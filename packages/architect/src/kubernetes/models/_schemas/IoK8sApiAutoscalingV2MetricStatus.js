...
const schema0 = {"properties":{"containerResource":{"$ref":"Yg9hteQjI99Xab3qEIrYNNheQAnMC7bfkCctIJ-olsk"},"external":{"$ref":"3GznqZOiYP1NqtGjIwQaR-QFt59ih5IyaIqXjbWEjTk"},"object":{"$ref":"hO9AwUGhJNzJWWDHO9W2oGIBLkCWWe8jkzmxbpKOHdg"},"pods":{"$ref":"fhEWDICm07YqOGtsx1Q6X10o2K8XD9t34cmW91V-zCA"},"resource":{"$ref":"LfNdXH8AbKeAJLupgVhsNPeXgNFfmrdNXkVler9VYLk"},"type":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"}},"required":["type"],"type":"object","$id":"io.k8s.api.autoscaling.v2.MetricStatus"};
const schema1 = {"nullableRef":"io.k8s.api.autoscaling.v2.ContainerResourceMetricStatus#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiAutoscalingV2ContainerResourceMetricStatus.js";
...
const schema3 = {"nullableRef":"io.k8s.api.autoscaling.v2.ExternalMetricStatus#"};
const schema4 = {};

import { validate as validate6 } from "./IoK8sApiAutoscalingV2ExternalMetricStatus.js";
...
const schema5 = {"nullableRef":"io.k8s.api.autoscaling.v2.ObjectMetricStatus#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAutoscalingV2ObjectMetricStatus.js";
...
const schema7 = {"nullableRef":"io.k8s.api.autoscaling.v2.PodsMetricStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAutoscalingV2PodsMetricStatus.js";
...
const schema9 = {"nullableRef":"io.k8s.api.autoscaling.v2.ResourceMetricStatus#"};
const schema10 = {};

import { validate as validate18 } from "./IoK8sApiAutoscalingV2ResourceMetricStatus.js";
