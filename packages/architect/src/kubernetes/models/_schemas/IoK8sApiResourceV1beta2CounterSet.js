...
const schema0 = {"properties":{"counters":{"$ref":"Sj5OTyqT9A370mQQJg8SGPREOJ0lcGMcH1Lmab9imw0"},"name":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"}},"required":["name","counters"],"type":"object","$id":"io.k8s.api.resource.v1beta2.CounterSet"};
const schema1 = {"additionalProperties":{"$ref":"_J7QHvMr9361A9VG6rXbp6Qci5gbWbmNmPJ9eEVE-cc"},"type":"object"};
const schema2 = {"$ref":"io.k8s.api.resource.v1beta2.Counter#"};
const schema3 = {};

import { validate as validate3 } from "./IoK8sApiResourceV1beta2Counter.js";
...
/*# sourceURL="io.k8s.api.resource.v1beta2.CounterSet" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
