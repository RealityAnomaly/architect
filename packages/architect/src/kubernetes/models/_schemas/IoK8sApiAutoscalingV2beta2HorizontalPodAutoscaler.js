...
const schema0 = {"properties":{"apiVersion":{"$ref":"LeHv01E2N8rX_KeP6q9SVduDUVSquyA0ocBBp1YuKBM"},"kind":{"$ref":"TsDFHmgoNOM6biY3WjZaYrfqcS795wROaRKTBXw4qiw"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"DvftO4Y7791QrYt274haDWU4xfopdDWuarZuUOUUZ3M"},"status":{"$ref":"DA7YKS5Gv1qv_AZIY6YL9Gn4ps9oUGzwirMVgygSwUA"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscaler"};
const schema1 = {"type":"string","enum":["autoscaling/v2beta2"]};
...
const schema5 = {"nullableRef":"io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscalerSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAutoscalingV2beta2HorizontalPodAutoscalerSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscalerStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAutoscalingV2beta2HorizontalPodAutoscalerStatus.js";
...
/*# sourceURL="io.k8s.api.autoscaling.v2beta2.HorizontalPodAutoscaler" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
