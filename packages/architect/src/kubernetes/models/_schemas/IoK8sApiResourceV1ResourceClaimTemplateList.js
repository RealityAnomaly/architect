...
const schema2 = {"items":{"$ref":"aJoaWSSXH1x1bdpNBEx4NDbRZ4BY9NVFbL_lnLxQVVk"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.resource.v1.ResourceClaimTemplate#"};
const schema4 = {};

import { validate as validate5 } from "./IoK8sApiResourceV1ResourceClaimTemplate.js";
...
/*# sourceURL="io.k8s.api.resource.v1.ResourceClaimTemplateList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
