...
const schema1 = {"properties":{"allocationMode":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"capacity":{"$ref":"Pr46cSUzPtUfWT4Uw1wq0HjyoNOaOEGZtqJ6bALSAQ0"},"count":{"$ref":"otlW-2SioSJxw2ZRa8bQrFi14CUkm_yS2tfdShK98Vk"},"deviceClassName":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"name":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"selectors":{"$ref":"TCP_CUQMXZ1WX6q_5g6kVQp2CUfbM9in8yBXjJWAhEU"},"tolerations":{"$ref":"Zt_wDZgLLDN3uQwwU5PBiaAG3JvXk9BYmq6EKFUV3WI"}},"required":["name","deviceClassName"],"type":"object","$id":"io.k8s.api.resource.v1beta1.DeviceSubRequest"};
...
import { validate as validate5 } from "./IoK8sApiResourceV1beta1CapacityRequirements.js";
...
const schema6 = {"items":{"$ref":"txbkPEUsZob5nD88vTFnGlpqMuPlvnblEFKLM1JoumY"},"type":"array","nullable":true};
const schema7 = {"$ref":"io.k8s.api.resource.v1beta1.DeviceSelector#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiResourceV1beta1DeviceSelector.js";
...
const schema9 = {"items":{"$ref":"JOsE5mUbDMMuMPPis9G5P6AGGjrRsY1Z9f1cfzqe1EY"},"type":"array","nullable":true};
const schema10 = {"$ref":"io.k8s.api.resource.v1beta1.DeviceToleration#"};
const schema11 = {};

import { validate as validate20 } from "./IoK8sApiResourceV1beta1DeviceToleration.js";
...
/*# sourceURL="io.k8s.api.resource.v1beta1.DeviceSubRequest" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
