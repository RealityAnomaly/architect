...
const schema0 = {"properties":{"distinguisherMethod":{"$ref":"ATLyJadG8VMn3WZt5bVDScheMGT6iXbqTXOMMd_LbdM"},"matchingPrecedence":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"priorityLevelConfiguration":{"$ref":"XtDhim1fRv-hSJpCVokhgav9Bp3xThgFvwdByW9TLOs"},"rules":{"$ref":"4vXIHYECKmVItV-y9UKYkPcHBSpwQ9APXcjI5GB1XR0"}},"required":["priorityLevelConfiguration"],"type":"object","$id":"io.k8s.api.flowcontrol.v1beta1.FlowSchemaSpec"};
const schema1 = {"nullableRef":"io.k8s.api.flowcontrol.v1beta1.FlowDistinguisherMethod#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiFlowcontrolV1beta1FlowDistinguisherMethod.js";
...
const schema4 = {"$ref":"io.k8s.api.flowcontrol.v1beta1.PriorityLevelConfigurationReference#"};
const schema5 = {};

import { validate as validate8 } from "./IoK8sApiFlowcontrolV1beta1PriorityLevelConfigurationReference.js";
...
const schema6 = {"items":{"$ref":"UBQpimd2J7vH1cfoVe2f3c0A-pNYHjejQJuqT1pgDfY"},"type":"array","nullable":true};
const schema7 = {"$ref":"io.k8s.api.flowcontrol.v1beta1.PolicyRulesWithSubjects#"};
const schema8 = {};

import { validate as validate13 } from "./IoK8sApiFlowcontrolV1beta1PolicyRulesWithSubjects.js";
...
/*# sourceURL="io.k8s.api.flowcontrol.v1beta1.FlowSchemaSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
