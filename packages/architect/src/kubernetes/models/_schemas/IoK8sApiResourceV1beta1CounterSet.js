...
const schema1 = {"additionalProperties":{"$ref":"keTVZBR8VAP1VSml4FL_F1KGXpa_JBOZGqoFFbrPMf0"},"type":"object"};
const schema2 = {"$ref":"io.k8s.api.resource.v1beta1.Counter#"};
const schema3 = {};

import { validate as validate3 } from "./IoK8sApiResourceV1beta1Counter.js";
...
/*# sourceURL="io.k8s.api.resource.v1beta1.CounterSet" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
