...
const schema0 = {"properties":{"opaque":{"$ref":"bO9fHkSSgMpLCOucJkQYx48JxvOCplTsS9-91h431hc"},"requests":{"$ref":"uqi-NWpwJAtCtKg340P2GU85hOwdccNKh8Eansj5IGE"}},"type":"object","$id":"io.k8s.api.resource.v1alpha3.DeviceClaimConfiguration"};
const schema1 = {"nullableRef":"io.k8s.api.resource.v1alpha3.OpaqueDeviceConfiguration#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiResourceV1alpha3OpaqueDeviceConfiguration.js";
...
/*# sourceURL="io.k8s.api.resource.v1alpha3.DeviceClaimConfiguration" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
