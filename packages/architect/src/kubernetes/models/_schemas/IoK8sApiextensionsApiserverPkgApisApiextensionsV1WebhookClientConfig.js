...
const schema0 = {"properties":{"caBundle":{"$ref":"-qMnViG9CEC-V8_TFn4WYpvO2NOwI2XARBIst170yi0"},"service":{"$ref":"Y_8KtK2hfQd-JFb6kHANTwS7QFvgiheyMbNoy1p7mA4"},"url":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"}},"type":"object","$id":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.WebhookClientConfig"};
...
const schema2 = {"nullableRef":"io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.ServiceReference#"};
const schema3 = {};

import { validate as validate4 } from "./IoK8sApiextensionsApiserverPkgApisApiextensionsV1ServiceReference.js";
...
/*# sourceURL="io.k8s.apiextensions-apiserver.pkg.apis.apiextensions.v1.WebhookClientConfig" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
