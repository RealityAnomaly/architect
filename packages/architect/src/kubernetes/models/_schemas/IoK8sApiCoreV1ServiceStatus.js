...
const schema4 = {"nullableRef":"io.k8s.api.core.v1.LoadBalancerStatus#"};
const schema5 = {};

import { validate as validate8 } from "./IoK8sApiCoreV1LoadBalancerStatus.js";
...
/*# sourceURL="io.k8s.api.core.v1.ServiceStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
let data1 = data.loadBalancer;
const _errs2 = errors;
if(!(validate7(data1, {instancePath:instancePath+"/loadBalancer",parentData:data,parentDataProperty:"loadBalancer",rootData}))){
