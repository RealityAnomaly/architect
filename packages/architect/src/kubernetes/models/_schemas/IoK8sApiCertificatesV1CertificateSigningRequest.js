...
const schema0 = {"properties":{"apiVersion":{"$ref":"Sra-NRo7CefYbfypn7c7Pu1mjpat95wYOHmqlWMFPSo"},"kind":{"$ref":"MYcmnu7x4Ms9B4PNBtv_05Wgu7YNVsjUM8WzH4Fc3zA"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"2fx9KERrhepSSVOa-j78kQ3AFqflBDv9sO8wXtVTNdg"},"status":{"$ref":"dFge-4OD-nJeS3YMcyYLWRUFMLJ-EM6wbuzEeAJPYCA"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.certificates.v1.CertificateSigningRequest"};
const schema1 = {"type":"string","enum":["certificates.k8s.io/v1"]};
...
if(!(data === "certificates.k8s.io/v1")){
...
const schema2 = {"type":"string","enum":["CertificateSigningRequest"]};
...
if(!(data === "CertificateSigningRequest")){
...
const schema5 = {"$ref":"io.k8s.api.certificates.v1.CertificateSigningRequestSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiCertificatesV1CertificateSigningRequestSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.certificates.v1.CertificateSigningRequestStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiCertificatesV1CertificateSigningRequestStatus.js";
...
/*# sourceURL="io.k8s.api.certificates.v1.CertificateSigningRequest" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
