...
const schema0 = {"properties":{"describedObject":{"$ref":"E2l06yuqoLv6uh8rsLN_0_gEKLk6SfvWTk4e_GHebmw"},"metric":{"$ref":"HhIW3eWSXOltn7SemUIsPuCS7UE0PSh1IWsMg8ta2ZE"},"target":{"$ref":"xjHD2zXMIlooXvmTxXzwc4ktFagRb6fAYasSY0Yuq7k"}},"required":["describedObject","target","metric"],"type":"object","$id":"io.k8s.api.autoscaling.v2.ObjectMetricSource"};
const schema1 = {"$ref":"io.k8s.api.autoscaling.v2.CrossVersionObjectReference#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiAutoscalingV2CrossVersionObjectReference.js";
...
import { validate as validate6 } from "./IoK8sApiAutoscalingV2MetricIdentifier.js";
...
const schema5 = {"$ref":"io.k8s.api.autoscaling.v2.MetricTarget#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAutoscalingV2MetricTarget.js";
...
/*# sourceURL="io.k8s.api.autoscaling.v2.ObjectMetricSource" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
