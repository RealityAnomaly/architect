...
const schema0 = {"properties":{"apiVersion":{"$ref":"kdF3Htu-APfgwC7VUX7AOjVhkUGR76mpFE8nNN6FKJk"},"kind":{"$ref":"sO5EHLUdRR2bymWMxzqRbZNaF0SHh3wmFZfMT2U6xA8"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"SHja0l1xvdDlgRsVsxqK2qFIIW81b91zNvQK9TmcX7c"},"status":{"$ref":"IXK2hm8UGxw1SW6hETs-gMrCopoTv5SaKsUjp0Ltxog"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.certificates.v1beta1.PodCertificateRequest"};
const schema1 = {"type":"string","enum":["certificates.k8s.io/v1beta1"]};
...
if(!(data === "certificates.k8s.io/v1beta1")){
...
const schema2 = {"type":"string","enum":["PodCertificateRequest"]};
...
const schema5 = {"$ref":"io.k8s.api.certificates.v1beta1.PodCertificateRequestSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiCertificatesV1beta1PodCertificateRequestSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.certificates.v1beta1.PodCertificateRequestStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiCertificatesV1beta1PodCertificateRequestStatus.js";
...
/*# sourceURL="io.k8s.api.certificates.v1beta1.PodCertificateRequest" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
