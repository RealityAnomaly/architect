...
const schema0 = {"properties":{"current":{"$ref":"Sd-dcUbA0TL7oZp5fmtDBLHIG0jkAJjU29O4p-Jjvq4"},"metric":{"$ref":"HhIW3eWSXOltn7SemUIsPuCS7UE0PSh1IWsMg8ta2ZE"}},"required":["metric","current"],"type":"object","$id":"io.k8s.api.autoscaling.v2.ExternalMetricStatus"};
...
/*# sourceURL="io.k8s.api.autoscaling.v2.ExternalMetricStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
