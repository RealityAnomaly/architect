...
const schema0 = {"properties":{"apiVersion":{"$ref":"OdhG_1Eyhgx7xM--eDQFyAjC1M3C_m7s531ZFZu457U"},"kind":{"$ref":"6xKv4pTdDB3wRvkqcIHiD8rkKZyVB7ADkjUy8OUN6Ao"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"lKw3HYhESvTqjXfDVJ7n3yKDqpn2VYwhSwoJ87ZsmNI"},"status":{"$ref":"-8O9hiS0W7I7Zj8m0nsYnrmUMsPRO80wZ-VPTvofvH4"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.batch.v2alpha1.CronJob"};
const schema1 = {"type":"string","enum":["batch/v2alpha1"]};
...
const schema2 = {"type":"string","enum":["CronJob"]};
...
const schema5 = {"nullableRef":"io.k8s.api.batch.v2alpha1.CronJobSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiBatchV2alpha1CronJobSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.batch.v2alpha1.CronJobStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiBatchV2alpha1CronJobStatus.js";
...
/*# sourceURL="io.k8s.api.batch.v2alpha1.CronJob" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
