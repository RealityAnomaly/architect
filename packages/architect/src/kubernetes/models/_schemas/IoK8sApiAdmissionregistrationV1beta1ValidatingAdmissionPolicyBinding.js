...
const schema0 = {"properties":{"apiVersion":{"$ref":"KmJtbxjKRbXdsyADIcJYH0lVv-K8B7QYvkcPlXiYrvM"},"kind":{"$ref":"_pa_pRoig1562SMnmz6rE2RZv7IM_jTs1ICtbyoj-5k"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"oMCsr4NKFPYppGYvhwqGsHvbMO6szKLn4DXBoWl1RTU"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicyBinding"};
...
const schema2 = {"type":"string","enum":["ValidatingAdmissionPolicyBinding"]};
...
if(!(data === "ValidatingAdmissionPolicyBinding")){
...
const schema5 = {"nullableRef":"io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicyBindingSpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAdmissionregistrationV1beta1ValidatingAdmissionPolicyBindingSpec.js";
...
/*# sourceURL="io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicyBinding" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
