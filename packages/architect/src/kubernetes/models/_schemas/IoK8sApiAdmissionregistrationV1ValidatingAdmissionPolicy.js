...
const schema0 = {"properties":{"apiVersion":{"$ref":"I2rC4AZeN16vyliIXvprq-UnxvxFKXyEtwjcNn0IxB8"},"kind":{"$ref":"DIF_tgKsUhbsV2OXL070IEWKOHfD4sT5VzJLD8xF66U"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"v6OTdiBdyM-U9bFnYqwMhWTfoApqD4AwiVaBVqOhBmU"},"status":{"$ref":"gJ1rWy9i0Z_4u_kUlZxHHpF82giAjY9vVbAkpPR6pZY"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicy"};
const schema1 = {"type":"string","enum":["admissionregistration.k8s.io/v1"]};
...
if(!(data === "admissionregistration.k8s.io/v1")){
...
const schema2 = {"type":"string","enum":["ValidatingAdmissionPolicy"]};
...
if(!(data === "ValidatingAdmissionPolicy")){
...
const schema5 = {"nullableRef":"io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicySpec#"};
const schema6 = {};

import { validate as validate10 } from "./IoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicySpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicyStatus#"};
const schema8 = {};

import { validate as validate14 } from "./IoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicyStatus.js";
...
/*# sourceURL="io.k8s.api.admissionregistration.v1.ValidatingAdmissionPolicy" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
