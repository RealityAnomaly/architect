...
const schema0 = {"properties":{"current":{"$ref":"57fVsV8QF6K7Eiz-QHtZM5WNXfZEa1BLaFAolOSmaGo"},"metric":{"$ref":"SP4t9bMcqKFbQ_Hn3zWQQ4aHu6Vcm_suAhTijLCaIoo"}},"required":["metric","current"],"type":"object","$id":"io.k8s.api.autoscaling.v2beta2.ExternalMetricStatus"};
const schema1 = {"$ref":"io.k8s.api.autoscaling.v2beta2.MetricValueStatus#"};
const schema2 = {};

import { validate as validate2 } from "./IoK8sApiAutoscalingV2beta2MetricValueStatus.js";
...
/*# sourceURL="io.k8s.api.autoscaling.v2beta2.ExternalMetricStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
