...
import { IIoK8sApiPolicyV1PodDisruptionBudgetSpec } from "./PodDisruptionBudgetSpec.ts";
import { IIoK8sApiPolicyV1PodDisruptionBudgetStatus } from "./PodDisruptionBudgetStatus.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/architect/kubernetes/types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/architect/kubernetes/types/meta";
import { ValidateFunc } from "@glassway/architect/kubernetes/validate";
import { validate } from "../../_schemas/IoK8sApiPolicyV1PodDisruptionBudget.js";
...
static apiVersion: IPodDisruptionBudget["apiVersion"] = "policy/v1";
static kind: IPodDisruptionBudget["kind"] = "PodDisruptionBudget";
static is = createTypeMetaGuard<IPodDisruptionBudget>(PodDisruptionBudget);
...
export type {
  IPodDisruptionBudget as IIoK8sApiPolicyV1PodDisruptionBudget,
  PodDisruptionBudget as IoK8sApiPolicyV1PodDisruptionBudget
};
