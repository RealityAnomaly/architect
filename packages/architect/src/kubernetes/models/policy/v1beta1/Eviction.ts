...
import { validate } from "../../_schemas/IoK8sApiPolicyV1beta1Eviction.js";
...
static apiVersion: IEviction["apiVersion"] = "policy/v1beta1";
static kind: IEviction["kind"] = "Eviction";
static is = createTypeMetaGuard<IEviction>(Eviction);
...
export type {
  IEviction as IIoK8sApiPolicyV1beta1Eviction,
  Eviction as IoK8sApiPolicyV1beta1Eviction
};
