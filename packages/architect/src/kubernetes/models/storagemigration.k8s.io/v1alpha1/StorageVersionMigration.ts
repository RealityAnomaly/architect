...
import { validate } from "../../_schemas/IoK8sApiStoragemigrationV1alpha1StorageVersionMigration.js";
...
static is = createTypeMetaGuard<IStorageVersionMigration>(StorageVersionMigration);
