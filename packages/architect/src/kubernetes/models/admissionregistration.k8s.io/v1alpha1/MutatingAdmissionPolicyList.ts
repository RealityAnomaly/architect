import { IIoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicy } from "./MutatingAdmissionPolicy.ts";
import { IIoK8sApimachineryPkgApisMetaV1ListMeta } from "../../../apimachinery/apis/meta/v1/ListMeta.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/architect/kubernetes/types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/architect/kubernetes/types/meta";
import { ValidateFunc } from "@glassway/architect/kubernetes/validate";
import { validate } from "../../_schemas/IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicyList.js";
 ...
 */
"items": Array<IIoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicy>;
...
static apiVersion: IMutatingAdmissionPolicyList["apiVersion"] = "admissionregistration.k8s.io/v1alpha1";
static kind: IMutatingAdmissionPolicyList["kind"] = "MutatingAdmissionPolicyList";
static is = createTypeMetaGuard<IMutatingAdmissionPolicyList>(MutatingAdmissionPolicyList);
...
export type {
  IMutatingAdmissionPolicyList as IIoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicyList,
  MutatingAdmissionPolicyList as IoK8sApiAdmissionregistrationV1alpha1MutatingAdmissionPolicyList
};
