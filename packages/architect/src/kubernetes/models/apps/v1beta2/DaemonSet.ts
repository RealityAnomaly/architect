...
import { IIoK8sApiAppsV1beta2DaemonSetSpec } from "./DaemonSetSpec.ts";
import { IIoK8sApiAppsV1beta2DaemonSetStatus } from "./DaemonSetStatus.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/architect/kubernetes/types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/architect/kubernetes/types/meta";
import { ValidateFunc } from "@glassway/architect/kubernetes/validate";
import { validate } from "../../_schemas/IoK8sApiAppsV1beta2DaemonSet.js";
...
static apiVersion: IDaemonSet["apiVersion"] = "apps/v1beta2";
...
export type {
  IDaemonSet as IIoK8sApiAppsV1beta2DaemonSet,
  DaemonSet as IoK8sApiAppsV1beta2DaemonSet
};
