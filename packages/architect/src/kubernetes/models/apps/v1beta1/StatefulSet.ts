...
import { IIoK8sApiAppsV1beta1StatefulSetSpec } from "./StatefulSetSpec.ts";
import { IIoK8sApiAppsV1beta1StatefulSetStatus } from "./StatefulSetStatus.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/architect/kubernetes/types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/architect/kubernetes/types/meta";
import { ValidateFunc } from "@glassway/architect/kubernetes/validate";
import { validate } from "../../_schemas/IoK8sApiAppsV1beta1StatefulSet.js";
...
static apiVersion: IStatefulSet["apiVersion"] = "apps/v1beta1";
...
export type {
  IStatefulSet as IIoK8sApiAppsV1beta1StatefulSet,
  StatefulSet as IoK8sApiAppsV1beta1StatefulSet
};
