...
import { IIoK8sApiAppsV1beta1DeploymentSpec } from "./DeploymentSpec.ts";
import { IIoK8sApiAppsV1beta1DeploymentStatus } from "./DeploymentStatus.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/architect/kubernetes/types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/architect/kubernetes/types/meta";
import { ValidateFunc } from "@glassway/architect/kubernetes/validate";
import { validate } from "../../_schemas/IoK8sApiAppsV1beta1Deployment.js";
...
static apiVersion: IDeployment["apiVersion"] = "apps/v1beta1";
...
export type {
  IDeployment as IIoK8sApiAppsV1beta1Deployment,
  Deployment as IoK8sApiAppsV1beta1Deployment
};
