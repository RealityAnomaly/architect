...
import { IIoK8sApiBatchV1beta1CronJobSpec } from "./CronJobSpec.ts";
import { IIoK8sApiBatchV1beta1CronJobStatus } from "./CronJobStatus.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/architect/kubernetes/types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/architect/kubernetes/types/meta";
import { ValidateFunc } from "@glassway/architect/kubernetes/validate";
import { validate } from "../../_schemas/IoK8sApiBatchV1beta1CronJob.js";
...
static apiVersion: ICronJob["apiVersion"] = "batch/v1beta1";
...
export type {
  ICronJob as IIoK8sApiBatchV1beta1CronJob,
  CronJob as IoK8sApiBatchV1beta1CronJob
};
