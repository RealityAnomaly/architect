 ...
 */
"successPolicy"?: IIoK8sApiBatchV1SuccessPolicy;
/**
 ...
 * JobSpec describes how the job execution will look like.
 */
export class JobSpec extends Model<IJobSpec> implements IJobSpec {
  "activeDeadlineSeconds"?: number;
"backoffLimit"?: number;
"backoffLimitPerIndex"?: number;
"completionMode"?: string;
...
setValidateFunc(JobSpec, validate as ValidateFunc<IJobSpec>);

export type {
  IJobSpec as IIoK8sApiBatchV1JobSpec,
  JobSpec as IoK8sApiBatchV1JobSpec
};
