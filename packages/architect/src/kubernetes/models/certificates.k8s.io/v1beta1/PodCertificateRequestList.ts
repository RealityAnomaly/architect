...
import { validate } from "../../_schemas/IoK8sApiCertificatesV1beta1PodCertificateRequestList.js";
...
static is = createTypeMetaGuard<IPodCertificateRequestList>(PodCertificateRequestList);
