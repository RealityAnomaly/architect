...
import { validate } from "../../_schemas/IoK8sApiApiserverinternalV1alpha1StorageVersionList.js";
...
static is = createTypeMetaGuard<IStorageVersionList>(StorageVersionList);
