...
import { validate } from "../../_schemas/Wgpolicyk8sIoV1alpha1PolicyReport.js";
 ...
 * PolicyReport is the Schema for the policyreports API
 */
export class PolicyReport extends Model<IPolicyReport> implements IPolicyReport {
  "apiVersion": IPolicyReport["apiVersion"];
  "kind": IPolicyReport["kind"];
  "metadata"?: IPolicyReport["metadata"];
  "results"?: IPolicyReport["results"];
  "scope"?: IPolicyReport["scope"];
  "scopeSelector"?: IPolicyReport["scopeSelector"];
  "summary"?: IPolicyReport["summary"];

static apiVersion: IPolicyReport["apiVersion"] = "wgpolicyk8s.io/v1alpha1";
static kind: IPolicyReport["kind"] = "PolicyReport";
static is = createTypeMetaGuard<IPolicyReport>(PolicyReport);

constructor(data?: ModelData<IPolicyReport>) {
  super({
    apiVersion: PolicyReport.apiVersion,
    kind: PolicyReport.kind,
    ...data
  } as IPolicyReport);
}
}
...
setValidateFunc(PolicyReport, validate as ValidateFunc<IPolicyReport>);
