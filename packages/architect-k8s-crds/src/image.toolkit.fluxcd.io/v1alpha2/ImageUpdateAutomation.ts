...
const schemaId = "image.toolkit.fluxcd.io.v1alpha2.ImageUpdateAutomation";
const schema = {
  "type": "object",
  "properties": {
    "apiVersion": {
...
static apiVersion: IImageUpdateAutomation["apiVersion"] = "image.toolkit.fluxcd.io/v1alpha2";
