...
const schema83 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "vk4wdo9M1u1ubBuy5bzylmC3qGFbd8BAJxcdqWrpD5Y"
    },
    "metadata": {
  ...
  "$id": "cilium.io.v2.CiliumClusterwideNetworkPolicy"
};
const schema84 = {
  "type": "string",
  "enum": ["cilium.io/v2"]
...
const schema85 = {
  "type": "string",
  "enum": ["CiliumClusterwideNetworkPolicy"]
};
function validate231(data, {
  ...
  if (!(data === "CiliumClusterwideNetworkPolicy")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate228(data, {
  ...
  /*# sourceURL="cilium.io.v2.CiliumClusterwideNetworkPolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
