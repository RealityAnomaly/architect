...
const schema24 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "tL7FJlUQhJZwpiJ2dGn0gk5x4OlirLvML6BrDiMK1Q"
    },
    "status": {
  ...
  "$id": "acme.cert-manager.io.v1alpha3.Challenge"
};
const schema25 = {
  "type": "string",
...
const schema29 = {
  "properties": {
    ...
    "type": {
      "$ref": "jQKD5sSqyr1kLnLtHaExmAC5DwaiVMQeDZDKPRbel74"
    },
    "url": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
...
function validate74(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.authzURL === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "authzURL"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.authzURL !== undefined) {
      if (!validate21(data.authzURL, {
        instancePath: instancePath + "/authzURL",
        parentData: data,
        parentDataProperty: "authzURL",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate65(data, {
  ...
  /*# sourceURL="acme.cert-manager.io.v1alpha3.Challenge" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.metadata === undefined) {
