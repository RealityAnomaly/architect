...
const schema16 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "oFIHUgimAK695hYnUjUyJDDYW7tdaxTaxfCfeb3SSPY"
    },
    "status": {
  ...
  "$id": "cert-manager.io.v1alpha3.Certificate"
};
const schema17 = {
  "type": "string",
...
function validate37(data, {
  ...
  /*# sourceURL="cert-manager.io.v1alpha3.Certificate" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
