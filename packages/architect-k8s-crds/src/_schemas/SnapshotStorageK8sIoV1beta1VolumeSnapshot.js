...
const schema8 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "cnHJdxmnQuatjjsxvBklBO2kITLEePrDErVOVtBH0UA"
    },
    "status": {
  ...
  "$id": "snapshot.storage.k8s.io.v1beta1.VolumeSnapshot"
};
const schema9 = {
  "type": "string",
...
const schema11 = {
  "properties": {
    "source": {
      "$ref": "YTibFlIJn4eRWFZ3CkjJU5dc9bzfZrdYEzLvMTA"
    },
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.restoreSize !== undefined) {
      if (!validate44(data.restoreSize, {
...
function validate23(data, {
  ...
  /*# sourceURL="snapshot.storage.k8s.io.v1beta1.VolumeSnapshot" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
