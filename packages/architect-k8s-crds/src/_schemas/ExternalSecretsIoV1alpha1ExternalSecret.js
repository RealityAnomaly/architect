...
const schema15 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "7P0NDQvQAF8hYJSC4NuXQMmSMZr24F2asBOcx5lcM"
    },
    "status": {
  ...
  "$id": "external-secrets.io.v1alpha1.ExternalSecret"
};
const schema16 = {
  "type": "string",
...
const schema20 = {
  "properties": {
    "data": {
      "$ref": "2DTEzv8T1WA1TYZNzRyPsH8IdxnJ5pAbdHHrHFDMBr8"
    },
    "dataFrom": {
      "$ref": "LlLnLgKq2fwxJBvIHgZUR1GT27H7GlBCLOGv1Aa2w"
    },
    "refreshInterval": {
      "$ref": "w84kBFuid6q5A2EyALRC9Fkg16rGnyoLRuwIG6vfws"
    },
    "secretStoreRef": {
      "$ref": "qG2rchYsQfqJ3Iejc7MkpREzc2DvxImn9J47xQu134"
    },
    "target": {
      "$ref": "Ejf6nBkCI6sksMaxE0DEsZiGV0xBmQw608nry10LG4E"
    }
  },
  "required": ["secretStoreRef", "target"],
  "type": "object",
  "nullable": true
};
const schema21 = {
  "items": {
    "$ref": "hP8Xi33tENBmqBB6YCrsauN0brLl8TdzXioWjyS0j4"
  },
  "type": "array",
  "nullable": true
};
const schema22 = {
  "properties": {
    "remoteRef": {
      "$ref": "mfZqsaaxzvrCO8yh8tY9VnWcGi4Diw0TGv8RAgU"
    },
    "secretKey": {
...
function validate23(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.conversionStrategy !== undefined) {
      if (!validate24(data.conversionStrategy, {
...
const schema26 = {
  "properties": {
    "creationPolicy": {
      "$ref": "kp0ghKyvXObF2OHGYtWYciD9cNaolmyDdCe2Kv9pc4"
    },
    "immutable": {
    ...
    "template": {
      "$ref": "z2bQiHN3aUDPe25ZiKKtAYIKpWaqMwVWcwAYYI3hM"
    }
  },
  "type": "object"
};
...
function validate65(data, {
  ...
  if (!(data === "Owner" || data === "Merge" || data === "None")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema29 = {
  "properties": {
    ...
    "engineVersion": {
      "$ref": "3s6hAxDn2cK57J74camicAUgYPr37GF7vgw34Qi6vE"
    },
    "metadata": {
      "$ref": "igJYwSZYrBtVsRmcMsQYdB7Q50xFQbahYKwITLXw0"
    },
    "templateFrom": {
      "$ref": "iVoOxWSr1TBWzlCv9n1XTuXJ7QLSyNDCyCJJNWHqBck"
    },
    "type": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    }
...
const schema32 = {
  "items": {
    "$ref": "a0EwtSh3mj5PGrbSSNIokbqtPAClZAG7RZQORta888"
  },
  "type": "array",
  "nullable": true
};
const schema33 = {
  ...
  "properties": {
    "configMap": {
      "$ref": "rOwJhWIpUWGBi6nNZHgUIZ4Li1X1ZSgXP46hYLjbRU"
    },
    "secret": {
      "$ref": "rOwJhWIpUWGBi6nNZHgUIZ4Li1X1ZSgXP46hYLjbRU"
    }
...
const schema11 = {
  "properties": {
    "items": {
      "$ref": "NEbmzoVXnVJWC3MDDRNkQAZqyQhrSjNQ4E3zMAng"
    },
    "name": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    }
...
const schema12 = {
  "items": {
    "$ref": "tI6A0ivxxn3WP4tPAqiGWTth4NQWse7zoy4QH5Y2nc"
  },
  "type": "array"
};
const schema13 = {
...
function validate70(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.engineVersion !== undefined) {
      if (!validate72(data.engineVersion, {
    ...
    if (data.templateFrom !== undefined) {
      if (!validate78(data.templateFrom, {
...
function validate64(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.creationPolicy !== undefined) {
      if (!validate65(data.creationPolicy, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.secretStoreRef === undefined) {
      const err1 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "secretStoreRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.refreshInterval !== undefined) {
      if (!validate58(data.refreshInterval, {
    ...
    if (data.secretStoreRef !== undefined) {
      if (!validate60(data.secretStoreRef, {
...
function validate94(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate38(data.lastTransitionTime, {
...
function validate88(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.refreshTime !== undefined) {
      if (!validate38(data.refreshTime, {
...
function validate39(data, {
  ...
  /*# sourceURL="external-secrets.io.v1alpha1.ExternalSecret" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
