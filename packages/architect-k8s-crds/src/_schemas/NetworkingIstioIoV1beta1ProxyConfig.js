...
const schema8 = {
  ...
  "properties": {
    "spec": {
      "$ref": "oCMAFGyhzkODg3hu0ehVBBt4gmHG98KYOPu3KVK2X0"
    },
    "status": {
    ...
    "kind": {
      "$ref": "aEyCkXBnwJ9fMcGoxzJKQzZ9Sfb9vZ6QEwC1K9Smjdg"
    },
    "metadata": {
  ...
  "$id": "networking.istio.io.v1beta1.ProxyConfig"
};
const schema9 = {
  "properties": {
    "concurrency": {
    ...
    "image": {
      "$ref": "DkvIqTmjtDQMzIUfn4wQHIkVeH7qK71qDg22gxJIliQ"
    },
    "selector": {
...
function validate25(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.concurrency !== undefined) {
      if (!validate26(data.concurrency, {
        instancePath: instancePath + "/concurrency",
        parentData: data,
        parentDataProperty: "concurrency",
        rootData
      })) {
    ...
    if (data.environmentVariables !== undefined) {
      if (!validate21(data.environmentVariables, {
        instancePath: instancePath + "/environmentVariables",
        parentData: data,
        parentDataProperty: "environmentVariables",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate24(data, {
  ...
  /*# sourceURL="networking.istio.io.v1beta1.ProxyConfig" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
