...
const schema26 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "Bd9dseW44oTuHIFClxdLhOsVO61MSdmF7IWiww0qSE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "0UzrF4GKnoGc0VLx9lCQw3LCKjXzFMLKab3oHsXfSg"
    },
    "status": {
  ...
  "$id": "cert-manager.io.v1beta1.ClusterIssuer"
};
const schema27 = {
  "type": "string",
...
const schema31 = {
  "properties": {
    "acme": {
      "$ref": "YE93131unH33ZV9I8XGBWsdXTIdXmZhFMXaI0UWskY"
    },
    "ca": {
...
const schema32 = {
  "properties": {
    ...
    "solvers": {
      "$ref": "Cc6Mp3uAlfRDoYzikckl7KuXFeqvdFxjKnuP876J6cs"
    }
  },
...
function validate67(data, {
  ...
  /*# sourceURL="cert-manager.io.v1beta1.ClusterIssuer" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.spec === undefined) {
