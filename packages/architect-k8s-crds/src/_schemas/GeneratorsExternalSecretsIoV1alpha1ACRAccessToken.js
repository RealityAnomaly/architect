...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "PttLyFSTwM69z7WQ2v6x3Lek9luntz0ozbbqCRg28"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "I22KQHAmOEanH4feqgtTajXGkb3OSdim8AvQqDzINEw"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "generators.external-secrets.io.v1alpha1.ACRAccessToken"
};
const schema10 = {
  "type": "string",
...
const schema14 = {
  "properties": {
    "auth": {
      "$ref": "MOiba8Ud6pbD9XOL1vrT6XAcIAGVGLaLa8kpVOlebSc"
    },
    "environmentType": {
...
const schema15 = {
  "properties": {
    "managedIdentity": {
      "$ref": "tAEWoQJKiJe0ABygeJ0wqRU5fD6RnWaJJR1iUlKiIQ"
    },
    "servicePrincipal": {
      "$ref": "uuJjXSAIpj4yqGlL01OcwwohBcjRDLK2xqbgOij9k"
    },
    "workloadIdentity": {
...
const schema17 = {
  "properties": {
    "secretRef": {
      "$ref": "lXiKdcVBb5QZRXaTAnmHwYOhIH6rAzxhLqBVqT5Pe0"
    }
  },
  "required": ["secretRef"],
  "type": "object",
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.serviceAccountRef !== undefined) {
      if (!validate48(data.serviceAccountRef, {
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.managedIdentity !== undefined) {
      if (!validate38(data.managedIdentity, {
    ...
    if (data.servicePrincipal !== undefined) {
      if (!validate41(data.servicePrincipal, {
        instancePath: instancePath + "/servicePrincipal",
        parentData: data,
        parentDataProperty: "servicePrincipal",
        rootData
      })) {
    ...
    if (data.workloadIdentity !== undefined) {
      if (!validate47(data.workloadIdentity, {
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.environmentType !== undefined) {
      if (!validate57(data.environmentType, {
...
function validate27(data, {
  ...
  /*# sourceURL="generators.external-secrets.io.v1alpha1.ACRAccessToken" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
