...
const schema10 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "df2mei2DOaJyCtUfnF1Xl5VZUEVdhyEbWekA1FsghFE"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "ItpW6abi1l5fbjsuQ3es25hvLBjNqcxo9l5VApgvko"
    },
    "status": {
  ...
  "$id": "acme.cert-manager.io.v1alpha3.Order"
};
const schema11 = {
  "type": "string",
  "enum": ["acme.cert-manager.io/v1alpha3"]
};
function validate27(data, {
  ...
  if (!(data === "acme.cert-manager.io/v1alpha3")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate26(data, {
  ...
  /*# sourceURL="acme.cert-manager.io.v1alpha3.Order" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
