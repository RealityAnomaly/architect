...
const schema7 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "2BANK8ennvhrnNACwGcpBTsBepBYN41zx6qVY3LPAc"
    },
    "status": {
  ...
  "$id": "snapshot.storage.k8s.io.v1beta1.VolumeSnapshotContent"
};
const schema8 = {
  "type": "string",
...
const schema10 = {
  "properties": {
    ...
    "source": {
      "$ref": "MApX9BaUCsVp8ZBSjdZyu4xYHWspF2nkMhpRXLhJ0"
    },
...
function validate27(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.volumeSnapshotRef !== undefined) {
      if (!validate37(data.volumeSnapshotRef, {
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.creationTime !== undefined) {
      if (!validate48(data.creationTime, {
    ...
    if (data.restoreSize !== undefined) {
      if (!validate57(data.restoreSize, {
...
const schema22 = {};
import { validate as validate62 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
function validate22(data, {
  ...
  /*# sourceURL="snapshot.storage.k8s.io.v1beta1.VolumeSnapshotContent" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
