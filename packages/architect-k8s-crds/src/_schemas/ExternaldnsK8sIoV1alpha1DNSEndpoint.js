...
const schema9 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "niZ8xTyU7QrAi6beNGsm3XTkZYHbs4O5l4Yzwgb2Lw"
    },
    "kind": {
      "$ref": "7bN19sGUan15ZgQjGjCE5WhhNzP5APd1jdcJH6J9KvM"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "1IzgZgQASkDo217AyeFfAn6z8LVNolsysSyXiw58"
    },
    "status": {
      "$ref": "HnH72na28k3AxhkWkPOXeKn3cXHIjuQ02WK7yQuyPI"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "externaldns.k8s.io.v1alpha1.DNSEndpoint"
};
const schema10 = {
  "type": "string",
  "enum": ["externaldns.k8s.io/v1alpha1"]
};
function validate25(data, {
  ...
  if (!(data === "externaldns.k8s.io/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema14 = {
  "properties": {
    "endpoints": {
      "$ref": "tIkXT2cpFNdIfLhKycQZZ7HXZpl4dG1iKJBX0pqlDA"
    }
  },
  "type": "object",
  "nullable": true
...
const schema15 = {
  "items": {
    "$ref": "OOgyXHWZyEBbKpRxDYRQo3kQQjIZw7vNb7wlo6vkhg"
  },
  "type": "array",
  "nullable": true
};
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.providerSpecific !== undefined) {
      if (!validate40(data.providerSpecific, {
        instancePath: instancePath + "/providerSpecific",
        parentData: data,
        parentDataProperty: "providerSpecific",
        rootData
      })) {
    ...
    if (data.recordTTL !== undefined) {
      if (!validate23(data.recordTTL, {
        instancePath: instancePath + "/recordTTL",
        parentData: data,
        parentDataProperty: "recordTTL",
        rootData
      })) {
    ...
    if (data.recordType !== undefined) {
      if (!validate21(data.recordType, {
        instancePath: instancePath + "/recordType",
        parentData: data,
        parentDataProperty: "recordType",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.setIdentifier !== undefined) {
      if (!validate21(data.setIdentifier, {
        instancePath: instancePath + "/setIdentifier",
        parentData: data,
        parentDataProperty: "setIdentifier",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate24(data, {
  ...
  /*# sourceURL="externaldns.k8s.io.v1alpha1.DNSEndpoint" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
