...
const schema20 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "zTWSxIKqKt2b3Q0VvtJsvn0hOiZoYZrpf3WQp9O7yDI"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "EBZwp6RvEkh9dwo46kmGhAuWAsLwnvXxXjYnIPM9PM"
    }
  },
  "required": ["spec", "apiVersion", "kind"],
  "$id": "monitoring.coreos.com.v1.PodMonitor"
};
const schema21 = {
  "type": "string",
...
const schema25 = {
  "properties": {
    ...
    "podMetricsEndpoints": {
      "$ref": "HbaoEyb65JlYhviok1lHLpoWoa4cPQcwph9ngKBy7g"
    },
    "podTargetLabels": {
...
const schema28 = {
  "items": {
    "$ref": "7ClSQlnA68wfbIXUXJX6Igb8n0MTZE5cpDxrdsIkjA"
  },
  "type": "array"
};
const schema29 = {
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sourceLabels !== undefined) {
      if (!validate39(data.sourceLabels, {
...
function validate88(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.clientSecret !== undefined) {
      if (!validate93(data.clientSecret, {
...
function validate119(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.insecureSkipVerify !== undefined) {
      if (!validate22(data.insecureSkipVerify, {
...
function validate73(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.authorization !== undefined) {
      if (!validate74(data.authorization, {
    ...
    if (data.bearerTokenSecret !== undefined) {
      if (!validate25(data.bearerTokenSecret, {
    ...
    if (data.followRedirects !== undefined) {
      if (!validate22(data.followRedirects, {
    ...
    if (data.honorLabels !== undefined) {
      if (!validate22(data.honorLabels, {
    ...
    if (data.honorTimestamps !== undefined) {
      if (!validate22(data.honorTimestamps, {
    ...
    if (data.metricRelabelings !== undefined) {
      if (!validate31(data.metricRelabelings, {
    ...
    if (data.relabelings !== undefined) {
      if (!validate31(data.relabelings, {
    ...
    if (data.scrapeTimeout !== undefined) {
      if (!validate45(data.scrapeTimeout, {
    ...
    if (data.targetPort !== undefined) {
      if (!validate114(data.targetPort, {
...
function validate130(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate131(data.matchExpressions, {
...
function validate60(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.attachMetadata !== undefined) {
      if (!validate61(data.attachMetadata, {
        instancePath: instancePath + "/attachMetadata",
        parentData: data,
        parentDataProperty: "attachMetadata",
        rootData
      })) {
    ...
    if (data.labelNameLengthLimit !== undefined) {
      if (!validate21(data.labelNameLengthLimit, {
    ...
    if (data.labelValueLengthLimit !== undefined) {
      if (!validate21(data.labelValueLengthLimit, {
    ...
    if (data.namespaceSelector !== undefined) {
      if (!validate68(data.namespaceSelector, {
    ...
    if (data.podMetricsEndpoints !== undefined) {
      if (!validate72(data.podMetricsEndpoints, {
    ...
    if (data.podTargetLabels !== undefined) {
      if (!validate29(data.podTargetLabels, {
    ...
    if (data.sampleLimit !== undefined) {
      if (!validate21(data.sampleLimit, {
    ...
    if (data.targetLimit !== undefined) {
      if (!validate21(data.targetLimit, {
...
function validate51(data, {
  ...
  /*# sourceURL="monitoring.coreos.com.v1.PodMonitor" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
