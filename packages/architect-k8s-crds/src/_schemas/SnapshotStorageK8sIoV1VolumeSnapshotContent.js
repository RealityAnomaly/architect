...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "nJJIxeswHV1ij5X8jOfVmqac259bTQjlLsHq4Vlb30"
    },
    "spec": {
      "$ref": "kTYwezlrVX7vu6iIFx9IMdaBSYtMLiafvzx5tio3pbM"
    },
    "status": {
      "$ref": "rPD2yZuOwWHhVxpGVSSpT3q1ca8b9npACKA6GkqMSZQ"
    },
    "metadata": {
  ...
  "$id": "snapshot.storage.k8s.io.v1.VolumeSnapshotContent"
};
const schema8 = {
  "type": "string",
...
const schema10 = {
  "properties": {
    ...
    "source": {
      "$ref": "IfRiNyv3mgeH0vcz8PYhX4BzhUpmTzB8sJZZNdywM"
    },
    "sourceVolumeMode": {
...
const schema13 = {
  "oneOf": [{
    "$ref": "PwtqGlwiuRhSmHSUP43GKglcwEBtSuMKnqaB63bTU4"
  }, {
    "$ref": "wAF1EDkmQrfnqNwtSdrPjpo6mh5cvKdHWv4bl7ar4"
  }],
  "properties": {
    "snapshotHandle": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.snapshotHandle === undefined) {
      const err0 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "snapshotHandle"
        }
      };
      if (vErrors === null) {
        vErrors = [err0];
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.snapshotHandle !== undefined) {
      if (!validate21(data.snapshotHandle, {
        instancePath: instancePath + "/snapshotHandle",
        parentData: data,
        parentDataProperty: "snapshotHandle",
        rootData
      })) {
    ...
    if (data.volumeHandle !== undefined) {
      if (!validate21(data.volumeHandle, {
        instancePath: instancePath + "/volumeHandle",
        parentData: data,
        parentDataProperty: "volumeHandle",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate27(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.volumeSnapshotRef === undefined) {
      const err3 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "volumeSnapshotRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err3];
    ...
    if (data.deletionPolicy !== undefined) {
      if (!validate28(data.deletionPolicy, {
    ...
    if (data.sourceVolumeMode !== undefined) {
      if (!validate21(data.sourceVolumeMode, {
        instancePath: instancePath + "/sourceVolumeMode",
        parentData: data,
        parentDataProperty: "sourceVolumeMode",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.volumeSnapshotRef !== undefined) {
      if (!validate42(data.volumeSnapshotRef, {
        instancePath: instancePath + "/volumeSnapshotRef",
        parentData: data,
        parentDataProperty: "volumeSnapshotRef",
        rootData
      })) {
...
function validate52(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.creationTime !== undefined) {
      if (!validate53(data.creationTime, {
    ...
    if (data.restoreSize !== undefined) {
      if (!validate62(data.restoreSize, {
...
const schema24 = {};
import { validate as validate67 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
function validate22(data, {
  ...
  /*# sourceURL="snapshot.storage.k8s.io.v1.VolumeSnapshotContent" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
