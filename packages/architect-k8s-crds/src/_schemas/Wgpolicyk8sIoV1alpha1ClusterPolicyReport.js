...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "2JbLIRvXlXbPQI55mRbdwpE2EY34tQpQwdH7fjMsU"
    },
    "metadata": {
  ...
  "$id": "wgpolicyk8s.io.v1alpha1.ClusterPolicyReport"
};
const schema15 = {
  "type": "string",
...
function validate37(data, {
  ...
  /*# sourceURL="wgpolicyk8s.io.v1alpha1.ClusterPolicyReport" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
