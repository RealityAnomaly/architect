...
const schema13 = {
  ...
  "properties": {
    "spec": {
      "$ref": "YEn4egpc8CEYeCKhgWEEunttI7RSKgoMrU9r2Vlsbs"
    },
    "status": {
    ...
    "kind": {
      "$ref": "AGtHWcNxZ68zp5mX1MxUVQxZrUXw6XWYcQtR0pXqdg"
    },
    "metadata": {
  ...
  "$id": "networking.istio.io.v1alpha3.Sidecar"
};
const schema14 = {
  "properties": {
    "egress": {
      "$ref": "cZ7DZA3YjHzNj52OryqbBblslTDPhA1Pbazz7OTyMI"
    },
    "ingress": {
      "$ref": "W6BooLT2QWcovl1AxkDfmbMqYRrGGvhkwAiYFPDWPv4"
    },
    "outboundTrafficPolicy": {
      "$ref": "n3QgyN3c0P5j0nCKpD3a64WZclg6sUlgudwd4hCIiSc"
    },
    "workloadSelector": {
...
const schema15 = {
  "items": {
    "$ref": "ywRYmO5QEXZsaMnkwqFKbtR45WEPsffc23gsUgiJc"
  },
  "type": "array",
  "nullable": true
};
const schema16 = {
  "properties": {
    ...
    "captureMode": {
      "$ref": "vNDgjILVzu6Y252OEYr8NmXv559huYcVmS8cg8TLfc"
    },
    "hosts": {
...
function validate23(data, {
  ...
  if (!(data === "DEFAULT" || data === "IPTABLES" || data === "NONE")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.captureMode !== undefined) {
      if (!validate23(data.captureMode, {
        instancePath: instancePath + "/captureMode",
        parentData: data,
        parentDataProperty: "captureMode",
        rootData
      })) {
...
const schema17 = {
  "items": {
    "$ref": "M53C2G0K0Rngzya8ArGmWcu5ZpsKrtowXZ4zBfhpA"
  },
  "type": "array",
  "nullable": true
};
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.cipherSuites !== undefined) {
      if (!validate29(data.cipherSuites, {
    ...
    if (data.httpsRedirect !== undefined) {
      if (!validate53(data.httpsRedirect, {
    ...
    if (data.maxProtocolVersion !== undefined) {
      if (!validate32(data.maxProtocolVersion, {
    ...
    if (data.minProtocolVersion !== undefined) {
      if (!validate32(data.minProtocolVersion, {
    ...
    if (data.subjectAltNames !== undefined) {
      if (!validate29(data.subjectAltNames, {
    ...
    if (data.verifyCertificateHash !== undefined) {
      if (!validate29(data.verifyCertificateHash, {
    ...
    if (data.verifyCertificateSpki !== undefined) {
      if (!validate29(data.verifyCertificateSpki, {
...
const schema22 = {
  "properties": {
    ...
    "mode": {
      "$ref": "zCa6BcxiFxJV4sNRBQtnp177cR06FikxsNEFOcyhJI"
    }
  },
  "type": "object",
  "nullable": true
...
function validate75(data, {
  ...
  if (!(data === "REGISTRY_ONLY" || data === "ALLOW_ANY")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate67(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.egressProxy !== undefined) {
      if (!validate68(data.egressProxy, {
        instancePath: instancePath + "/egressProxy",
        parentData: data,
        parentDataProperty: "egressProxy",
        rootData
      })) {
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.outboundTrafficPolicy !== undefined) {
      if (!validate67(data.outboundTrafficPolicy, {
        instancePath: instancePath + "/outboundTrafficPolicy",
        parentData: data,
        parentDataProperty: "outboundTrafficPolicy",
        rootData
      })) {
    ...
    if (data.workloadSelector !== undefined) {
      if (!validate78(data.workloadSelector, {
...
function validate33(data, {
  ...
  /*# sourceURL="networking.istio.io.v1alpha3.Sidecar" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
