...
const schema14 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "EyGhDq7T2CUAsZY4UVrfj28OIOfWrXuTzN33vZzco"
    },
    "metadata": {
  ...
  "$id": "kyverno.io.v1alpha2.ReportChangeRequest"
};
const schema15 = {
  "type": "string",
...
function validate37(data, {
  ...
  /*# sourceURL="kyverno.io.v1alpha2.ReportChangeRequest" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
