...
const schema7 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "3FDKODxAFzydqbDMhQcQPYvlVBx0MwVawxERqyblsU"
    },
    "deletionPolicy": {
  ...
  "$id": "snapshot.storage.k8s.io.v1beta1.VolumeSnapshotClass"
};
const schema8 = {
  "type": "string",
...
function validate23(data, {
  ...
  if (!(data === "snapshot.storage.k8s.io/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate22(data, {
  ...
  /*# sourceURL="snapshot.storage.k8s.io.v1beta1.VolumeSnapshotClass" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
