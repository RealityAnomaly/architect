...
const schema10 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "7LwOIp4MUh2b5A4ruon9FpOJgePFJBK7PzfVc6pHE64"
    },
    "status": {
  ...
  "$id": "cert-manager.io.v1beta1.CertificateRequest"
};
const schema11 = {
  "type": "string",
...
function validate25(data, {
  ...
  /*# sourceURL="cert-manager.io.v1beta1.CertificateRequest" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
