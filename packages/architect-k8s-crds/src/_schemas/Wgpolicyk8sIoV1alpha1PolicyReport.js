...
const schema14 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "L2W72gW7OxiXpwExN0DY6F47ITip4uIEHON66WJTBIc"
    },
    "kind": {
      "$ref": "D5KCUm7lAdY0ZV0pKDnCvLQuv6Ngfe78M9vq8fYUVYk"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "results": {
      "$ref": "i1OXpvkkvgu5ch6xUObbQtitY0k2ZqfozjVErdPtuE"
    },
    "scope": {
  ...
  "$id": "wgpolicyk8s.io.v1alpha1.PolicyReport"
};
const schema15 = {
  "type": "string",
  "enum": ["wgpolicyk8s.io/v1alpha1"]
};
function validate38(data, {
  ...
  if (!(data === "wgpolicyk8s.io/v1alpha1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema19 = {
  "items": {
    "$ref": "ZtfEwdIoqwX7Ai2kSrQap1buYLEcIBDl82AGFfJuDkk"
  },
  "type": "array",
  "nullable": true
};
...
function validate37(data, {
  ...
  /*# sourceURL="wgpolicyk8s.io.v1alpha1.PolicyReport" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
