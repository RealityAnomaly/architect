...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "ojTGx7DFVnV2pVuEO3Hk9hz2uTyTsJ3WeTJUh6BB9r4"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "v2ZJX8ZLyF2fwye96ozuG0oB9J8VudKivBRXlPcKRE"
    },
    "status": {
  ...
  "$id": "secretgenerator.mittwald.de.v1alpha1.StringSecret"
};
const schema8 = {
  "type": "string",
...
const schema12 = {
  "properties": {
    ...
    "fields": {
      "$ref": "2Hm6Npm50Q15TKX1VpSzmHfgkj7tyWXHu0hLwqA9wo"
    },
    "forceRegenerate": {
...
const schema15 = {
  "items": {
    "$ref": "2gbJHbbInyolphoUsXKcTAAseIfkfIIf9v5468yHw"
  },
  "type": "array"
};
const schema16 = {
...
function validate31(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.forceRegenerate !== undefined) {
      if (!validate43(data.forceRegenerate, {
...
function validate22(data, {
  ...
  /*# sourceURL="secretgenerator.mittwald.de.v1alpha1.StringSecret" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
