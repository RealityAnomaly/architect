...
const schema16 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "ZEkUUz9vEVNot1FdGKRnKeYT0095nimIyAFSTdFKY"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "ReN9QubDlBCSAoQvYwq1GjFsZKl3MrFJLg8SwIGLko"
    },
    "status": {
  ...
  "$id": "cert-manager.io.v1beta1.Certificate"
};
const schema17 = {
  "type": "string",
  "enum": ["cert-manager.io/v1beta1"]
};
function validate38(data, {
  ...
  if (!(data === "cert-manager.io/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema21 = {
  "properties": {
    ...
    "privateKey": {
      "$ref": "WiGEY11s2qWcwn3RiC3KR6zYh2hRhiEGmWQfw9S2zwo"
    },
    "renewBefore": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema24 = {
  "properties": {
    "algorithm": {
      "$ref": "hQPYZkPgJquOHAdWmBQN0e0eyVO291OINyaZjoYIA"
    },
    "encoding": {
...
function validate63(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.algorithm !== undefined) {
      if (!validate64(data.algorithm, {
        instancePath: instancePath + "/algorithm",
        parentData: data,
        parentDataProperty: "algorithm",
        rootData
      })) {
...
function validate79(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.organizations !== undefined) {
      if (!validate22(data.organizations, {
...
function validate46(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.revisionHistoryLimit !== undefined) {
      if (!validate72(data.revisionHistoryLimit, {
    ...
    if (data.secretTemplate !== undefined) {
      if (!validate75(data.secretTemplate, {
...
function validate37(data, {
  ...
  /*# sourceURL="cert-manager.io.v1beta1.Certificate" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
