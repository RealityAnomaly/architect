...
const schema7 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "O1F5qfilFBPZqVAPUQnGT9Fk5eyTck4ih6txauvTs"
    },
    "metadata": {
  ...
  "$id": "networking.istio.io.v1beta1.WorkloadEntry"
};
const schema8 = {
  "properties": {
    "address": {
...
function validate22(data, {
  ...
  /*# sourceURL="networking.istio.io.v1beta1.WorkloadEntry" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
