...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "TMggkfBksMInL1YuubtTgpPyEYYNI0jyVGtOPrYsYjA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "6clxzo5d37OhN9eVdPSoB7NsMdgEi9DIVUAhzuZld4"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "generators.external-secrets.io.v1alpha1.STSSessionToken"
};
const schema10 = {
  "type": "string",
...
const schema13 = {};
import { validate as validate33 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema14 = {
  "properties": {
    ...
    "requestParameters": {
      "$ref": "gj2KQcfSRXvMKhEyteyFDhvgQSH532NbeMSTThIbJAA"
    },
    "role": {
...
function validate38(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.serviceAccountRef !== undefined) {
      if (!validate39(data.serviceAccountRef, {
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sessionTokenSecretRef !== undefined) {
      if (!validate23(data.sessionTokenSecretRef, {
...
function validate54(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sessionDuration !== undefined) {
      if (!validate56(data.sessionDuration, {
        instancePath: instancePath + "/sessionDuration",
        parentData: data,
        parentDataProperty: "sessionDuration",
        rootData
      })) {
    ...
    if (data.tokenCode !== undefined) {
      if (!validate22(data.tokenCode, {
        instancePath: instancePath + "/tokenCode",
        parentData: data,
        parentDataProperty: "tokenCode",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.requestParameters !== undefined) {
      if (!validate54(data.requestParameters, {
        instancePath: instancePath + "/requestParameters",
        parentData: data,
        parentDataProperty: "requestParameters",
        rootData
      })) {
...
function validate27(data, {
  ...
  /*# sourceURL="generators.external-secrets.io.v1alpha1.STSSessionToken" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
