...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "R5tkwq0g3xJRcrYlMrhki5SkX3WDGeNYhx5RAW5Y0"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "POSxUjeCGR1P8ZliVcsL3txtPmQhnbjWQrBObMarlM"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "generators.external-secrets.io.v1alpha1.GCRAccessToken"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  "properties": {
    "auth": {
      "$ref": "YSaxuJK1fKFQs1pkIWjyTAkMSuaV5gHEPNMpmpCZU"
    },
    "projectID": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    }
  },
  "required": ["auth", "projectID"],
  "type": "object",
  "nullable": true
};
const schema14 = {
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.secretAccessKeySecretRef !== undefined) {
      if (!validate35(data.secretAccessKeySecretRef, {
...
function validate41(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.clusterLocation !== undefined) {
      if (!validate22(data.clusterLocation, {
    ...
    if (data.clusterProjectID !== undefined) {
      if (!validate21(data.clusterProjectID, {
    ...
    if (data.serviceAccountRef !== undefined) {
      if (!validate45(data.serviceAccountRef, {
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.workloadIdentity !== undefined) {
      if (!validate41(data.workloadIdentity, {
...
function validate23(data, {
  ...
  /*# sourceURL="generators.external-secrets.io.v1alpha1.GCRAccessToken" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
