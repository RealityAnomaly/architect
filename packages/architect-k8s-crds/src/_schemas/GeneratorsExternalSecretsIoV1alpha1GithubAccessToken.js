...
const schema8 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "1LUHCvmaqEBnXlYRFWAQolOb2snEa4gxqpoJjDsRs"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "6OR9GhhzxBvHI262OFYopfIsvRbth9FsyyYMJMK0iY"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "generators.external-secrets.io.v1alpha1.GithubAccessToken"
};
const schema9 = {
  "type": "string",
...
const schema13 = {
  "properties": {
    ...
    "auth": {
      "$ref": "QYEcNnA8C6kglvzPL2t8CmV9jQmmEEAmxqsAp4gP0"
    },
    "installID": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
...
const schema14 = {
  "properties": {
    "privateKey": {
      "$ref": "cTar7LW4OqpE64ONscwADpcPuLp0dYvh7uWvGHrkfzg"
    }
  },
  "required": ["privateKey"],
  "type": "object"
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.appID !== undefined) {
      if (!validate22(data.appID, {
        instancePath: instancePath + "/appID",
        parentData: data,
        parentDataProperty: "appID",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.installID !== undefined) {
      if (!validate22(data.installID, {
        instancePath: instancePath + "/installID",
        parentData: data,
        parentDataProperty: "installID",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
    ...
    if (data.permissions !== undefined) {
      if (!validate44(data.permissions, {
    ...
    if (data.repositories !== undefined) {
      if (!validate47(data.repositories, {
        instancePath: instancePath + "/repositories",
        parentData: data,
        parentDataProperty: "repositories",
        rootData
      })) {
...
function validate23(data, {
  ...
  /*# sourceURL="generators.external-secrets.io.v1alpha1.GithubAccessToken" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
