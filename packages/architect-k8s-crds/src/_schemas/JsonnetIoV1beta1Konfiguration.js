...
const schema11 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "YX9WB28pugzyrgtEAeChHpEmJDGlrNdFqzmJypJxJY"
    },
    "kind": {
      "$ref": "UQlZSXM3SdrtvIlPO88dS0u5ul9vUgXSv1KeGeIhH8"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "8RXhpBi7B2wjXkGm7vDxiD3QG2HyVgXmdf005KALQ"
    },
    "status": {
      "$ref": "a54p5s80eZ030CmfJJwR20kd3LzoZPfJYhuIo2qip0"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "jsonnet.io.v1beta1.Konfiguration"
};
const schema12 = {
  "type": "string",
  "enum": ["jsonnet.io/v1beta1"]
};
...
const schema16 = {
  "properties": {
    ...
    "kubeConfig": {
      "$ref": "vx77cTaABVsrkcmCzi1fbEkd3eA87Xh2xblBvbTw"
    },
    "path": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
    ...
    "sourceRef": {
      "$ref": "yGEmwPsGIQ6ehHXSvHnIotHWeh75QzuatS7U8gCSpg"
    },
    "suspend": {
    ...
    "variables": {
      "$ref": "Fb3dR0zLsAOTZaaPzNhdjrPqdMyfvqwY1jX9Jg9I0c"
    }
  },
  "required": ["interval", "path", "prune"],
  "type": "object",
  "nullable": true
};
const schema17 = {
...
function validate79(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.extCode !== undefined) {
      if (!validate25(data.extCode, {
        instancePath: instancePath + "/extCode",
        parentData: data,
        parentDataProperty: "extCode",
        rootData
      })) {
    ...
    if (data.extStr !== undefined) {
      if (!validate25(data.extStr, {
        instancePath: instancePath + "/extStr",
        parentData: data,
        parentDataProperty: "extStr",
        rootData
      })) {
        vErrors = vErrors === null ? validate25.errors : vErrors.concat(validate25.errors);
        errors = vErrors.length;
    ...
    if (data.extVars !== undefined) {
      if (!validate27(data.extVars, {
        instancePath: instancePath + "/extVars",
        parentData: data,
        parentDataProperty: "extVars",
        rootData
      })) {
    ...
    if (data.tlaCode !== undefined) {
      if (!validate25(data.tlaCode, {
        instancePath: instancePath + "/tlaCode",
        parentData: data,
        parentDataProperty: "tlaCode",
        rootData
      })) {
        vErrors = vErrors === null ? validate25.errors : vErrors.concat(validate25.errors);
        errors = vErrors.length;
    ...
    if (data.tlaStr !== undefined) {
      if (!validate25(data.tlaStr, {
        instancePath: instancePath + "/tlaStr",
        parentData: data,
        parentDataProperty: "tlaStr",
        rootData
      })) {
        vErrors = vErrors === null ? validate25.errors : vErrors.concat(validate25.errors);
        errors = vErrors.length;
    ...
    if (data.tlaVars !== undefined) {
      if (!validate27(data.tlaVars, {
        instancePath: instancePath + "/tlaVars",
        parentData: data,
        parentDataProperty: "tlaVars",
        rootData
      })) {
        vErrors = vErrors === null ? validate27.errors : vErrors.concat(validate27.errors);
        errors = vErrors.length;
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.healthChecks !== undefined) {
      if (!validate46(data.healthChecks, {
    ...
    if (data.inject !== undefined) {
      if (!validate21(data.inject, {
        instancePath: instancePath + "/inject",
        parentData: data,
        parentDataProperty: "inject",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.jsonnetPaths !== undefined) {
      if (!validate23(data.jsonnetPaths, {
        instancePath: instancePath + "/jsonnetPaths",
        parentData: data,
        parentDataProperty: "jsonnetPaths",
        rootData
      })) {
    ...
    if (data.jsonnetURLs !== undefined) {
      if (!validate23(data.jsonnetURLs, {
        instancePath: instancePath + "/jsonnetURLs",
        parentData: data,
        parentDataProperty: "jsonnetURLs",
        rootData
      })) {
        vErrors = vErrors === null ? validate23.errors : vErrors.concat(validate23.errors);
        errors = vErrors.length;
...
function validate90(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate91(data.lastTransitionTime, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate95(data.observedGeneration, {
...
function validate88(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastAppliedRevision !== undefined) {
      if (!validate21(data.lastAppliedRevision, {
    ...
    if (data.lastAttemptedRevision !== undefined) {
      if (!validate21(data.lastAttemptedRevision, {
...
function validate28(data, {
  ...
  /*# sourceURL="jsonnet.io.v1beta1.Konfiguration" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
