...
const schema16 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "GnYKYMvj1ka507i7rVND5X53imgZxugJ2NKCnkdw"
    },
    "status": {
  ...
  "$id": "cert-manager.io.v1.Certificate"
};
const schema17 = {
  "type": "string",
...
const schema21 = {
  "properties": {
    ...
    "privateKey": {
      "$ref": "oP8akyg0YdfOct4ECP29LpAz7RnjNG65z72DWChI"
    },
    "renewBefore": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema24 = {
  "properties": {
    "algorithm": {
      "$ref": "dTuG5XL4XTMEktcnW5agZBh9YuJWyIB1tuNX1IIM"
    },
    "encoding": {
...
function validate64(data, {
  ...
  if (!(data === "RSA" || data === "ECDSA" || data === "Ed25519")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate46(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.emailAddresses !== undefined) {
      if (!validate22(data.emailAddresses, {
...
function validate37(data, {
  ...
  /*# sourceURL="cert-manager.io.v1.Certificate" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
