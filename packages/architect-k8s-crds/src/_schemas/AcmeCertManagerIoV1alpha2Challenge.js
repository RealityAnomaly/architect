...
const schema24 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "peb0kvLRKwWTfvcMlZC3gvoArLSqQWDoJLdkYJnq0"
    },
    "kind": {
  ...
  "$id": "acme.cert-manager.io.v1alpha2.Challenge"
};
const schema25 = {
  "type": "string",
  "enum": ["acme.cert-manager.io/v1alpha2"]
};
function validate66(data, {
  ...
  if (!(data === "acme.cert-manager.io/v1alpha2")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate65(data, {
  ...
  /*# sourceURL="acme.cert-manager.io.v1alpha2.Challenge" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.metadata === undefined) {
