...
const schema10 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "YBmRei8u92ZSIE1gPJvzen1lphr6Nfac6DujQKvt6k"
    },
    "kind": {
      "$ref": "PyY5q2Sjd6ONeQMoGGk641OHwOytTZkZCdbXSt4hwcU"
    },
    "metadata": {
      "$ref": "F8UXVl2B8ROl9kb045E2at1pE3IVL8xPdYnpnYIkb0"
    },
    "spec": {
      "$ref": "GjtTZoRlXCid7dxS0VHz8UcMrGluA9UGZ5KFB2HVrAk"
    },
    "status": {
      "$ref": "ybpK2au15JxeXz6RgBy6Vmx2uj2k479sCd1cKVyN8"
    }
  },
  "required": ["metadata", "spec", "apiVersion", "kind"],
  "$id": "acme.cert-manager.io.v1.Order"
};
const schema11 = {
  "type": "string",
  "enum": ["acme.cert-manager.io/v1"]
};
function validate27(data, {
  ...
  if (!(data === "acme.cert-manager.io/v1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema18 = {
  "properties": {
    "authorizations": {
      "$ref": "v52eSLRI4ZRjndwjMsBciJzuz3bJ39sQ9fOAfGkNHs"
    },
    "certificate": {
...
const schema19 = {
  "items": {
    "$ref": "saAFaUoFDjPOTBKMzIHHtxe8hXAOxYQFudAhRRfvU"
  },
  "type": "array",
  "nullable": true
};
const schema20 = {
  "properties": {
    "challenges": {
      "$ref": "GXI3Z8EiqM8E9CyiR5jlOjpct999TS86B4JqTVS4X0"
    },
    "identifier": {
      "$ref": "GlcYMJF0EagTzhTCQIbCB22J377Z87wRm00IC2Ss2g"
    },
...
const schema21 = {
  "items": {
    "$ref": "BQYs8JabGV25eZck3qDtsaV2csjOImdeV9pV47GXdo"
  },
  "type": "array",
  "nullable": true
};
...
function validate50(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.challenges !== undefined) {
      if (!validate51(data.challenges, {
        instancePath: instancePath + "/challenges",
        parentData: data,
        parentDataProperty: "challenges",
        rootData
      })) {
    ...
    if (data.initialState !== undefined) {
      if (!validate25(data.initialState, {
...
function validate48(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.authorizations !== undefined) {
      if (!validate49(data.authorizations, {
        instancePath: instancePath + "/authorizations",
        parentData: data,
        parentDataProperty: "authorizations",
        rootData
      })) {
    ...
    if (data.certificate !== undefined) {
      if (!validate65(data.certificate, {
    ...
    if (data.failureTime !== undefined) {
      if (!validate67(data.failureTime, {
    ...
    if (data.finalizeURL !== undefined) {
      if (!validate21(data.finalizeURL, {
        instancePath: instancePath + "/finalizeURL",
        parentData: data,
        parentDataProperty: "finalizeURL",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate26(data, {
  ...
  /*# sourceURL="acme.cert-manager.io.v1.Order" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
