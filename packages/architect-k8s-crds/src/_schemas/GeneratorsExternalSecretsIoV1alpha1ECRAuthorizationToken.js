...
const schema9 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "LWGFoUiAsuncJMekGzoAqpwxVfBa4TqC9cLAwidhfA"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "AF1lcfHZsbR3A6M2rRzruQZt3VovlICbsxdt7PBH0Y"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "generators.external-secrets.io.v1alpha1.ECRAuthorizationToken"
};
const schema10 = {
  "type": "string",
...
function validate27(data, {
  ...
  /*# sourceURL="generators.external-secrets.io.v1alpha1.ECRAuthorizationToken" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
