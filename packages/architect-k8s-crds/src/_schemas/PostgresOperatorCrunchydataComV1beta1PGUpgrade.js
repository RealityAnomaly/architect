...
export const validate = validate63;
const schema25 = {
  "type": "object",
  "properties": {
    "apiVersion": {
    ...
    "kind": {
      "$ref": "m9zSEDag1xN9iNtFF5VTX43Jln3f2OjQScS6zEWZRpE"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "DnvhUyOvvjMOcmBHkiAFxNbrAalDLnyYwc0y4Lbl8"
    },
    "status": {
      "$ref": "OGEU8fQ7j4pMAakRji2EZetHkT2NHHxqgcCOK7BZM9Y"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "postgres-operator.crunchydata.com.v1beta1.PGUpgrade"
};
const schema26 = {
  "type": "string",
...
const schema29 = {};
import { validate as validate69 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema30 = {
  ...
  "required": ["fromPostgresVersion", "postgresClusterName", "toPostgresVersion"],
  "type": "object",
  "nullable": true
};
const schema31 = {
...
function validate81(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.nodeSelectorTerms !== undefined) {
      if (!validate82(data.nodeSelectorTerms, {
...
function validate74(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.preferredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate75(data.preferredDuringSchedulingIgnoredDuringExecution, {
    ...
    if (data.requiredDuringSchedulingIgnoredDuringExecution !== undefined) {
      if (!validate81(data.requiredDuringSchedulingIgnoredDuringExecution, {
...
function validate73(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.nodeAffinity !== undefined) {
      if (!validate74(data.nodeAffinity, {
...
function validate113(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.tolerationSeconds !== undefined) {
      if (!validate117(data.tolerationSeconds, {
...
function validate72(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.fromPostgresVersion === undefined) {
      const err1 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "fromPostgresVersion"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.postgresClusterName === undefined) {
      const err2 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "postgresClusterName"
        }
      };
      if (vErrors === null) {
        vErrors = [err2];
    ...
    if (data.toPostgresVersion === undefined) {
      const err3 = {
        instancePath,
        schemaPath: "#/required",
        keyword: "required",
        params: {
          missingProperty: "toPostgresVersion"
        }
      };
      if (vErrors === null) {
        vErrors = [err3];
    ...
    if (data.fromPostgresVersion !== undefined) {
      if (!validate61(data.fromPostgresVersion, {
        instancePath: instancePath + "/fromPostgresVersion",
        parentData: data,
        parentDataProperty: "fromPostgresVersion",
        rootData
      })) {
    ...
    if (data.imagePullPolicy !== undefined) {
      if (!validate92(data.imagePullPolicy, {
    ...
    if (data.imagePullSecrets !== undefined) {
      if (!validate94(data.imagePullSecrets, {
    ...
    if (data.postgresClusterName !== undefined) {
      if (!validate103(data.postgresClusterName, {
        instancePath: instancePath + "/postgresClusterName",
        parentData: data,
        parentDataProperty: "postgresClusterName",
        rootData
      })) {
    ...
    if (data.toPostgresImage !== undefined) {
      if (!validate54(data.toPostgresImage, {
        instancePath: instancePath + "/toPostgresImage",
        parentData: data,
        parentDataProperty: "toPostgresImage",
        rootData
      })) {
        vErrors = vErrors === null ? validate54.errors : vErrors.concat(validate54.errors);
        errors = vErrors.length;
    ...
    if (data.toPostgresVersion !== undefined) {
      if (!validate61(data.toPostgresVersion, {
        instancePath: instancePath + "/toPostgresVersion",
        parentData: data,
        parentDataProperty: "toPostgresVersion",
        rootData
      })) {
        vErrors = vErrors === null ? validate61.errors : vErrors.concat(validate61.errors);
        errors = vErrors.length;
    ...
    if (data.tolerations !== undefined) {
      if (!validate112(data.tolerations, {
...
function validate125(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate126(data.lastTransitionTime, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate62(data.observedGeneration, {
...
function validate123(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.conditions !== undefined) {
      if (!validate124(data.conditions, {
...
function validate63(data, {
  ...
  /*# sourceURL="postgres-operator.crunchydata.com.v1beta1.PGUpgrade" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
