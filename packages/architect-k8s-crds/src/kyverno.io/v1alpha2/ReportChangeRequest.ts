...
import { validate } from "../../_schemas/KyvernoIoV1alpha2ReportChangeRequest.js";
...
setValidateFunc(ReportChangeRequest, validate as ValidateFunc<IReportChangeRequest>);
