...
const schemaId = "snapshot.storage.k8s.io.v1.VolumeSnapshotContent";
const schema = {
  "type": "object",
  "properties": {
    "apiVersion": {
...
static apiVersion: IVolumeSnapshotContent["apiVersion"] = "snapshot.storage.k8s.io/v1";
...
setSchema(VolumeSnapshotContent, schemaId, () => {
  addSchema();
