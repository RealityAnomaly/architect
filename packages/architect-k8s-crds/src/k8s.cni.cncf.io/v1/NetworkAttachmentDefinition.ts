...
import { validate } from "../../_schemas/K8sCniCncfIoV1NetworkAttachmentDefinition.js";
...
setValidateFunc(NetworkAttachmentDefinition, validate as ValidateFunc<INetworkAttachmentDefinition>);
