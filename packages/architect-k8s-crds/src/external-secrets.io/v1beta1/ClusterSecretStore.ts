...
import { validate } from "../../_schemas/ExternalSecretsIoV1beta1ClusterSecretStore.js";
 ...
 * ClusterSecretStore represents a secure external location for storing secrets, which can be referenced as part of `storeRef` fields.
 */
export class ClusterSecretStore extends Model<IClusterSecretStore> implements IClusterSecretStore {
  "apiVersion": IClusterSecretStore["apiVersion"];
  "kind": IClusterSecretStore["kind"];
  "metadata"?: IClusterSecretStore["metadata"];
  "spec"?: IClusterSecretStore["spec"];
  "status"?: IClusterSecretStore["status"];

static apiVersion: IClusterSecretStore["apiVersion"] = "external-secrets.io/v1beta1";
static kind: IClusterSecretStore["kind"] = "ClusterSecretStore";
static is = createTypeMetaGuard<IClusterSecretStore>(ClusterSecretStore);

constructor(data?: ModelData<IClusterSecretStore>) {
  super({
    apiVersion: ClusterSecretStore.apiVersion,
    kind: ClusterSecretStore.kind,
    ...data
  } as IClusterSecretStore);
}
}
