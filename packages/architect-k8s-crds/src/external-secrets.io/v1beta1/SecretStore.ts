...
import { validate } from "../../_schemas/ExternalSecretsIoV1beta1SecretStore.js";
...
static apiVersion: ISecretStore["apiVersion"] = "external-secrets.io/v1beta1";
...
setValidateFunc(SecretStore, validate as ValidateFunc<ISecretStore>);
