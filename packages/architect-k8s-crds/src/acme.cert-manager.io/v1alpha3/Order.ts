...
import { validate } from "../../_schemas/AcmeCertManagerIoV1alpha3Order.js";
...
static apiVersion: IOrder["apiVersion"] = "acme.cert-manager.io/v1alpha3";
...
setValidateFunc(Order, validate as ValidateFunc<IOrder>);
