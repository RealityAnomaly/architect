...
const schemaId = "cert-manager.io.v1alpha2.ClusterIssuer";
const schema = {
  "type": "object",
  "properties": {
    "apiVersion": {
...
static apiVersion: IClusterIssuer["apiVersion"] = "cert-manager.io/v1alpha2";
...
setSchema(ClusterIssuer, schemaId, () => {
  addSchema();
