...
const schema10 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "Z1Nml3MIAv1aQvUNnzbqdrnilGKWtiiuHEJAXlUJAn8"
    },
    "status": {
      "$ref": "qADSJFiShT8i34WSjOiPXHWW3Mmo2taLrugZRWo6r8"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "image.toolkit.fluxcd.io.v1beta2.ImageUpdateAutomation"
};
const schema11 = {
  "type": "string",
...
function validate66(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchExpressions !== undefined) {
      if (!validate67(data.matchExpressions, {
...
function validate35(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.policySelector !== undefined) {
      if (!validate66(data.policySelector, {
        instancePath: instancePath + "/policySelector",
        parentData: data,
        parentDataProperty: "policySelector",
        rootData
      })) {
...
const schema34 = {
  ...
  "properties": {
    ...
    "observedPolicies": {
      "$ref": "830TlUMYYeFCLLr0vb3u4MfYRVOn1f2qCMuKau1RBwQ"
    },
...
function validate95(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate96(data.lastTransitionTime, {
...
const schema44 = {
  "additionalProperties": {
    "$ref": "sH8z9RGZvLjaejLHvcJaJqlTg5TTEYRG0fcLL1zhm8"
  },
  "type": "object",
  "properties": {},
  "nullable": true
...
function validate93(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastAutomationRunTime !== undefined) {
      if (!validate25(data.lastAutomationRunTime, {
    ...
    if (data.lastPushTime !== undefined) {
      if (!validate25(data.lastPushTime, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate114(data.observedGeneration, {
        instancePath: instancePath + "/observedGeneration",
        parentData: data,
        parentDataProperty: "observedGeneration",
        rootData
    ...
    if (data.observedPolicies !== undefined) {
      if (!validate116(data.observedPolicies, {
        instancePath: instancePath + "/observedPolicies",
        parentData: data,
        parentDataProperty: "observedPolicies",
        rootData
      })) {
    ...
    if (data.observedSourceRevision !== undefined) {
      if (!validate21(data.observedSourceRevision, {
        instancePath: instancePath + "/observedSourceRevision",
        parentData: data,
        parentDataProperty: "observedSourceRevision",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate26(data, {
  ...
  /*# sourceURL="image.toolkit.fluxcd.io.v1beta2.ImageUpdateAutomation" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
