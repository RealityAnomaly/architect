...
const schema10 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "56gpZAeP5NqRkkGnQQ7bpRVPicX0EmgbFn8m3YhV5is"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "qAy0TvhvUk6eN1Mddn0LsaaDlMmX8KqaqgINLzYkx0"
    },
    "status": {
      "$ref": "ZElzztahyWkpIXxv8JzxAl3fXFd1EYJVxZKaW0uZaxE"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "image.toolkit.fluxcd.io.v1beta2.ImagePolicy"
};
const schema11 = {
  "type": "string",
...
const schema14 = {};
import { validate as validate32 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta.js.js";
...
const schema15 = {
  "properties": {
    "filterTags": {
      "$ref": "I5UwR8WbcJ90sIhQf0BPu9WmuiflbXQBKvSijDQE2pE"
    },
    "imageRepositoryRef": {
      "$ref": "djR0IiKxj20fIodNTVmExT7zNueAT3cy9fuVEwNlhI"
    },
    "policy": {
      "$ref": "P2S1fuIh60PVbs3SY49pGtYvGQqQx8DqALvR4QlOk"
    }
  },
...
const schema18 = {
  "properties": {
    "alphabetical": {
      "$ref": "FyJrG7Wo05Mt5IJr3qWIUhQPauBdog6KGwuD3TqZJIg"
    },
    "numerical": {
      "$ref": "FyJrG7Wo05Mt5IJr3qWIUhQPauBdog6KGwuD3TqZJIg"
    },
    "semver": {
      "$ref": "83reGa7fjqC45hFQ72TIbRfLbWTrQTszIN6t1gq88"
    }
  },
  "type": "object"
};
const schema7 = {
  "properties": {
    "order": {
      "$ref": "oleuNXqB4HSaYXV7q9R1ZgRWIvvoHODsGrsuhoF0D8I"
    }
  },
  "type": "object",
  "nullable": true
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.range !== undefined) {
      if (!validate25(data.range, {
        instancePath: instancePath + "/range",
        parentData: data,
        parentDataProperty: "range",
        rootData
      })) {
        vErrors = vErrors === null ? validate25.errors : vErrors.concat(validate25.errors);
        errors = vErrors.length;
...
function validate44(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.alphabetical !== undefined) {
      if (!validate22(data.alphabetical, {
        instancePath: instancePath + "/alphabetical",
        parentData: data,
        parentDataProperty: "alphabetical",
        rootData
      })) {
    ...
    if (data.numerical !== undefined) {
      if (!validate22(data.numerical, {
        instancePath: instancePath + "/numerical",
        parentData: data,
        parentDataProperty: "numerical",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.imageRepositoryRef === undefined) {
      const err1 = {
        ...
        keyword: "required",
        params: {
          missingProperty: "imageRepositoryRef"
        }
      };
      if (vErrors === null) {
        vErrors = [err1];
    ...
    if (data.filterTags !== undefined) {
      if (!validate36(data.filterTags, {
        instancePath: instancePath + "/filterTags",
        parentData: data,
        parentDataProperty: "filterTags",
        rootData
      })) {
    ...
    if (data.imageRepositoryRef !== undefined) {
      if (!validate40(data.imageRepositoryRef, {
        instancePath: instancePath + "/imageRepositoryRef",
        parentData: data,
        parentDataProperty: "imageRepositoryRef",
        rootData
      })) {
...
function validate52(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.latestImage !== undefined) {
      if (!validate21(data.latestImage, {
        instancePath: instancePath + "/latestImage",
        parentData: data,
        parentDataProperty: "latestImage",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
    ...
    if (data.observedPreviousImage !== undefined) {
      if (!validate21(data.observedPreviousImage, {
        instancePath: instancePath + "/observedPreviousImage",
        parentData: data,
        parentDataProperty: "observedPreviousImage",
        rootData
      })) {
        vErrors = vErrors === null ? validate21.errors : vErrors.concat(validate21.errors);
        errors = vErrors.length;
...
function validate26(data, {
  ...
  /*# sourceURL="image.toolkit.fluxcd.io.v1beta2.ImagePolicy" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
