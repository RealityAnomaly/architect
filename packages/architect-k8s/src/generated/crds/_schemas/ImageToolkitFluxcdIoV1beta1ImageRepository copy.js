...
const schema9 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "lLigUIrRXEFsPjTGsd7uMZBApEHvpH7gtu3ja2RF4"
    },
    "status": {
      "$ref": "UABbyP5WsyNRKG1QZrQdBDuuiSe6WkfuMWSgVKNNfM"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "image.toolkit.fluxcd.io.v1beta1.ImageRepository"
};
const schema10 = {
  "type": "string",
...
const schema13 = {};
import { validate as validate31 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta.js.js";
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.exclusionList !== undefined) {
      if (!validate45(data.exclusionList, {
    ...
    if (data.serviceAccountName !== undefined) {
      if (!validate52(data.serviceAccountName, {
...
const schema24 = {
  ...
  "properties": {
    ...
    "lastScanResult": {
      "$ref": "sBeU3NgckqLbC2niBvsOtfGKf5yRpGZ9GLwamV3WY4Q"
    },
    "observedGeneration": {
...
function validate62(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate67(data.observedGeneration, {
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.canonicalImageName !== undefined) {
      if (!validate24(data.canonicalImageName, {
    ...
    if (data.lastScanResult !== undefined) {
      if (!validate78(data.lastScanResult, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate84(data.observedGeneration, {
        instancePath: instancePath + "/observedGeneration",
        parentData: data,
        parentDataProperty: "observedGeneration",
        rootData
...
function validate25(data, {
  ...
  /*# sourceURL="image.toolkit.fluxcd.io.v1beta1.ImageRepository" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
