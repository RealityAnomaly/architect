...
const schema11 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "94qChO0xSXl8kVVkK0Y5DzhqPgudvJ6X3ALajGYkFo"
    },
    "status": {
      "$ref": "TnCQgIS8XdB4keie8KHtpOnYeou2o1wtjnMZUCvD6o"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "source.toolkit.fluxcd.io.v1beta1.GitRepository"
};
const schema12 = {
  "type": "string",
...
const schema16 = {
  "properties": {
    ...
    "ref": {
      "$ref": "jfbeAtt5reqlLEASB23UHpHxcbrOYeluIIxyYbPk"
    },
    "secretRef": {
    ...
    "verify": {
      "$ref": "6Wzq4wXQafm93yyhK3W1ML4QmiVVtpBVcOiqPfF2JT0"
    }
  },
...
function validate39(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchLabels !== undefined) {
      if (!validate40(data.matchLabels, {
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.namespaceSelectors !== undefined) {
      if (!validate38(data.namespaceSelectors, {
...
const pattern0 = new RegExp("^(http|https|ssh)://.*$", "u");
...
function validate36(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.gitImplementation !== undefined) {
      if (!validate46(data.gitImplementation, {
...
const schema30 = {
  ...
  "properties": {
    ...
    "includedArtifacts": {
      "$ref": "XKvxkIn8MMZWK3BW2Wx6Y0NGfZHnbZfEKl1NHq0fQk"
    },
...
const schema39 = {
  "items": {
    "$ref": "OfA8nlLZJMGAGTgppaTWDDd7HSROwKaRFK0SC6jvdU"
  },
  "type": "array",
  "nullable": true
};
...
function validate78(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate111(data.observedGeneration, {
        instancePath: instancePath + "/observedGeneration",
        parentData: data,
        parentDataProperty: "observedGeneration",
        rootData
...
function validate27(data, {
  ...
  /*# sourceURL="source.toolkit.fluxcd.io.v1beta1.GitRepository" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
