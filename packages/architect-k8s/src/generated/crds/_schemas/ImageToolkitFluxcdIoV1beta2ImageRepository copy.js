...
const schema11 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "sfUjDFX2kP7zyHOm37k2M4gCUEHHl9q1KRVjrdOc48"
    },
    "kind": {
      "$ref": "LDoHIeZmyZUEfAkLFa4dGIy0wWyAoxGiDkNeHCxeg"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "BT4os9UUUcjpV0DyEYffqxvRdRW5hntfDtslQfOe58"
    },
    "status": {
      "$ref": "JVCCFfeCqcwxovrcsCafamgGnMIDD02eYI2Xl2AoM"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "image.toolkit.fluxcd.io.v1beta2.ImageRepository"
};
const schema12 = {
  "type": "string",
  "enum": ["image.toolkit.fluxcd.io/v1beta2"]
};
function validate29(data, {
  ...
  if (!(data === "image.toolkit.fluxcd.io/v1beta2")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema15 = {};
import { validate as validate34 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta.js.js";
...
const schema16 = {
  "properties": {
    ...
    "exclusionList": {
      "$ref": "GJis5Fu0qTKk3XXYQkfPBlLpLnUcrKlhHMOcKprxDYU"
    },
    "image": {
    ...
    "serviceAccountName": {
      "$ref": "BaupFy3GvTRiKYHKliFKTaQW00q04zDjMXZdAzxeuQ"
    },
    "suspend": {
      "$ref": "hsGPmGwy4VrrbOBJwiGgjUKGPtMFeHO5cmtUu5ZUh0"
    },
...
function validate37(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.exclusionList !== undefined) {
      if (!validate48(data.exclusionList, {
        instancePath: instancePath + "/exclusionList",
        parentData: data,
        parentDataProperty: "exclusionList",
        rootData
      })) {
    ...
    if (data.serviceAccountName !== undefined) {
      if (!validate59(data.serviceAccountName, {
...
const schema26 = {
  ...
  "properties": {
    ...
    "lastScanResult": {
      "$ref": "44R6vBFPR6bZ5krTfWliBPsSrcA8cKxKTM5ORdYJNLc"
    },
...
function validate68(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate69(data.lastTransitionTime, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate73(data.observedGeneration, {
...
function validate84(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.latestTags !== undefined) {
      if (!validate26(data.latestTags, {
        instancePath: instancePath + "/latestTags",
        parentData: data,
        parentDataProperty: "latestTags",
        rootData
      })) {
    ...
    if (data.scanTime !== undefined) {
      if (!validate86(data.scanTime, {
        instancePath: instancePath + "/scanTime",
        parentData: data,
        parentDataProperty: "scanTime",
        rootData
      })) {
    ...
    if (data.tagCount !== undefined) {
      if (!validate88(data.tagCount, {
        instancePath: instancePath + "/tagCount",
        parentData: data,
        parentDataProperty: "tagCount",
        rootData
      })) {
...
function validate65(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.canonicalImageName !== undefined) {
      if (!validate25(data.canonicalImageName, {
        instancePath: instancePath + "/canonicalImageName",
        parentData: data,
        parentDataProperty: "canonicalImageName",
        rootData
      })) {
    ...
    if (data.lastHandledReconcileAt !== undefined) {
      if (!validate25(data.lastHandledReconcileAt, {
    ...
    if (data.lastScanResult !== undefined) {
      if (!validate84(data.lastScanResult, {
        instancePath: instancePath + "/lastScanResult",
        parentData: data,
        parentDataProperty: "lastScanResult",
        rootData
      })) {
    ...
    if (data.observedExclusionList !== undefined) {
      if (!validate26(data.observedExclusionList, {
        instancePath: instancePath + "/observedExclusionList",
        parentData: data,
        parentDataProperty: "observedExclusionList",
        rootData
      })) {
        vErrors = vErrors === null ? validate26.errors : vErrors.concat(validate26.errors);
        errors = vErrors.length;
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate92(data.observedGeneration, {
        instancePath: instancePath + "/observedGeneration",
        parentData: data,
        parentDataProperty: "observedGeneration",
        rootData
...
function validate28(data, {
  ...
  /*# sourceURL="image.toolkit.fluxcd.io.v1beta2.ImageRepository" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
