...
const schema8 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "Ma9xBuHwsb7i66aNOJnotG5bMfnduyHatOKbutQA4"
    },
    "status": {
      "$ref": "M8KKhKXYwskd5mk3XpEDPOBdVi1MTS9mTOURGIiF1c"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "notification.toolkit.fluxcd.io.v1beta2.Receiver"
};
const schema9 = {
  "type": "string",
...
function validate23(data, {
  ...
  /*# sourceURL="notification.toolkit.fluxcd.io.v1beta2.Receiver" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
