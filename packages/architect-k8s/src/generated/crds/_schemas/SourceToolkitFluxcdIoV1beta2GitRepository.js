...
const schema16 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "EC6SU6K7OJ2aITldcNslXJrmpmYnJeHLjdFiNdy9oA"
    },
    "status": {
      "$ref": "BeBsPTzI5QkaXDlhIcAIEcX1JG7LybaH7tPAbtagfc"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "source.toolkit.fluxcd.io.v1beta2.GitRepository"
};
const schema17 = {
  "type": "string",
...
const schema20 = {};
import { validate as validate43 } from "npm:@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta";
...
const schema21 = {
  "properties": {
    ...
    "gitImplementation": {
      "$ref": "LJX73xLmtHCVy3DoOkmldHiri1yl5EBSz5ZZYCTl6k"
    },
    "ignore": {
    ...
    "verify": {
      "$ref": "1EvQSsPeBug6iDSpMGYnCV8IOaPs6pJMeTJST0hA"
    }
  },
...
function validate49(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchLabels !== undefined) {
      if (!validate26(data.matchLabels, {
...
function validate47(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.namespaceSelectors !== undefined) {
      if (!validate48(data.namespaceSelectors, {
...
const schema31 = {
  "properties": {
    "mode": {
      "$ref": "ZtKljfPqosTHGhsBXqqiw9SpwG9P6LOUayIGAWylnOA"
    },
    "secretRef": {
      "$ref": "HN5PKMIdyNeW2tH5k7qzNtrzheocymAho1Vd1ZpPn9c"
    }
...
function validate46(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.gitImplementation !== undefined) {
      if (!validate54(data.gitImplementation, {
        instancePath: instancePath + "/gitImplementation",
        parentData: data,
        parentDataProperty: "gitImplementation",
        rootData
      })) {
    ...
    if (data.recurseSubmodules !== undefined) {
      if (!validate23(data.recurseSubmodules, {
...
function validate93(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate97(data.observedGeneration, {
...
function validate82(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.includedArtifacts !== undefined) {
      if (!validate108(data.includedArtifacts, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate30(data.observedGeneration, {
        instancePath: instancePath + "/observedGeneration",
        parentData: data,
        parentDataProperty: "observedGeneration",
        rootData
    ...
    if (data.observedInclude !== undefined) {
      if (!validate31(data.observedInclude, {
    ...
    if (data.observedRecurseSubmodules !== undefined) {
      if (!validate23(data.observedRecurseSubmodules, {
...
function validate37(data, {
  ...
  /*# sourceURL="source.toolkit.fluxcd.io.v1beta2.GitRepository" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
