...
const schema9 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "eSHxxOsNqP59k8TbtoVZGTdxvPq4QXPLOc0QJj5C6A"
    },
    "status": {
  ...
  "$id": "source.toolkit.fluxcd.io.v1beta1.HelmChart"
};
const schema10 = {
  "type": "string",
...
function validate34(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.namespaceSelectors !== undefined) {
      if (!validate35(data.namespaceSelectors, {
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.reconcileStrategy !== undefined) {
      if (!validate45(data.reconcileStrategy, {
    ...
    if (data.valuesFiles !== undefined) {
      if (!validate56(data.valuesFiles, {
...
function validate24(data, {
  ...
  /*# sourceURL="source.toolkit.fluxcd.io.v1beta1.HelmChart" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
