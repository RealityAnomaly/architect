...
const schema10 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "we7e3dkqjjUWX5RRUo6667BesjzPjVWj6dJcHw7mdl4"
    },
    "status": {
  ...
  "$id": "source.toolkit.fluxcd.io.v1beta1.HelmRepository"
};
const schema11 = {
  "type": "string",
...
function validate25(data, {
  ...
  /*# sourceURL="source.toolkit.fluxcd.io.v1beta1.HelmRepository" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
