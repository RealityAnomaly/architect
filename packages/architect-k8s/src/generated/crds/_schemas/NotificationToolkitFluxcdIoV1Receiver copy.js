...
const schema8 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "ZrcAuq5y18Fml6TTTbnxl41Rw1E8nscRx5q3Wz8TM"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "kixogmTgBne3D5M5bNa5YuwYiVA74rhSspBxjpHca0"
    },
    "status": {
      "$ref": "Wzhcd5mQp4GfSUL0aslGeHuF9z4vWKLSJIBoVupGmA"
    }
  },
...
const schema12 = {};
import { validate as validate29 } from "@kubernetes-models/apimachinery/_schemas/IoK8sApimachineryPkgApisMetaV1ObjectMeta.js.js";
...
const schema13 = {
  "properties": {
    ...
    "interval": {
      "$ref": "wjhDvGhTJicyUNgZByWEQfDhxuChSKsybfFyVZJUE"
    },
    "resources": {
    ...
    "type": {
      "$ref": "UjNwbWcaokOcweXXYqqXQHyYIsxviRhG1yAyDlE"
    }
  },
...
function validate57(data, {
  ...
  if (!(data === "generic" || data === "generic-hmac" || data === "github" || data === "gitlab" || data === "bitbucket" || data === "harbor" || data === "dockerhub" || data === "quay" || data === "gcr" || data === "nexus" || data === "acr" || data === "cdevents")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate60(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.webhookPath !== undefined) {
      if (!validate22(data.webhookPath, {
        instancePath: instancePath + "/webhookPath",
        parentData: data,
        parentDataProperty: "webhookPath",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
