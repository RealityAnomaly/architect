...
const schema13 = {
  ...
  "properties": {
    ...
    "kind": {
      "$ref": "JPeegELQmXNtCrFSACiVO0m0IgxoWq4mRV3IMm0A"
    },
    "metadata": {
      "$ref": "a6f0oUEaFqHmymdwnqPORTNOTU7GczWAkwGD0uYU"
    },
    "spec": {
      "$ref": "wrtMsUFeaz0FDFeWbGAOMHje1Q76jja5tDpu0OXBzM"
    },
    "status": {
      "$ref": "f5dtDNWiRKqrjYZXe1v6ztQezWhzLfXsWT6R0nCgoQ"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "source.toolkit.fluxcd.io.v1beta2.HelmRepository"
};
const schema14 = {
  "type": "string",
...
const schema18 = {
  "properties": {
    ...
    "type": {
      "$ref": "HFKBTBfRsMESsKTw2OVQGpdrUYDobRKuAzBEjywniUI"
    },
    "url": {
      "$ref": "0ADwS1JH5ZesaTzM1fGhY9805Yh5cbS0KuqG1o190"
    }
  },
  "required": ["url"],
  "type": "object",
...
function validate42(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.matchLabels !== undefined) {
      if (!validate25(data.matchLabels, {
...
function validate39(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.passCredentials !== undefined) {
      if (!validate22(data.passCredentials, {
        instancePath: instancePath + "/passCredentials",
        parentData: data,
        parentDataProperty: "passCredentials",
        rootData
      })) {
        vErrors = vErrors === null ? validate22.errors : vErrors.concat(validate22.errors);
        errors = vErrors.length;
...
function validate64(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastUpdateTime !== undefined) {
      if (!validate27(data.lastUpdateTime, {
...
function validate75(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate79(data.observedGeneration, {
...
function validate63(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastHandledReconcileAt !== undefined) {
      if (!validate29(data.lastHandledReconcileAt, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate28(data.observedGeneration, {
        instancePath: instancePath + "/observedGeneration",
        parentData: data,
        parentDataProperty: "observedGeneration",
        rootData
...
function validate30(data, {
  ...
  /*# sourceURL="source.toolkit.fluxcd.io.v1beta2.HelmRepository" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
