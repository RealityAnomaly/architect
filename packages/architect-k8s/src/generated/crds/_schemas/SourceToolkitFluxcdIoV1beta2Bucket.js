...
const schema13 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "B4Y9Ml0FqdQx5Xqh4MzTTarNyKKf067ocAsgORSaaH0"
    },
    "status": {
...
const schema18 = {
  "properties": {
    ...
    "sts": {
      "$ref": "QAKsYEDRWe3u1FxwEBOqw9ans02Eiw0uWFQCiZG0I"
    },
    "suspend": {
      "$ref": "hsGPmGwy4VrrbOBJwiGgjUKGPtMFeHO5cmtUu5ZUh0"
    },
...
const schema24 = {
  "properties": {
    ...
    "endpoint": {
      "$ref": "fAGof3dYprg29CTZ6NtUfO3T4qmnSvlbxASU7DSa0"
    },
    "provider": {
      "$ref": "eVkV261aMckU30QW08DaI3hff8lkxbxHXTW158"
    },
    "secretRef": {
      "$ref": "OAgQGC3YN1FICnXF5ReeaD1QWt6Riug0pHBXOEYs"
    }
...
function validate39(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.sts !== undefined) {
      if (!validate60(data.sts, {
        instancePath: instancePath + "/sts",
        parentData: data,
        parentDataProperty: "sts",
        rootData
      })) {
...
function validate72(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate29(data.observedGeneration, {
        instancePath: instancePath + "/observedGeneration",
        parentData: data,
        parentDataProperty: "observedGeneration",
        rootData
