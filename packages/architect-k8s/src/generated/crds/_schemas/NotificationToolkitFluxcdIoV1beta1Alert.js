...
const schema8 = {
  ...
  "properties": {
    ...
    "spec": {
      "$ref": "7BCUMCJIQteZXRTV3dcTAm9HA3KROSLH2vTEY3LEj0"
    },
    "status": {
  ...
  "$id": "notification.toolkit.fluxcd.io.v1beta1.Alert"
};
const schema9 = {
  "type": "string",
...
function validate32(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.eventSeverity !== undefined) {
      if (!validate33(data.eventSeverity, {
    ...
    if (data.eventSources !== undefined) {
      if (!validate35(data.eventSources, {
    ...
    if (data.exclusionList !== undefined) {
      if (!validate49(data.exclusionList, {
    ...
    if (data.providerRef !== undefined) {
      if (!validate52(data.providerRef, {
...
function validate61(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate62(data.lastTransitionTime, {
...
function validate59(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate76(data.observedGeneration, {
        instancePath: instancePath + "/observedGeneration",
        parentData: data,
        parentDataProperty: "observedGeneration",
        rootData
...
function validate23(data, {
  ...
  /*# sourceURL="notification.toolkit.fluxcd.io.v1beta1.Alert" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
