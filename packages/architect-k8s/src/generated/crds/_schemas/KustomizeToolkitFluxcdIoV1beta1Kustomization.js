...
const schema9 = {
  ...
  "properties": {
    "apiVersion": {
      "$ref": "yl5cIAgFAO2XnX6CnlgXKxIQgonehDT9vwfjiYJRnPk"
    },
    "kind": {
    ...
    "spec": {
      "$ref": "ZKIMygGjcQ2h2hZ4oAX6zDzFxEEySjEB6FL5TRaOyxY"
    },
    "status": {
      "$ref": "AWPLhhsm8nHHPxYOmIC8awuMiXaOAJzdblo7T50fE"
    }
  },
  "required": ["apiVersion", "kind"],
  "$id": "kustomize.toolkit.fluxcd.io.v1beta1.Kustomization"
};
const schema10 = {
  "type": "string",
  "enum": ["kustomize.toolkit.fluxcd.io/v1beta1"]
};
function validate25(data, {
  ...
  if (!(data === "kustomize.toolkit.fluxcd.io/v1beta1")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
const schema14 = {
  "properties": {
    ...
    "postBuild": {
      "$ref": "LaTaAmyue5TSsyES58bq92gu1QYP9YfiMuEgfSCY"
    },
    "prune": {
    ...
    "sourceRef": {
      "$ref": "nwlPthN79qgt87RpkmQwi4fBcm0AxluhjBP9TcxoiE"
    },
    "suspend": {
...
function validate74(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.annotationSelector !== undefined) {
      if (!validate22(data.annotationSelector, {
...
const schema37 = {
  "properties": {
    ...
    "substituteFrom": {
      "$ref": "Y1dPTX1CEhJm2r0pLcJ537kgpIXMZ7i2l4K4Z3Dk8"
    }
  },
  "type": "object",
  "nullable": true
...
const schema39 = {
  "items": {
    "$ref": "x7qwE2Wl2O2xKx6COCGtBGtP3fjpzzcuabXtJ6MFZs"
  },
  "type": "array",
  "nullable": true
};
...
function validate111(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.substitute !== undefined) {
      if (!validate112(data.substitute, {
    ...
    if (data.substituteFrom !== undefined) {
      if (!validate115(data.substituteFrom, {
...
const schema44 = {
  "properties": {
    ...
    "kind": {
      "$ref": "U4uHHCogkMNHmneJnNwi21IJV33d6w7098PkftHBTw"
    },
    "name": {
      "$ref": "jdFtv6DGtroqVatkuk8ipQtGFLMzfSuVek97sB0uauQ"
    },
...
function validate130(data, {
  ...
  if (!(data === "GitRepository" || data === "Bucket")) {
    const err1 = {
      instancePath,
      schemaPath: "#/enum",
      keyword: "enum",
...
function validate33(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.healthChecks !== undefined) {
      if (!validate49(data.healthChecks, {
    ...
    if (data.patchesJson6902 !== undefined) {
      if (!validate85(data.patchesJson6902, {
    ...
    if (data.patchesStrategicMerge !== undefined) {
      if (!validate107(data.patchesStrategicMerge, {
    ...
    if (data.targetNamespace !== undefined) {
      if (!validate137(data.targetNamespace, {
    ...
    if (data.validation !== undefined) {
      if (!validate140(data.validation, {
...
const schema49 = {
  ...
  "properties": {
    ...
    "snapshot": {
      "$ref": "F6pqnQXZ2S1qbmbzqVmkvsQEIfD3WOaWg0K7DQlTYI"
    }
  },
  "type": "object",
  "nullable": true
...
function validate145(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    ...
    if (data.lastTransitionTime !== undefined) {
      if (!validate146(data.lastTransitionTime, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate150(data.observedGeneration, {
...
const schema59 = {
  "properties": {
    ...
    "entries": {
      "$ref": "bg4bDHjLsy43Zb8ZMWEKiuwxUqBNIzgJ4gvozYryE"
    }
  },
...
const schema60 = {
  "items": {
    "$ref": "kBell43awCaVD7ZGJIrURHnHe4IinY78QASJ6G8Dw"
  },
  "type": "array"
};
const schema61 = {
...
function validate143(data, {
  ...
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.conditions !== undefined) {
      if (!validate144(data.conditions, {
    ...
    if (data.lastAppliedRevision !== undefined) {
      if (!validate22(data.lastAppliedRevision, {
    ...
    if (data.lastAttemptedRevision !== undefined) {
      if (!validate22(data.lastAttemptedRevision, {
    ...
    if (data.observedGeneration !== undefined) {
      if (!validate163(data.observedGeneration, {
        instancePath: instancePath + "/observedGeneration",
        parentData: data,
        parentDataProperty: "observedGeneration",
        rootData
...
function validate24(data, {
  ...
  /*# sourceURL="kustomize.toolkit.fluxcd.io.v1beta1.Kustomization" */;
  let vErrors = null;
  let errors = 0;
  if (data && typeof data == "object" && !Array.isArray(data)) {
    if (data.apiVersion === undefined) {
