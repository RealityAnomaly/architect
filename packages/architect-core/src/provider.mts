 ...
 */
export abstract class Provider<T, TStatus extends ApplyStatus<T> = ApplyStatus<T>> {
  abstract apply(resources: T[], dryRun: boolean, watch: boolean): AsyncGenerator<TStatus>;
};
