...
export class GVK {
   ...
   */
  public static fromCRD(
    crd: apiextensionsK8sIo.v1.CustomResourceDefinition,
  ): GVK[] {
  ...
  public compare(operand: GVK): boolean {
    return this.group === operand.group && this.version === operand.version &&
  ...
  public isAPIModel(): boolean {
    return this.group === undefined || !this.group.includes(".") ||
      this.group.endsWith(".k8s.io");
  }
