/* @ts-self-types="./LabelSelectorRequirement.d.ts" */
export const validate = validate1;
const schema1 = {"properties":{"key":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"operator":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"values":{"$ref":"uqi-NWpwJAtCtKg340P2GU85hOwdccNKh8Eansj5IGE"}},"required":["key","operator"],"type":"object","$id":"io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement"};
...
/*# sourceURL="io.k8s.apimachinery.pkg.apis.meta.v1.LabelSelectorRequirement" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
const _errs2 = errors;
if(!(validate0(data1, {instancePath:instancePath+"/operator",parentData:data,parentDataProperty:"operator",rootData}))){
vErrors = vErrors === null ? validate0.errors : vErrors.concat(validate0.errors);
errors = vErrors.length;
}
else {
