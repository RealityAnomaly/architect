...
import { validate } from "../../_schemas/storage.k8s.io/v1beta1/VolumeAttributesClass.js";
...
static apiVersion: IVolumeAttributesClass["apiVersion"] = "storage.k8s.io/v1beta1";
...
export type {
  IVolumeAttributesClass as IIoK8sApiStorageV1beta1VolumeAttributesClass,
  VolumeAttributesClass as IoK8sApiStorageV1beta1VolumeAttributesClass
};
