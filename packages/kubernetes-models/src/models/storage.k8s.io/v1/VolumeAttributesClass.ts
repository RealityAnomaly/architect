...
import { validate } from "../../_schemas/storage.k8s.io/v1/VolumeAttributesClass.js";
...
static apiVersion: IVolumeAttributesClass["apiVersion"] = "storage.k8s.io/v1";
...
export type {
  IVolumeAttributesClass as IIoK8sApiStorageV1VolumeAttributesClass,
  VolumeAttributesClass as IoK8sApiStorageV1VolumeAttributesClass
};
