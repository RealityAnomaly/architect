...
import { IIoK8sApiStorageV1VolumeAttachmentSpec } from "./VolumeAttachmentSpec.ts";
import { IIoK8sApiStorageV1VolumeAttachmentStatus } from "./VolumeAttachmentStatus.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/kubernetes-types/meta";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/storage.k8s.io/v1/VolumeAttachment.js";
...
static apiVersion: IVolumeAttachment["apiVersion"] = "storage.k8s.io/v1";
...
export type {
  IVolumeAttachment as IIoK8sApiStorageV1VolumeAttachment,
  VolumeAttachment as IoK8sApiStorageV1VolumeAttachment
};
