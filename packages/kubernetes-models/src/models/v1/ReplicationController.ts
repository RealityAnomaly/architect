...
import { validate } from "../_schemas/v1/ReplicationController.js";
...
static is: TypeMetaGuard<IReplicationController> = createTypeMetaGuard<IReplicationController>(ReplicationController);
