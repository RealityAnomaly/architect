...
import { validate } from "../_schemas/v1/ServiceAccountList.js";
...
static is: TypeMetaGuard<IServiceAccountList> = createTypeMetaGuard<IServiceAccountList>(ServiceAccountList);
