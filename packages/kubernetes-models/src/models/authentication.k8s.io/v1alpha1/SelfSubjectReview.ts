...
import { IIoK8sApiAuthenticationV1alpha1SelfSubjectReviewStatus } from "./SelfSubjectReviewStatus.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/kubernetes-types/meta";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/authentication.k8s.io/v1alpha1/SelfSubjectReview.js";
 ...
 */
"status"?: IIoK8sApiAuthenticationV1alpha1SelfSubjectReviewStatus;
}
...
export type {
  ISelfSubjectReview as IIoK8sApiAuthenticationV1alpha1SelfSubjectReview,
  SelfSubjectReview as IoK8sApiAuthenticationV1alpha1SelfSubjectReview
};
