...
import { IIoK8sApiAuthenticationV1SelfSubjectReviewStatus } from "./SelfSubjectReviewStatus.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/kubernetes-types/meta";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/authentication.k8s.io/v1/SelfSubjectReview.js";
...
static apiVersion: ISelfSubjectReview["apiVersion"] = "authentication.k8s.io/v1";
...
export type {
  ISelfSubjectReview as IIoK8sApiAuthenticationV1SelfSubjectReview,
  SelfSubjectReview as IoK8sApiAuthenticationV1SelfSubjectReview
};
