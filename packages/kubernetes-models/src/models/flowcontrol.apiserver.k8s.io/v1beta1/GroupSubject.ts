...
import { validate } from "../../_schemas/flowcontrol.apiserver.k8s.io/v1beta1/GroupSubject.js";
...
export type {
  IGroupSubject as IIoK8sApiFlowcontrolV1beta1GroupSubject,
  GroupSubject as IoK8sApiFlowcontrolV1beta1GroupSubject
};
