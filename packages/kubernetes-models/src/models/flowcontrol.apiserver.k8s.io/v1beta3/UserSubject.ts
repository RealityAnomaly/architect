...
import { validate } from "../../_schemas/flowcontrol.apiserver.k8s.io/v1beta3/UserSubject.js";
...
export type {
  IUserSubject as IIoK8sApiFlowcontrolV1beta3UserSubject,
  UserSubject as IoK8sApiFlowcontrolV1beta3UserSubject
};
