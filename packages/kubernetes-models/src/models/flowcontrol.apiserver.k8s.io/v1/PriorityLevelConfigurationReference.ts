...
import { validate } from "../../_schemas/flowcontrol.apiserver.k8s.io/v1/PriorityLevelConfigurationReference.js";
...
export type {
  IPriorityLevelConfigurationReference as IIoK8sApiFlowcontrolV1PriorityLevelConfigurationReference,
  PriorityLevelConfigurationReference as IoK8sApiFlowcontrolV1PriorityLevelConfigurationReference
};
