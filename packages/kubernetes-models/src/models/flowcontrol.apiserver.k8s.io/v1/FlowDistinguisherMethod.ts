...
import { validate } from "../../_schemas/flowcontrol.apiserver.k8s.io/v1/FlowDistinguisherMethod.js";
...
export type {
  IFlowDistinguisherMethod as IIoK8sApiFlowcontrolV1FlowDistinguisherMethod,
  FlowDistinguisherMethod as IoK8sApiFlowcontrolV1FlowDistinguisherMethod
};
