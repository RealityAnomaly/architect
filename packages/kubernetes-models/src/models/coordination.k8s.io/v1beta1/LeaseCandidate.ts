...
import { IIoK8sApiCoordinationV1beta1LeaseCandidateSpec } from "./LeaseCandidateSpec.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/kubernetes-types/meta";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/coordination.k8s.io/v1beta1/LeaseCandidate.js";
 ...
 */
"spec": IIoK8sApiCoordinationV1beta1LeaseCandidateSpec;
}
...
export type {
  ILeaseCandidate as IIoK8sApiCoordinationV1beta1LeaseCandidate,
  LeaseCandidate as IoK8sApiCoordinationV1beta1LeaseCandidate
};
