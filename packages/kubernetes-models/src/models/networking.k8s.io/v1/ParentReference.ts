...
import { validate } from "../../_schemas/networking.k8s.io/v1/ParentReference.js";
...
export type {
  IParentReference as IIoK8sApiNetworkingV1ParentReference,
  ParentReference as IoK8sApiNetworkingV1ParentReference
};
