...
import { IIoK8sApiNetworkingV1IPAddressSpec } from "./IPAddressSpec.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/kubernetes-types/meta";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/networking.k8s.io/v1/IPAddress.js";
 ...
 */
"spec": IIoK8sApiNetworkingV1IPAddressSpec;
}
...
static apiVersion: IIPAddress["apiVersion"] = "networking.k8s.io/v1";
...
export type {
  IIPAddress as IIoK8sApiNetworkingV1IPAddress,
  IPAddress as IoK8sApiNetworkingV1IPAddress
};
