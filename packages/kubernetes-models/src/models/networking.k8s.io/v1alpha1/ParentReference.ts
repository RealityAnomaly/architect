...
import { validate } from "../../_schemas/networking.k8s.io/v1alpha1/ParentReference.js";
...
export type {
  IParentReference as IIoK8sApiNetworkingV1alpha1ParentReference,
  ParentReference as IoK8sApiNetworkingV1alpha1ParentReference
};
