...
import { validate } from "../../_schemas/networking.k8s.io/v1alpha1/ServiceCIDRSpec.js";
...
export type {
  IServiceCIDRSpec as IIoK8sApiNetworkingV1alpha1ServiceCIDRSpec,
  ServiceCIDRSpec as IoK8sApiNetworkingV1alpha1ServiceCIDRSpec
};
