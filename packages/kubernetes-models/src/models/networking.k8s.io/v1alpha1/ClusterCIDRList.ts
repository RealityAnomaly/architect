...
import { validate } from "../../_schemas/networking.k8s.io/v1alpha1/ClusterCIDRList.js";
...
static is: TypeMetaGuard<IClusterCIDRList> = createTypeMetaGuard<IClusterCIDRList>(ClusterCIDRList);
