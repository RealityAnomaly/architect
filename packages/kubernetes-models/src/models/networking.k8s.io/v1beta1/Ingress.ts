...
import { IIoK8sApiNetworkingV1beta1IngressSpec } from "./IngressSpec.ts";
import { IIoK8sApiNetworkingV1beta1IngressStatus } from "./IngressStatus.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/kubernetes-types/meta";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/networking.k8s.io/v1beta1/Ingress.js";
...
export type {
  IIngress as IIoK8sApiNetworkingV1beta1Ingress,
  Ingress as IoK8sApiNetworkingV1beta1Ingress
};
