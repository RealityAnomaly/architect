...
import { validate } from "../../_schemas/networking.k8s.io/v1beta1/IngressTLS.js";
...
export type {
  IIngressTLS as IIoK8sApiNetworkingV1beta1IngressTLS,
  IngressTLS as IoK8sApiNetworkingV1beta1IngressTLS
};
