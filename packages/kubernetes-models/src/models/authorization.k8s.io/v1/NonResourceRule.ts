...
import { validate } from "../../_schemas/authorization.k8s.io/v1/NonResourceRule.js";
...
export type {
  INonResourceRule as IIoK8sApiAuthorizationV1NonResourceRule,
  NonResourceRule as IoK8sApiAuthorizationV1NonResourceRule
};
