...
const schema0 = {"properties":{"name":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"selector":{"$ref":"ft7HGURTbPyh-vhzFAYgnhVehb5DIkOC1Qu-kP-9F84"}},"required":["name"],"type":"object","$id":"io.k8s.api.autoscaling.v2.MetricIdentifier"};
...
/*# sourceURL="io.k8s.api.autoscaling.v2.MetricIdentifier" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
