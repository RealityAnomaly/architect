/* @ts-self-types="./HPAScalingPolicy.d.ts" */
import { formats } from "@glassway/kubernetes-types/validate";
export const validate = validate1;
const schema1 = {"properties":{"periodSeconds":{"$ref":"6VbGrbfqnPJ4dMmNewHbRn4M59VZOmu0uhV1edBN8qE"},"type":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"value":{"$ref":"6VbGrbfqnPJ4dMmNewHbRn4M59VZOmu0uhV1edBN8qE"}},"required":["type","value","periodSeconds"],"type":"object","$id":"io.k8s.api.autoscaling.v2.HPAScalingPolicy"};
...
/*# sourceURL="io.k8s.api.autoscaling.v2.HPAScalingPolicy" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
