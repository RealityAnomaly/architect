...
const schema1 = {"properties":{"apiVersion":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"kind":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"name":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"}},"required":["kind","name"],"type":"object","$id":"io.k8s.api.autoscaling.v1.CrossVersionObjectReference"};
...
/*# sourceURL="io.k8s.api.autoscaling.v1.CrossVersionObjectReference" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
