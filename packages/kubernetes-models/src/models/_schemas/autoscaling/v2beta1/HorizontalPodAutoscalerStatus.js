...
const schema1 = {"properties":{"conditions":{"$ref":"5xnxDjo8Bf8q6UKVnQKEivaMssJ7z_Xy-lZ91UMj-Qg"},"currentMetrics":{"$ref":"TNqPLWJNZ26OWwpMqYYGUHiyZvAMcnDTMVnI_q282-E"},"currentReplicas":{"$ref":"6VbGrbfqnPJ4dMmNewHbRn4M59VZOmu0uhV1edBN8qE"},"desiredReplicas":{"$ref":"6VbGrbfqnPJ4dMmNewHbRn4M59VZOmu0uhV1edBN8qE"},"lastScaleTime":{"$ref":"tpjjy07qx44TS_S1WH8Z24TCcf0ahn452vZ82zIbIK0"},"observedGeneration":{"$ref":"otlW-2SioSJxw2ZRa8bQrFi14CUkm_yS2tfdShK98Vk"}},"required":["currentReplicas","desiredReplicas"],"type":"object","$id":"io.k8s.api.autoscaling.v2beta1.HorizontalPodAutoscalerStatus"};
const schema2 = {"items":{"$ref":"NgL9t2LTEzwoyHY-Gwx3Bw6MBxC3tsrJ6L1nBtvE408"},"type":"array","nullable":true};
const schema3 = {"$ref":"io.k8s.api.autoscaling.v2beta1.HorizontalPodAutoscalerCondition#"};
const schema4 = {};

import { validate as validate4 } from "././HorizontalPodAutoscalerCondition.js";
...
const schema5 = {"items":{"$ref":"WU1Kq0RFsiMuA2P6QrULoeV-T9GwKKyGmUCwWfRj9oI"},"type":"array","nullable":true};
const schema6 = {"$ref":"io.k8s.api.autoscaling.v2beta1.MetricStatus#"};
const schema7 = {};

import { validate as validate10 } from "././MetricStatus.js";
...
import { validate as validate17 } from "./../../../../apimachinery/_schemas/apis/meta/v1/Time.js";
...
/*# sourceURL="io.k8s.api.autoscaling.v2beta1.HorizontalPodAutoscalerStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
