...
/*# sourceURL="io.k8s.api.storage.v1.VolumeAttributesClass" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
