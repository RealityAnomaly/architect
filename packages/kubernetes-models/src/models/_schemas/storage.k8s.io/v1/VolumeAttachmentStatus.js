/* @ts-self-types="./VolumeAttachmentStatus.d.ts" */
export const validate = validate3;
const schema2 = {"properties":{"attachError":{"$ref":"hKqS_xtoNMeWinZfrbWXssroS6BmTG4di19SnAEJe3Y"},"attached":{"$ref":"C6hei-tisjs1kz7xDhDJSDhsoUlCo3cumzNSDD7Je7A"},"attachmentMetadata":{"$ref":"Ul_dhUdbb_DarDhfw0mKkpjzZdc0vNqkGhUAaKt2b7M"},"detachError":{"$ref":"hKqS_xtoNMeWinZfrbWXssroS6BmTG4di19SnAEJe3Y"}},"required":["attached"],"type":"object","$id":"io.k8s.api.storage.v1.VolumeAttachmentStatus"};
const schema0 = {"nullableRef":"io.k8s.api.storage.v1.VolumeError#"};
const schema1 = {};

import { validate as validate1 } from "././VolumeError.js";
...
/*# sourceURL="io.k8s.api.storage.v1.VolumeAttachmentStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
