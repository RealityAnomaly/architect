...
/*# sourceURL="io.k8s.api.storagemigration.v1alpha1.MigrationCondition" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
let data0 = data.lastUpdateTime;
const _errs1 = errors;
if(!(validate3(data0, {instancePath:instancePath+"/lastUpdateTime",parentData:data,parentDataProperty:"lastUpdateTime",rootData}))){
...
const _errs3 = errors;
if(!(validate0(data2, {instancePath:instancePath+"/reason",parentData:data,parentDataProperty:"reason",rootData}))){
vErrors = vErrors === null ? validate0.errors : vErrors.concat(validate0.errors);
errors = vErrors.length;
}
else {
...
const _errs4 = errors;
if(!(validate1(data3, {instancePath:instancePath+"/status",parentData:data,parentDataProperty:"status",rootData}))){
...
let data4 = data.type;
const _errs5 = errors;
if(!(validate1(data4, {instancePath:instancePath+"/type",parentData:data,parentDataProperty:"type",rootData}))){
vErrors = vErrors === null ? validate1.errors : vErrors.concat(validate1.errors);
errors = vErrors.length;
}
else {
