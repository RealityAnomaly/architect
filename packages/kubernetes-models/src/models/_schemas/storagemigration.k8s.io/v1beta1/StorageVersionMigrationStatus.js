...
const schema0 = {"properties":{"conditions":{"$ref":"jI7gN-jH9FiRLjopJCUTgArdnLwDtZcYfDbNHkOZBp0"},"resourceVersion":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"}},"type":"object","$id":"io.k8s.api.storagemigration.v1beta1.StorageVersionMigrationStatus"};
...
/*# sourceURL="io.k8s.api.storagemigration.v1beta1.StorageVersionMigrationStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
