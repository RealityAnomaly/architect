/* @ts-self-types="./StorageVersionMigrationList.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"k5mDDesRtCFucGllimaaTnNCzeQUUecIZ4YUku2KWxM"},"items":{"$ref":"uWUp3kLm8sxeUKTcwYHUgM5a4Tgg7BXVMw-RmysLN4c"},"kind":{"$ref":"dpNaK8ZVPC68H0HE_6TJ4YOVdWh6llizCu98IDIEorg"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.storagemigration.v1beta1.StorageVersionMigrationList"};
...
const schema2 = {"items":{"$ref":"bMDOyKDhlEKAqcXGUTOS_67gI547AprBCDLG5n7BYUE"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.storagemigration.v1beta1.StorageVersionMigration#"};
const schema4 = {};

import { validate as validate5 } from "././StorageVersionMigration.js";
...
const schema5 = {"type":"string","enum":["StorageVersionMigrationList"]};
...
if(!(data === "StorageVersionMigrationList")){
...
/*# sourceURL="io.k8s.api.storagemigration.v1beta1.StorageVersionMigrationList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
