...
const schema1 = {"properties":{"max":{"$ref":"0YQm7z5aN2fg7S8XlbxrquRU6pdIr97uCbtQYyjv3S4"},"min":{"$ref":"0YQm7z5aN2fg7S8XlbxrquRU6pdIr97uCbtQYyjv3S4"}},"required":["min","max"],"type":"object","$id":"io.k8s.api.policy.v1beta1.IDRange"};
...
/*# sourceURL="io.k8s.api.policy.v1beta1.IDRange" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
