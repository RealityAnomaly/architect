/* @ts-self-types="./Eviction.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"b92H8BVeVpZpHNCYU8cOc8y08Qv4UCxDyqytMuI0gCw"},"deleteOptions":{"$ref":"3vZ-sKVL9MLIxCAH9kl1DzADih0e6Y4IV05bqhD88C8"},"kind":{"$ref":"TCUo9aTdmabJ8gX8TMLnS8r7rpdpJeas_ricvb_KRQs"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.policy.v1beta1.Eviction"};
const schema1 = {"type":"string","enum":["policy/v1beta1"]};
...
const schema2 = {"nullableRef":"io.k8s.apimachinery.pkg.apis.meta.v1.DeleteOptions#"};
const schema3 = {};

import { validate as validate4 } from "./../../../../apimachinery/_schemas/apis/meta/v1/DeleteOptions.js";
...
const schema4 = {"type":"string","enum":["Eviction"]};
...
/*# sourceURL="io.k8s.api.policy.v1beta1.Eviction" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
if(data.deleteOptions !== undefined){
let data1 = data.deleteOptions;
const _errs2 = errors;
if(!(validate3(data1, {instancePath:instancePath+"/deleteOptions",parentData:data,parentDataProperty:"deleteOptions",rootData}))){
