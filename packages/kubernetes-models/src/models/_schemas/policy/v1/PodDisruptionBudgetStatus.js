/* @ts-self-types="./PodDisruptionBudgetStatus.d.ts" */
import { formats } from "@glassway/kubernetes-types/validate";
export const validate = validate1;
const schema1 = {"properties":{"conditions":{"$ref":"jI7gN-jH9FiRLjopJCUTgArdnLwDtZcYfDbNHkOZBp0"},"currentHealthy":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"desiredHealthy":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"disruptedPods":{"$ref":"n1HQow9N2jJY4PLugVkV9mwDtmly-fB3A9-OpE8m7lo"},"disruptionsAllowed":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"expectedPods":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"observedGeneration":{"$ref":"otlW-2SioSJxw2ZRa8bQrFi14CUkm_yS2tfdShK98Vk"}},"type":"object","$id":"io.k8s.api.policy.v1.PodDisruptionBudgetStatus"};
...
import { validate as validate12 } from "./../../../../apimachinery/_schemas/apis/meta/v1/Time.js";
...
/*# sourceURL="io.k8s.api.policy.v1.PodDisruptionBudgetStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
