...
const schema0 = {"properties":{"apiVersion":{"$ref":"eAyZa3na3YWtE-ukHIB1wyDKbrORzBVg00FMJMyk6bo"},"deleteOptions":{"$ref":"3vZ-sKVL9MLIxCAH9kl1DzADih0e6Y4IV05bqhD88C8"},"kind":{"$ref":"TCUo9aTdmabJ8gX8TMLnS8r7rpdpJeas_ricvb_KRQs"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.policy.v1.Eviction"};
const schema1 = {"type":"string","enum":["policy/v1"]};
...
/*# sourceURL="io.k8s.api.policy.v1.Eviction" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
