/* @ts-self-types="./ResourceRule.d.ts" */
...
/*# sourceURL="io.k8s.api.authorization.v1beta1.ResourceRule" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
let data1 = data.resourceNames;
const _errs2 = errors;
if(!(validate0(data1, {instancePath:instancePath+"/resourceNames",parentData:data,parentDataProperty:"resourceNames",rootData}))){
vErrors = vErrors === null ? validate0.errors : vErrors.concat(validate0.errors);
errors = vErrors.length;
}
else {
...
const _errs3 = errors;
if(!(validate0(data2, {instancePath:instancePath+"/resources",parentData:data,parentDataProperty:"resources",rootData}))){
vErrors = vErrors === null ? validate0.errors : vErrors.concat(validate0.errors);
errors = vErrors.length;
}
else {
...
if(data.verbs !== undefined){
let data3 = data.verbs;
const _errs4 = errors;
if(!(validate7(data3, {instancePath:instancePath+"/verbs",parentData:data,parentDataProperty:"verbs",rootData}))){
