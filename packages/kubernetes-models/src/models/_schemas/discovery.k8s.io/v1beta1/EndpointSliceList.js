/* @ts-self-types="./EndpointSliceList.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"twWohf_LcncLcUHUa8bLkoVO9oFYamI13Vad3PNcZrU"},"items":{"$ref":"tRgU0vOW09nrr8sx-BaIdaHzLVOp4J_vXH55DRbDtIo"},"kind":{"$ref":"SHPrl8rrXxmgSGtCwGnZLNNAH57BT_JJb4a9wiYUhTw"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.discovery.v1beta1.EndpointSliceList"};
const schema1 = {"type":"string","enum":["discovery.k8s.io/v1beta1"]};
...
const schema2 = {"items":{"$ref":"coMJ04mj7CY0ql30aE-j4kQI1tVaDOQNvWgE9mxMHxY"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.discovery.v1beta1.EndpointSlice#"};
const schema4 = {};

import { validate as validate5 } from "././EndpointSlice.js";
...
const schema5 = {"type":"string","enum":["EndpointSliceList"]};
...
/*# sourceURL="io.k8s.api.discovery.v1beta1.EndpointSliceList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
