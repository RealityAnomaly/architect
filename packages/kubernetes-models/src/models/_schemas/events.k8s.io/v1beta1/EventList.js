/* @ts-self-types="./EventList.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"6HcqeNnqn8zQuJDebL0khMYvQGhePr6hjaW5aK6Djt0"},"items":{"$ref":"1dazbJSaha4yCVwzf8DluGBCQSjFhgRpqn7awBir7WU"},"kind":{"$ref":"7blu8xv5jbp9Ah_TAnd_a-y9NaQkEO7rEN2Zquy36ew"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.events.v1beta1.EventList"};
const schema1 = {"type":"string","enum":["events.k8s.io/v1beta1"]};
...
const schema2 = {"items":{"$ref":"gxsLO9swwmHkAq82xNJpd9xJT6rSmtJ_nLBaWnvLRGw"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.events.v1beta1.Event#"};
const schema4 = {};

import { validate as validate5 } from "././Event.js";
...
const schema5 = {"type":"string","enum":["EventList"]};
...
/*# sourceURL="io.k8s.api.events.v1beta1.EventList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
