/* @ts-self-types="./EventSeries.d.ts" */
import { formats } from "@glassway/kubernetes-types/validate";
export const validate = validate0;
const schema0 = {"properties":{"count":{"$ref":"6VbGrbfqnPJ4dMmNewHbRn4M59VZOmu0uhV1edBN8qE"},"lastObservedTime":{"$ref":"MdxhferRjti8877U_5w2PibKQQv4V2Zk1e2FIMataHU"}},"required":["count","lastObservedTime"],"type":"object","$id":"io.k8s.api.events.v1.EventSeries"};
...
import { validate as validate4 } from "./../../../../apimachinery/_schemas/apis/meta/v1/MicroTime.js";
...
/*# sourceURL="io.k8s.api.events.v1.EventSeries" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
