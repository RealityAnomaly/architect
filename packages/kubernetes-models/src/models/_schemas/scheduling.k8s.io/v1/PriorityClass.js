...
const schema0 = {"properties":{"apiVersion":{"$ref":"HpsEyiWOInqhlY0dIoLKmMEFK0Hs6s0dhtLNqVM-2Fk"},"globalDefault":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"kind":{"$ref":"Q_eeCZFPdLzMy7d8cyQqYjBcqmeO5n6A27fy6Q5A9r4"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"preemptionPolicy":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"value":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.scheduling.v1.PriorityClass"};
...
/*# sourceURL="io.k8s.api.scheduling.v1.PriorityClass" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
