/* @ts-self-types="./PodGroupResourceClaim.d.ts" */
export const validate = validate1;
const schema1 = {"properties":{"name":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"resourceClaimName":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"resourceClaimTemplateName":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"}},"required":["name"],"type":"object","$id":"io.k8s.api.scheduling.v1alpha2.PodGroupResourceClaim"};
...
/*# sourceURL="io.k8s.api.scheduling.v1alpha2.PodGroupResourceClaim" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
