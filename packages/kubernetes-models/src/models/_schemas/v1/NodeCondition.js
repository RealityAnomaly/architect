...
/*# sourceURL="io.k8s.api.core.v1.NodeCondition" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
if(data.lastHeartbeatTime !== undefined){
let data0 = data.lastHeartbeatTime;
const _errs1 = errors;
if(!(validate0(data0, {instancePath:instancePath+"/lastHeartbeatTime",parentData:data,parentDataProperty:"lastHeartbeatTime",rootData}))){
