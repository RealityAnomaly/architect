...
let data0 = data[key0];
const _errs3 = errors;
if(!(validate5(data0, {instancePath:instancePath+"/" + key0.replace(/~/g, "~0").replace(/\//g, "~1"),parentData:data,parentDataProperty:key0,rootData}))){
...
import { validate as validate9 } from "././PodTemplateSpec.js";
...
/*# sourceURL="io.k8s.api.core.v1.ReplicationControllerSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
