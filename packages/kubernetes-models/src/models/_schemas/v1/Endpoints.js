/* @ts-self-types="./Endpoints.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"_-ZvS-rLxHiNEArQOhevVo83klxV-qnul8X_v4BZ4M4"},"kind":{"$ref":"-ABJznQo-nJFT5iEGqfc_f1lU5Ha_vMvJWyPfWrA2G4"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"subsets":{"$ref":"u-cAZ1k3yEDrZPWFrWOimfym-mrHwt2EiCiz_VFHo44"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.core.v1.Endpoints"};
...
const schema2 = {"type":"string","enum":["Endpoints"]};
...
const schema5 = {"items":{"$ref":"T1jD18MnJpIfAM5xfpoM-wVCdhmbebH8VejxjkEADl4"},"type":"array","nullable":true};
const schema6 = {"$ref":"io.k8s.api.core.v1.EndpointSubset#"};
const schema7 = {};

import { validate as validate11 } from "././EndpointSubset.js";
...
/*# sourceURL="io.k8s.api.core.v1.Endpoints" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
let data3 = data.subsets;
const _errs4 = errors;
if(!(validate9(data3, {instancePath:instancePath+"/subsets",parentData:data,parentDataProperty:"subsets",rootData}))){
