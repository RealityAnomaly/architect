...
const schema2 = {"items":{"$ref":"Zk7-arHayXIyMt6L-wzE4t9t5JyUOfy1NhISsNADtS4"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.core.v1.Secret#"};
const schema4 = {};

import { validate as validate5 } from "././Secret.js";
...
const schema5 = {"type":"string","enum":["SecretList"]};
...
/*# sourceURL="io.k8s.api.core.v1.SecretList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
