...
const schema2 = {"items":{"$ref":"V4M8GeaT-Z3hX2B7tly_SmH6bzvSig8kQhMmb7ed2Mc"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.core.v1.Pod#"};
const schema4 = {};

import { validate as validate5 } from "././Pod.js";
...
const schema5 = {"type":"string","enum":["PodList"]};
...
/*# sourceURL="io.k8s.api.core.v1.PodList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
