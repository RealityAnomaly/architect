...
const schema2 = {"items":{"$ref":"z3fd3Jfmv8CUzT3milpd9d6ApPWR8nBVhos9dxsaSSU"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.core.v1.Event#"};
const schema4 = {};
...
/*# sourceURL="io.k8s.api.core.v1.EventList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
