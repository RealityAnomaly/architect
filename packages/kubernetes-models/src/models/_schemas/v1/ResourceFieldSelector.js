/* @ts-self-types="./ResourceFieldSelector.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"containerName":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"divisor":{"$ref":"pp_xaFlNXkKoD6DTqyaUAeP7lGItJ9_hKwPxmHYeCNA"},"resource":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"}},"required":["resource"],"type":"object","$id":"io.k8s.api.core.v1.ResourceFieldSelector"};
...
/*# sourceURL="io.k8s.api.core.v1.ResourceFieldSelector" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
let data1 = data.divisor;
const _errs2 = errors;
if(!(validate3(data1, {instancePath:instancePath+"/divisor",parentData:data,parentDataProperty:"divisor",rootData}))){
...
const _errs3 = errors;
if(!(validate7(data2, {instancePath:instancePath+"/resource",parentData:data,parentDataProperty:"resource",rootData}))){
