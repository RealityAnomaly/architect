...
/*# sourceURL="io.k8s.api.core.v1.PodCondition" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
let data0 = data.lastProbeTime;
const _errs1 = errors;
if(!(validate0(data0, {instancePath:instancePath+"/lastProbeTime",parentData:data,parentDataProperty:"lastProbeTime",rootData}))){
...
let data1 = data.lastTransitionTime;
const _errs2 = errors;
if(!(validate0(data1, {instancePath:instancePath+"/lastTransitionTime",parentData:data,parentDataProperty:"lastTransitionTime",rootData}))){
vErrors = vErrors === null ? validate0.errors : vErrors.concat(validate0.errors);
errors = vErrors.length;
}
else {
...
const _errs4 = errors;
if(!(validate9(data3, {instancePath:instancePath+"/observedGeneration",parentData:data,parentDataProperty:"observedGeneration",rootData}))){
...
const _errs5 = errors;
if(!(validate3(data4, {instancePath:instancePath+"/reason",parentData:data,parentDataProperty:"reason",rootData}))){
vErrors = vErrors === null ? validate3.errors : vErrors.concat(validate3.errors);
errors = vErrors.length;
}
else {
...
const _errs6 = errors;
if(!(validate4(data5, {instancePath:instancePath+"/status",parentData:data,parentDataProperty:"status",rootData}))){
...
let data6 = data.type;
const _errs7 = errors;
if(!(validate4(data6, {instancePath:instancePath+"/type",parentData:data,parentDataProperty:"type",rootData}))){
vErrors = vErrors === null ? validate4.errors : vErrors.concat(validate4.errors);
errors = vErrors.length;
}
else {
