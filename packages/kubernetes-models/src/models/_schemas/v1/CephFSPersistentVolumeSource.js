/* @ts-self-types="./CephFSPersistentVolumeSource.d.ts" */
export const validate = validate1;
const schema1 = {"properties":{"monitors":{"$ref":"uqUtVyG9D2UAWDvqosEgVMtwK5kI3TMy2eLbDZB452I"},"path":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"readOnly":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"},"secretFile":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"secretRef":{"$ref":"1a3NqiktqyZHHY3Qk2TC-_08DZCxXEI_qoSZ_ClP6qA"},"user":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"}},"required":["monitors"],"type":"object","$id":"io.k8s.api.core.v1.CephFSPersistentVolumeSource"};
...
import { validate as validate11 } from "././SecretReference.js";
...
/*# sourceURL="io.k8s.api.core.v1.CephFSPersistentVolumeSource" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
