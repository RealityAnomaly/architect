/* @ts-self-types="./ComponentStatus.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"_-ZvS-rLxHiNEArQOhevVo83klxV-qnul8X_v4BZ4M4"},"conditions":{"$ref":"jtLf3DH4Lq7dvjwPRFxndmseFxFWMOqP8agnR7RUn4w"},"kind":{"$ref":"rNRr7Hg6sM0yFStaHPb8egqSr3rYGwHs8yG-V9Re4J8"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.core.v1.ComponentStatus"};
...
const schema2 = {"items":{"$ref":"bUIcbKYVdi-AFXpG4_LQ1bweLouQ0Mr_L2wFT6RPTh4"},"type":"array","nullable":true};
const schema3 = {"$ref":"io.k8s.api.core.v1.ComponentCondition#"};
const schema4 = {};

import { validate as validate5 } from "././ComponentCondition.js";
...
const schema5 = {"type":"string","enum":["ComponentStatus"]};
...
import { validate as validate12 } from "./../../../apimachinery/_schemas/apis/meta/v1/ObjectMeta.js";
...
/*# sourceURL="io.k8s.api.core.v1.ComponentStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
