/* @ts-self-types="./HTTPHeader.d.ts" */
export const validate = validate1;
const schema1 = {"properties":{"name":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"value":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"}},"required":["name","value"],"type":"object","$id":"io.k8s.api.core.v1.HTTPHeader"};
...
/*# sourceURL="io.k8s.api.core.v1.HTTPHeader" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
