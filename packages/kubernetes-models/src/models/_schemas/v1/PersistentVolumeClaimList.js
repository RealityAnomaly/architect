/* @ts-self-types="./PersistentVolumeClaimList.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"_-ZvS-rLxHiNEArQOhevVo83klxV-qnul8X_v4BZ4M4"},"items":{"$ref":"DFvwcRQ2QAsUgUULHuZYpMf-04Cr__rh1k4acZ3_U6o"},"kind":{"$ref":"WO5t6rRfefPafxRemjfMI1o3uMz4tlvZipxnadMFv_E"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.core.v1.PersistentVolumeClaimList"};
...
const schema2 = {"items":{"$ref":"88z9MLdBy9QO6G1cQFyRTAv2mdNTuRZA8vsLtRVrtAQ"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.core.v1.PersistentVolumeClaim#"};
const schema4 = {};

import { validate as validate5 } from "././PersistentVolumeClaim.js";
...
const schema5 = {"type":"string","enum":["PersistentVolumeClaimList"]};
...
if(!(data === "PersistentVolumeClaimList")){
...
/*# sourceURL="io.k8s.api.core.v1.PersistentVolumeClaimList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
