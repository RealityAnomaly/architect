/* @ts-self-types="./SecretEnvSource.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"name":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"optional":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"}},"type":"object","$id":"io.k8s.api.core.v1.SecretEnvSource"};
...
/*# sourceURL="io.k8s.api.core.v1.SecretEnvSource" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
