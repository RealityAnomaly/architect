/* @ts-self-types="./ServiceAccountTokenProjection.d.ts" */
import { formats } from "@glassway/kubernetes-types/validate";
export const validate = validate0;
const schema0 = {"properties":{"audience":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"expirationSeconds":{"$ref":"otlW-2SioSJxw2ZRa8bQrFi14CUkm_yS2tfdShK98Vk"},"path":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"}},"required":["path"],"type":"object","$id":"io.k8s.api.core.v1.ServiceAccountTokenProjection"};
...
/*# sourceURL="io.k8s.api.core.v1.ServiceAccountTokenProjection" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
let data2 = data.path;
const _errs3 = errors;
if(!(validate5(data2, {instancePath:instancePath+"/path",parentData:data,parentDataProperty:"path",rootData}))){
