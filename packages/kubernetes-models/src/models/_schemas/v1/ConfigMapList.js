...
const schema2 = {"items":{"$ref":"xzJrZgbFXRrniLXsWf-6kVvjfd2ELG7OWaRNG_Vlrk8"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.core.v1.ConfigMap#"};
const schema4 = {};

import { validate as validate5 } from "././ConfigMap.js";
...
const schema5 = {"type":"string","enum":["ConfigMapList"]};
...
/*# sourceURL="io.k8s.api.core.v1.ConfigMapList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
