/* @ts-self-types="./PersistentVolumeClaim.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"_-ZvS-rLxHiNEArQOhevVo83klxV-qnul8X_v4BZ4M4"},"kind":{"$ref":"ozrw5VpBsDpUwPdckufjh4D7GR8fL3THPlRgu_mNB5I"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"F9i6wrkfeuC0TNc7ADLjLYZt-zPP6zjsokalNzfb_oM"},"status":{"$ref":"Z5Rgyu3_FkPYIVBEwC7QUqyfeuufgCAnWoAD0Fagt7A"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.core.v1.PersistentVolumeClaim"};
...
const schema2 = {"type":"string","enum":["PersistentVolumeClaim"]};
...
const schema5 = {"nullableRef":"io.k8s.api.core.v1.PersistentVolumeClaimSpec#"};
const schema6 = {};

import { validate as validate10 } from "././PersistentVolumeClaimSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.core.v1.PersistentVolumeClaimStatus#"};
const schema8 = {};

import { validate as validate14 } from "././PersistentVolumeClaimStatus.js";
...
/*# sourceURL="io.k8s.api.core.v1.PersistentVolumeClaim" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
