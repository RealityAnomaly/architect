/* @ts-self-types="./PodTemplateSpec.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"GJG6DU-r9Ll88IDUd8sCFAdS8DYKqfGSqPQb3BefAVY"}},"type":"object","$id":"io.k8s.api.core.v1.PodTemplateSpec"};
...
const schema3 = {"nullableRef":"io.k8s.api.core.v1.PodSpec#"};
const schema4 = {};

import { validate as validate6 } from "././PodSpec.js";
...
/*# sourceURL="io.k8s.api.core.v1.PodTemplateSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
