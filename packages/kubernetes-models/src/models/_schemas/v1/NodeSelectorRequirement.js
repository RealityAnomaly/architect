/* @ts-self-types="./NodeSelectorRequirement.d.ts" */
export const validate = validate1;
const schema1 = {"properties":{"key":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"operator":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"values":{"$ref":"uqi-NWpwJAtCtKg340P2GU85hOwdccNKh8Eansj5IGE"}},"required":["key","operator"],"type":"object","$id":"io.k8s.api.core.v1.NodeSelectorRequirement"};
...
/*# sourceURL="io.k8s.api.core.v1.NodeSelectorRequirement" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
