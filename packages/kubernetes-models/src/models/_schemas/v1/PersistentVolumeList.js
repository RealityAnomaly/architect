...
const schema2 = {"items":{"$ref":"ZS9IAq8WDYPP2mSQIjZmGTguuFGxr6A0gnFxh5Vmnnc"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.core.v1.PersistentVolume#"};
const schema4 = {};

import { validate as validate5 } from "././PersistentVolume.js";
...
const schema5 = {"type":"string","enum":["PersistentVolumeList"]};
...
/*# sourceURL="io.k8s.api.core.v1.PersistentVolumeList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
