...
/*# sourceURL="io.k8s.api.core.v1.PhotonPersistentDiskVolumeSource" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
if(data.pdID === undefined){
const err0 = {instancePath,schemaPath:"#/required",keyword:"required",params:{missingProperty: "pdID"}};
if(vErrors === null){
vErrors = [err0];
}
else {
...
let data1 = data.pdID;
const _errs2 = errors;
if(!(validate3(data1, {instancePath:instancePath+"/pdID",parentData:data,parentDataProperty:"pdID",rootData}))){
