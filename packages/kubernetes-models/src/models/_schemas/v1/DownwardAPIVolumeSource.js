/* @ts-self-types="./DownwardAPIVolumeSource.d.ts" */
import { formats } from "@glassway/kubernetes-types/validate";
export const validate = validate0;
const schema0 = {"properties":{"defaultMode":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"items":{"$ref":"krzam2IFG3_TrBdtLJhXXmTEMLuQPMMTUGo31eWBMJs"}},"type":"object","$id":"io.k8s.api.core.v1.DownwardAPIVolumeSource"};
...
const schema2 = {"items":{"$ref":"X8H07OlYPUeX1nPFecrihRDrsiIf-ismDDr04KPB39A"},"type":"array","nullable":true};
const schema3 = {"$ref":"io.k8s.api.core.v1.DownwardAPIVolumeFile#"};
const schema4 = {};

import { validate as validate5 } from "././DownwardAPIVolumeFile.js";
...
/*# sourceURL="io.k8s.api.core.v1.DownwardAPIVolumeSource" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
