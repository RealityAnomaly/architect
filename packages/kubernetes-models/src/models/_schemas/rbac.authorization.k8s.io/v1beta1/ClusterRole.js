...
const schema1 = {"nullableRef":"io.k8s.api.rbac.v1beta1.AggregationRule#"};
const schema2 = {};
...
const schema3 = {"type":"string","enum":["rbac.authorization.k8s.io/v1beta1"]};
...
const schema7 = {"items":{"$ref":"Pvv5tt0Trt7EsyjVoyXl-drXgVX7OLBipUSRT6lZttQ"},"type":"array","nullable":true};
const schema8 = {"$ref":"io.k8s.api.rbac.v1beta1.PolicyRule#"};
const schema9 = {};
...
/*# sourceURL="io.k8s.api.rbac.v1beta1.ClusterRole" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
