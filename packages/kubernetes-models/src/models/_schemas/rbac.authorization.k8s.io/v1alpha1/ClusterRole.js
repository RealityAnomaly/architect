...
const schema0 = {"properties":{"aggregationRule":{"$ref":"AN4D81ZtdQOySXYPmCi6fCSq1z5pY__Vckqc_TmB2qQ"},"apiVersion":{"$ref":"De87fb06yF1O97xgebZ6vmxJNCRPEZ95phqgm7gmOfs"},"kind":{"$ref":"lF_s-1fL1mG5tyO99S1CKbe2VV90te--JI99qVoIrNI"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"rules":{"$ref":"FHgrTPkhDUCv_hOE5R-6rKIcC4zyJ9tVHAPG35t5y_M"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.rbac.v1alpha1.ClusterRole"};
const schema1 = {"nullableRef":"io.k8s.api.rbac.v1alpha1.AggregationRule#"};
const schema2 = {};

import { validate as validate2 } from "././AggregationRule.js";
...
const schema3 = {"type":"string","enum":["rbac.authorization.k8s.io/v1alpha1"]};
...
const schema7 = {"items":{"$ref":"aYhjWxqT5ygZbyUHeFlMLR9z35SZrqFWOFLGYQRQgNI"},"type":"array","nullable":true};
const schema8 = {"$ref":"io.k8s.api.rbac.v1alpha1.PolicyRule#"};
const schema9 = {};

import { validate as validate15 } from "././PolicyRule.js";
...
/*# sourceURL="io.k8s.api.rbac.v1alpha1.ClusterRole" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
