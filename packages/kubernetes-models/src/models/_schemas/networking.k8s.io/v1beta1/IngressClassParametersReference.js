/* @ts-self-types="./IngressClassParametersReference.d.ts" */
export const validate = validate2;
const schema2 = {"properties":{"apiGroup":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"kind":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"name":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"namespace":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"scope":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"}},"required":["kind","name"],"type":"object","$id":"io.k8s.api.networking.v1beta1.IngressClassParametersReference"};
...
/*# sourceURL="io.k8s.api.networking.v1beta1.IngressClassParametersReference" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
const _errs1 = errors;
if(!(validate1(data0, {instancePath:instancePath+"/apiGroup",parentData:data,parentDataProperty:"apiGroup",rootData}))){
...
const _errs5 = errors;
if(!(validate1(data4, {instancePath:instancePath+"/scope",parentData:data,parentDataProperty:"scope",rootData}))){
vErrors = vErrors === null ? validate1.errors : vErrors.concat(validate1.errors);
errors = vErrors.length;
}
else {
