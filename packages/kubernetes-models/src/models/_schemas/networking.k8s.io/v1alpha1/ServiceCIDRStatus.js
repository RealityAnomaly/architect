/* @ts-self-types="./ServiceCIDRStatus.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"conditions":{"$ref":"jI7gN-jH9FiRLjopJCUTgArdnLwDtZcYfDbNHkOZBp0"}},"type":"object","$id":"io.k8s.api.networking.v1alpha1.ServiceCIDRStatus"};
...
/*# sourceURL="io.k8s.api.networking.v1alpha1.ServiceCIDRStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
