/* @ts-self-types="./PodPreset.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"Eck1aBTfjLCBJauPf39qh-uYtKJ5wRf5uEawxPabnew"},"kind":{"$ref":"zHbrGNK_6atm2BaG1DoXCzFDEAyJNCS2IsHXs1K9OeE"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"YV8RTo7TBRBxMtvnoEl1LfsCuUMILG3DndK4E7YGNGA"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.settings.v1alpha1.PodPreset"};
const schema1 = {"type":"string","enum":["settings.k8s.io/v1alpha1"]};
...
if(!(data === "settings.k8s.io/v1alpha1")){
...
const schema2 = {"type":"string","enum":["PodPreset"]};
...
const schema5 = {"nullableRef":"io.k8s.api.settings.v1alpha1.PodPresetSpec#"};
const schema6 = {};

import { validate as validate10 } from "././PodPresetSpec.js";
...
/*# sourceURL="io.k8s.api.settings.v1alpha1.PodPreset" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
