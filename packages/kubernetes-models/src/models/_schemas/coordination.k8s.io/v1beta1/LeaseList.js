...
const schema2 = {"items":{"$ref":"ci2XBGHTmkIVkvxHB-XFBK7Gzu5NDJVgCxffYBsecFk"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.coordination.v1beta1.Lease#"};
const schema4 = {};

import { validate as validate5 } from "././Lease.js";
...
const schema5 = {"type":"string","enum":["LeaseList"]};
...
/*# sourceURL="io.k8s.api.coordination.v1beta1.LeaseList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
