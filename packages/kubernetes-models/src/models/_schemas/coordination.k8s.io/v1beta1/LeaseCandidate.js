/* @ts-self-types="./LeaseCandidate.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"4VnbGDthne7Oi0TQOmIamcqo7uf6poTfBSf50SQpVig"},"kind":{"$ref":"6Wlb6wO28SeTR0x-f7A9nW2rOPz2iFNXYMOX9UCKUtc"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"PFnwLGn8rirNAYTPyL2FtLHKjFXkT_E_2xGFJRWpRoY"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.coordination.v1beta1.LeaseCandidate"};
const schema1 = {"type":"string","enum":["coordination.k8s.io/v1beta1"]};
...
if(!(data === "coordination.k8s.io/v1beta1")){
...
const schema2 = {"type":"string","enum":["LeaseCandidate"]};
...
const schema5 = {"$ref":"io.k8s.api.coordination.v1beta1.LeaseCandidateSpec#"};
const schema6 = {};

import { validate as validate10 } from "././LeaseCandidateSpec.js";
...
/*# sourceURL="io.k8s.api.coordination.v1beta1.LeaseCandidate" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
