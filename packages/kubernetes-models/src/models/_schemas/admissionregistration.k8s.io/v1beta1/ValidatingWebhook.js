...
import { validate as validate20 } from "././RuleWithOperations.js";
...
/*# sourceURL="io.k8s.api.admissionregistration.v1beta1.ValidatingWebhook" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
const _errs8 = errors;
if(!(validate18(data7, {instancePath:instancePath+"/rules",parentData:data,parentDataProperty:"rules",rootData}))){
...
let data8 = data.sideEffects;
const _errs9 = errors;
if(!(validate0(data8, {instancePath:instancePath+"/sideEffects",parentData:data,parentDataProperty:"sideEffects",rootData}))){
vErrors = vErrors === null ? validate0.errors : vErrors.concat(validate0.errors);
errors = vErrors.length;
}
else {
...
if(!(validate25(data9, {instancePath:instancePath+"/timeoutSeconds",parentData:data,parentDataProperty:"timeoutSeconds",rootData}))){
