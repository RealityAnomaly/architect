...
const schema0 = {"properties":{"conditions":{"$ref":"jI7gN-jH9FiRLjopJCUTgArdnLwDtZcYfDbNHkOZBp0"},"observedGeneration":{"$ref":"otlW-2SioSJxw2ZRa8bQrFi14CUkm_yS2tfdShK98Vk"},"typeChecking":{"$ref":"OlQbrJEFf3mQX6HKc4YBL7D-Ts6vyOAsUJzeYCYaNpE"}},"type":"object","$id":"io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicyStatus"};
...
const schema5 = {"nullableRef":"io.k8s.api.admissionregistration.v1beta1.TypeChecking#"};
const schema6 = {};
...
/*# sourceURL="io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicyStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
