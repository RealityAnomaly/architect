/* @ts-self-types="./MutatingWebhookConfigurationList.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"KmJtbxjKRbXdsyADIcJYH0lVv-K8B7QYvkcPlXiYrvM"},"items":{"$ref":"-CEMwWFeLYJvEYkrUNyJ_4osIuMk2RdZmOnMhxVsl7A"},"kind":{"$ref":"AIwuFJlcL3YPRc6lD_Ct-fwPTMsuTm869acldu-onBA"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.admissionregistration.v1beta1.MutatingWebhookConfigurationList"};
...
const schema2 = {"items":{"$ref":"gJ7qMGE09oUSCKF_ZhQQsIR9fyBahFfOlTwOAgqrLA8"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.admissionregistration.v1beta1.MutatingWebhookConfiguration#"};
const schema4 = {};

import { validate as validate5 } from "././MutatingWebhookConfiguration.js";
...
const schema5 = {"type":"string","enum":["MutatingWebhookConfigurationList"]};
...
if(!(data === "MutatingWebhookConfigurationList")){
...
/*# sourceURL="io.k8s.api.admissionregistration.v1beta1.MutatingWebhookConfigurationList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
