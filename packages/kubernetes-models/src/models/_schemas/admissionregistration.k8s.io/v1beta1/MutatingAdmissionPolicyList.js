...
const schema2 = {"items":{"$ref":"lzDfuq7tTLH-_rJ8qneiG4dz0yEsG2yYfe4h2iCQvIA"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicy#"};
const schema4 = {};

import { validate as validate5 } from "././MutatingAdmissionPolicy.js";
...
const schema5 = {"type":"string","enum":["MutatingAdmissionPolicyList"]};
...
if(!(data === "MutatingAdmissionPolicyList")){
...
/*# sourceURL="io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicyList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
