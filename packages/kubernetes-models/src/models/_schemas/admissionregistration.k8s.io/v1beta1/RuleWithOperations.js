/* @ts-self-types="./RuleWithOperations.d.ts" */
...
/*# sourceURL="io.k8s.api.admissionregistration.v1beta1.RuleWithOperations" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
const _errs5 = errors;
if(!(validate8(data4, {instancePath:instancePath+"/scope",parentData:data,parentDataProperty:"scope",rootData}))){
