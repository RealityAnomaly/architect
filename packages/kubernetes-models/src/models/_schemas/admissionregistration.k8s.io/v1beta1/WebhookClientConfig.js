...
const schema0 = {"properties":{"caBundle":{"$ref":"-qMnViG9CEC-V8_TFn4WYpvO2NOwI2XARBIst170yi0"},"service":{"$ref":"MwDJLWwGkuwwn0ed099FkUUCa3yUIL00TZHRntj7h0o"},"url":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"}},"type":"object","$id":"io.k8s.api.admissionregistration.v1beta1.WebhookClientConfig"};
...
const schema2 = {"nullableRef":"io.k8s.api.admissionregistration.v1beta1.ServiceReference#"};
const schema3 = {};
...
/*# sourceURL="io.k8s.api.admissionregistration.v1beta1.WebhookClientConfig" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
