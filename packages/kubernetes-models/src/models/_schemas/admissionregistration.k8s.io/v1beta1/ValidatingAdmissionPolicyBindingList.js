/* @ts-self-types="./ValidatingAdmissionPolicyBindingList.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"KmJtbxjKRbXdsyADIcJYH0lVv-K8B7QYvkcPlXiYrvM"},"items":{"$ref":"eLKyeULZGXXxJ4bnG3YyPMkpGp7O98uwmuh2DZl3hTA"},"kind":{"$ref":"jEJKUpiS0ykLMYbZVW3Bk2dJf4061Aw-A0vJWY8FX3A"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicyBindingList"};
...
const schema2 = {"items":{"$ref":"H1aRKDY2ubyQsQIAKPYeOfHWypsl0hBjldjcfq-koJs"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicyBinding#"};
const schema4 = {};

import { validate as validate5 } from "././ValidatingAdmissionPolicyBinding.js";
...
const schema5 = {"type":"string","enum":["ValidatingAdmissionPolicyBindingList"]};
...
if(!(data === "ValidatingAdmissionPolicyBindingList")){
...
/*# sourceURL="io.k8s.api.admissionregistration.v1beta1.ValidatingAdmissionPolicyBindingList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
