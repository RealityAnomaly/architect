...
const schema2 = {"items":{"$ref":"rgfZsNIxrWD5onn1ueMJaJXmxHQylRz_gp0-jW1kYcs"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicyBinding#"};
const schema4 = {};
...
/*# sourceURL="io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicyBindingList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
