/* @ts-self-types="./MutatingAdmissionPolicy.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"KmJtbxjKRbXdsyADIcJYH0lVv-K8B7QYvkcPlXiYrvM"},"kind":{"$ref":"TsYwpvGG3WpI53KWd5IG-3nPuPmnrsDMF1ba654DFTE"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"WVxBUDpIJcNOt3DzflHgtaeJXTB67v1BnigV1HHSTOg"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicy"};
...
const schema2 = {"type":"string","enum":["MutatingAdmissionPolicy"]};
...
if(!(data === "MutatingAdmissionPolicy")){
...
const schema5 = {"nullableRef":"io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicySpec#"};
const schema6 = {};

import { validate as validate10 } from "././MutatingAdmissionPolicySpec.js";
...
/*# sourceURL="io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicy" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
