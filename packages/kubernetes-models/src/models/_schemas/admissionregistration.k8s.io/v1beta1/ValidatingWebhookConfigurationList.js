/* @ts-self-types="./ValidatingWebhookConfigurationList.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"KmJtbxjKRbXdsyADIcJYH0lVv-K8B7QYvkcPlXiYrvM"},"items":{"$ref":"oDZuQvP0zi8yBQ5IHyIuVpEQNjzrLoh21df76H35ayE"},"kind":{"$ref":"jRPTkAxtHKa57sTJZ_JYeMVdusziM8Z8ArbvAq9J_lA"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.admissionregistration.v1beta1.ValidatingWebhookConfigurationList"};
...
const schema2 = {"items":{"$ref":"YhTMNes9ytLRGvVMJ9R0AYNaMO_P6p0rQHavNNDtwo8"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.admissionregistration.v1beta1.ValidatingWebhookConfiguration#"};
const schema4 = {};

import { validate as validate5 } from "././ValidatingWebhookConfiguration.js";
...
const schema5 = {"type":"string","enum":["ValidatingWebhookConfigurationList"]};
...
if(!(data === "ValidatingWebhookConfigurationList")){
...
/*# sourceURL="io.k8s.api.admissionregistration.v1beta1.ValidatingWebhookConfigurationList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
