...
const schema0 = {"properties":{"matchResources":{"$ref":"_NtCloUFDKjl1lGJbn-gATEs-QayZB4VyyTq7sQ9cHs"},"paramRef":{"$ref":"XpuwhJfOsInH1L2OwI0p4n_0ZsbjcFREkothBOcgRfI"},"policyName":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"}},"type":"object","$id":"io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicyBindingSpec"};
...
/*# sourceURL="io.k8s.api.admissionregistration.v1beta1.MutatingAdmissionPolicyBindingSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
