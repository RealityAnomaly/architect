/* @ts-self-types="./ValidatingAdmissionPolicyStatus.d.ts" */
import { formats } from "@glassway/kubernetes-types/validate";
export const validate = validate0;
const schema0 = {"properties":{"conditions":{"$ref":"jI7gN-jH9FiRLjopJCUTgArdnLwDtZcYfDbNHkOZBp0"},"observedGeneration":{"$ref":"otlW-2SioSJxw2ZRa8bQrFi14CUkm_yS2tfdShK98Vk"},"typeChecking":{"$ref":"TqZ-lSx0qY6Rtqg5F8ldJeQA6CciEIzzw_Rc5krLSh8"}},"type":"object","$id":"io.k8s.api.admissionregistration.v1alpha1.ValidatingAdmissionPolicyStatus"};
...
const schema5 = {"nullableRef":"io.k8s.api.admissionregistration.v1alpha1.TypeChecking#"};
const schema6 = {};

import { validate as validate10 } from "././TypeChecking.js";
...
/*# sourceURL="io.k8s.api.admissionregistration.v1alpha1.ValidatingAdmissionPolicyStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
