...
const schema2 = {"items":{"$ref":"BgPGJQUeCsKcTwM8LejPq6COkTCUoxXAx9Ug3Bg-fsU"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.admissionregistration.v1alpha1.MutatingAdmissionPolicy#"};
const schema4 = {};
...
/*# sourceURL="io.k8s.api.admissionregistration.v1alpha1.MutatingAdmissionPolicyList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
