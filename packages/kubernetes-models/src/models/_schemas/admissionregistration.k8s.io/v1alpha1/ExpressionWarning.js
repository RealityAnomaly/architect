...
const schema1 = {"properties":{"fieldRef":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"warning":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"}},"required":["fieldRef","warning"],"type":"object","$id":"io.k8s.api.admissionregistration.v1alpha1.ExpressionWarning"};
...
/*# sourceURL="io.k8s.api.admissionregistration.v1alpha1.ExpressionWarning" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
