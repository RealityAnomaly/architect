...
const schema2 = {"items":{"$ref":"uYdjPwd9SHRdMMwomYQNsz28uj2S9Z4fFpQScF8SqGs"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.admissionregistration.v1alpha1.MutatingAdmissionPolicyBinding#"};
const schema4 = {};
...
/*# sourceURL="io.k8s.api.admissionregistration.v1alpha1.MutatingAdmissionPolicyBindingList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
