/* @ts-self-types="./ValidatingWebhookConfiguration.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"I2rC4AZeN16vyliIXvprq-UnxvxFKXyEtwjcNn0IxB8"},"kind":{"$ref":"PCmc9LVQk7EXg7E0zzw2xJVRE9Xkj4aU2j3yZtNOlJw"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"webhooks":{"$ref":"Sa4H0YWj4lLFifaGwmBcEjHLo9eqDcPUKjFx5H8yX_k"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.admissionregistration.v1.ValidatingWebhookConfiguration"};
...
const schema2 = {"type":"string","enum":["ValidatingWebhookConfiguration"]};
...
if(!(data === "ValidatingWebhookConfiguration")){
...
const schema5 = {"items":{"$ref":"GRKzZxhu0ZkxLd73izZTtwX9WbzzH00Bud8E2PdNll8"},"type":"array","nullable":true};
const schema6 = {"$ref":"io.k8s.api.admissionregistration.v1.ValidatingWebhook#"};
const schema7 = {};

import { validate as validate11 } from "././ValidatingWebhook.js";
...
/*# sourceURL="io.k8s.api.admissionregistration.v1.ValidatingWebhookConfiguration" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
let data3 = data.webhooks;
const _errs4 = errors;
if(!(validate9(data3, {instancePath:instancePath+"/webhooks",parentData:data,parentDataProperty:"webhooks",rootData}))){
