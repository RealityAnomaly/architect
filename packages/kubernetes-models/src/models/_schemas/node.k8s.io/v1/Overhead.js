...
const schema0 = {"properties":{"podFixed":{"$ref":"YfMVS3P5aWVrkVb6yChl1fVwg8EQjbWuoJkKTJAHr6A"}},"type":"object","$id":"io.k8s.api.node.v1.Overhead"};
...
/*# sourceURL="io.k8s.api.node.v1.Overhead" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
if(data.podFixed !== undefined){
let data0 = data.podFixed;
const _errs1 = errors;
if(!(validate1(data0, {instancePath:instancePath+"/podFixed",parentData:data,parentDataProperty:"podFixed",rootData}))){
