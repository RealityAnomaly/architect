/* @ts-self-types="./RuntimeClassList.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"NJMUM60rp3y1uJ1jnuvFGtwG0Jgncg42VaaLKLZyW48"},"items":{"$ref":"7WKgsmR3K5c93-RjXWXqvOTVMepjgqHEnBunGLf3Ehc"},"kind":{"$ref":"DRCCjvyixjUbzaXbgVinhxlk4mgclIeIdLAB4tgjQmg"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.node.v1alpha1.RuntimeClassList"};
const schema1 = {"type":"string","enum":["node.k8s.io/v1alpha1"]};
...
const schema2 = {"items":{"$ref":"stpjYaPJjWwIP-cJ5tdbGyLXJUeqURBZKLWbW8ms8Ss"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.node.v1alpha1.RuntimeClass#"};
const schema4 = {};

import { validate as validate5 } from "././RuntimeClass.js";
...
const schema5 = {"type":"string","enum":["RuntimeClassList"]};
...
/*# sourceURL="io.k8s.api.node.v1alpha1.RuntimeClassList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
