...
const schema2 = {"items":{"$ref":"IMUBEJvWRBfiiz6rTyqgD6AwRphxud0uXj8rQ9QU1LM"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.node.v1beta1.RuntimeClass#"};
const schema4 = {};
...
/*# sourceURL="io.k8s.api.node.v1beta1.RuntimeClassList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
