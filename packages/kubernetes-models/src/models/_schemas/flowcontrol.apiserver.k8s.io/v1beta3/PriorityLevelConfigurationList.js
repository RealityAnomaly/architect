/* @ts-self-types="./PriorityLevelConfigurationList.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"zYcO_GfmnrPKeQxbxlWAolDPmzdfu9A3kxUQ3jlqozM"},"items":{"$ref":"Xo1Vz6KQD6HEVC3PF4c3uc89Tn6S_mlMwJY-oZ9XEYU"},"kind":{"$ref":"S-0fd5kkohP4tIxUbFiFcF-YkOya47YZevtqXHTc6Wo"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.flowcontrol.v1beta3.PriorityLevelConfigurationList"};
...
const schema2 = {"items":{"$ref":"qpvsjtG44-oIo77agrx-37JKQaii1jCyEZx9L01ZBOQ"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.flowcontrol.v1beta3.PriorityLevelConfiguration#"};
const schema4 = {};

import { validate as validate5 } from "././PriorityLevelConfiguration.js";
...
const schema5 = {"type":"string","enum":["PriorityLevelConfigurationList"]};
...
if(!(data === "PriorityLevelConfigurationList")){
...
/*# sourceURL="io.k8s.api.flowcontrol.v1beta3.PriorityLevelConfigurationList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
