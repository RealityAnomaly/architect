/* @ts-self-types="./QueuingConfiguration.d.ts" */
import { formats } from "@glassway/kubernetes-types/validate";
export const validate = validate1;
const schema1 = {"properties":{"handSize":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"queueLengthLimit":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"queues":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"}},"type":"object","$id":"io.k8s.api.flowcontrol.v1beta3.QueuingConfiguration"};
...
/*# sourceURL="io.k8s.api.flowcontrol.v1beta3.QueuingConfiguration" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
