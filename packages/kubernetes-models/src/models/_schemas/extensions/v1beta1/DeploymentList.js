...
const schema2 = {"items":{"$ref":"ZqfZeuTX1327GgGRY-485SIAzkLL-sxtd6ZuNuEu0go"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.extensions.v1beta1.Deployment#"};
const schema4 = {};
...
/*# sourceURL="io.k8s.api.extensions.v1beta1.DeploymentList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
