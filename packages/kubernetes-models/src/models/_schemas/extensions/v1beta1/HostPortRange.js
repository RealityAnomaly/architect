/* @ts-self-types="./HostPortRange.d.ts" */
import { formats } from "@glassway/kubernetes-types/validate";
export const validate = validate1;
const schema1 = {"properties":{"max":{"$ref":"6VbGrbfqnPJ4dMmNewHbRn4M59VZOmu0uhV1edBN8qE"},"min":{"$ref":"6VbGrbfqnPJ4dMmNewHbRn4M59VZOmu0uhV1edBN8qE"}},"required":["min","max"],"type":"object","$id":"io.k8s.api.extensions.v1beta1.HostPortRange"};
...
/*# sourceURL="io.k8s.api.extensions.v1beta1.HostPortRange" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
