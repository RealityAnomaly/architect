/* @ts-self-types="./DaemonSetSpec.d.ts" */
import { formats } from "@glassway/kubernetes-types/validate";
export const validate = validate1;
const schema1 = {"properties":{"minReadySeconds":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"revisionHistoryLimit":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"selector":{"$ref":"ft7HGURTbPyh-vhzFAYgnhVehb5DIkOC1Qu-kP-9F84"},"template":{"$ref":"SbN1rvaZBSVKM0AiyQONz32lv4L14pFnWFUIJk4xq20"},"templateGeneration":{"$ref":"otlW-2SioSJxw2ZRa8bQrFi14CUkm_yS2tfdShK98Vk"},"updateStrategy":{"$ref":"VPhFUo-bVMSaq-2scHOGrugwQTBvU6afBpXwrXtbA9o"}},"required":["template"],"type":"object","$id":"io.k8s.api.extensions.v1beta1.DaemonSetSpec"};
...
import { validate as validate5 } from "./../../../../apimachinery/_schemas/apis/meta/v1/LabelSelector.js";
...
import { validate as validate9 } from "./../../v1/PodTemplateSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.extensions.v1beta1.DaemonSetUpdateStrategy#"};
const schema8 = {};

import { validate as validate15 } from "././DaemonSetUpdateStrategy.js";
...
/*# sourceURL="io.k8s.api.extensions.v1beta1.DaemonSetSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
if(data.templateGeneration !== undefined){
let data4 = data.templateGeneration;
const _errs5 = errors;
if(!(validate12(data4, {instancePath:instancePath+"/templateGeneration",parentData:data,parentDataProperty:"templateGeneration",rootData}))){
...
let data5 = data.updateStrategy;
const _errs6 = errors;
if(!(validate14(data5, {instancePath:instancePath+"/updateStrategy",parentData:data,parentDataProperty:"updateStrategy",rootData}))){
