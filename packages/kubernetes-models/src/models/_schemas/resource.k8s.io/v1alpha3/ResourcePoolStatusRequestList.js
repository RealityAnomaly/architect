/* @ts-self-types="./ResourcePoolStatusRequestList.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"JhWvHbSFO3ELsap4IWTkIXEjLRfpdwhmVqXnItVBFvQ"},"items":{"$ref":"t1XslaNW72JuwyVWh0ncoIiaCSrK9wo6SjOVEsbphDs"},"kind":{"$ref":"WP0n1Gj3fkxdodA2P-tp4PKYxLWeRiTVDf66Cqn11Mw"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.resource.v1alpha3.ResourcePoolStatusRequestList"};
...
const schema2 = {"items":{"$ref":"vrJ08h2f3uMqbtKWC-J7-iwd4_FYVBIndJcaAH6xaZE"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.resource.v1alpha3.ResourcePoolStatusRequest#"};
const schema4 = {};

import { validate as validate5 } from "././ResourcePoolStatusRequest.js";
...
const schema5 = {"type":"string","enum":["ResourcePoolStatusRequestList"]};
...
if(!(data === "ResourcePoolStatusRequestList")){
...
/*# sourceURL="io.k8s.api.resource.v1alpha3.ResourcePoolStatusRequestList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
