...
const schema0 = {"properties":{"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"maCfrHbaLIhQc8aW5m2Y9jeq62WH9NMF6wHZnZTksjc"}},"required":["spec"],"type":"object","$id":"io.k8s.api.resource.v1beta2.ResourceClaimTemplateSpec"};
...
const schema3 = {"$ref":"io.k8s.api.resource.v1beta2.ResourceClaimSpec#"};
const schema4 = {};
...
/*# sourceURL="io.k8s.api.resource.v1beta2.ResourceClaimTemplateSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
