...
const schema0 = {"properties":{"allocationTimestamp":{"$ref":"tpjjy07qx44TS_S1WH8Z24TCcf0ahn452vZ82zIbIK0"},"devices":{"$ref":"8BHVp4-vJj4MJWEgytN_GwZGt-oGbCzAy5R0orhLJF4"},"nodeSelector":{"$ref":"TkSNaYWIxhO85OVX_cSWzmQgv784eOxf9GMx98WTU1I"}},"type":"object","$id":"io.k8s.api.resource.v1beta2.AllocationResult"};
...
const schema3 = {"nullableRef":"io.k8s.api.resource.v1beta2.DeviceAllocationResult#"};
const schema4 = {};

import { validate as validate6 } from "././DeviceAllocationResult.js";
...
import { validate as validate10 } from "./../../v1/NodeSelector.js";
...
/*# sourceURL="io.k8s.api.resource.v1beta2.AllocationResult" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
