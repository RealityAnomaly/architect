...
const schema0 = {"properties":{"driver":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"parameters":{"$ref":"iqsaYtRYnjKnPQivTbpYZthqN78wC5VBsG5WXKWxuB4"}},"required":["driver","parameters"],"type":"object","$id":"io.k8s.api.resource.v1beta2.OpaqueDeviceConfiguration"};
...
/*# sourceURL="io.k8s.api.resource.v1beta2.OpaqueDeviceConfiguration" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
