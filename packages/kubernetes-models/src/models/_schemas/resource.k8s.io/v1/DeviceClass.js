/* @ts-self-types="./DeviceClass.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"r5slmBzt4gwD9IfCYEHurvJ8bcGL1iYKjzPe5Eec0DI"},"kind":{"$ref":"7QOqVClwumGTrjYp3MRMiYXPfP8-apUrWikor7U7D9A"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"yZ2yzlrumi0X4M2mR6pFHpsckMlvsGT71UyoT1NtDbk"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.resource.v1.DeviceClass"};
...
const schema2 = {"type":"string","enum":["DeviceClass"]};
...
const schema5 = {"$ref":"io.k8s.api.resource.v1.DeviceClassSpec#"};
const schema6 = {};

import { validate as validate10 } from "././DeviceClassSpec.js";
...
/*# sourceURL="io.k8s.api.resource.v1.DeviceClass" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
