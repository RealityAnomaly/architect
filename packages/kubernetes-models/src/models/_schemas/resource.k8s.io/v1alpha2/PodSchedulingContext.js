/* @ts-self-types="./PodSchedulingContext.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"S8fQs5b8d_o6Mwyyipqll0kFyW-w4flYhC3Wcb4vRpg"},"kind":{"$ref":"fd8APodru1IBJu8tyNaE5w4iCGuJ6eFrccRQzxxIk2I"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"njms_pVttVYHrU6yImrDpwBvBHw4_9bRbiZtk3O9lXw"},"status":{"$ref":"jOPNrBXoroXmgjslrrw4IG37ztHKsYrYE-VAAzhitPo"}},"required":["spec","apiVersion","kind"],"type":"object","$id":"io.k8s.api.resource.v1alpha2.PodSchedulingContext"};
...
const schema2 = {"type":"string","enum":["PodSchedulingContext"]};
...
const schema5 = {"$ref":"io.k8s.api.resource.v1alpha2.PodSchedulingContextSpec#"};
const schema6 = {};

import { validate as validate10 } from "././PodSchedulingContextSpec.js";
...
const schema7 = {"nullableRef":"io.k8s.api.resource.v1alpha2.PodSchedulingContextStatus#"};
const schema8 = {};

import { validate as validate14 } from "././PodSchedulingContextStatus.js";
...
/*# sourceURL="io.k8s.api.resource.v1alpha2.PodSchedulingContext" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
