/* @ts-self-types="./ResourceClassList.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"qFxjlRgnFy8rsS3DXNoRWXTbA1LI5QMudW7t-VRniiY"},"items":{"$ref":"fRiF72YGh_9YnyJ3irDQr6ZubcKPeldGXOOWR31PwXo"},"kind":{"$ref":"BsWuQkRRymWdglDmhrfAZB6tmk_N3-g3Oj-6BNd12JA"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.resource.v1alpha1.ResourceClassList"};
...
const schema2 = {"items":{"$ref":"ZeWnIBcH2rXsnfqwJZVK7F1bjOYE4ALkwVAInh1BgEg"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.resource.v1alpha1.ResourceClass#"};
const schema4 = {};

import { validate as validate5 } from "././ResourceClass.js";
...
const schema5 = {"type":"string","enum":["ResourceClassList"]};
...
/*# sourceURL="io.k8s.api.resource.v1alpha1.ResourceClassList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
