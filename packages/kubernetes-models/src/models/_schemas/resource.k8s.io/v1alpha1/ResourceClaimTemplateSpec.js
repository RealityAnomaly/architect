/* @ts-self-types="./ResourceClaimTemplateSpec.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"spec":{"$ref":"vhMzOIuYzthmTP05Hn7F0ctsaVazsqEMn_sB05ugqNg"}},"required":["spec"],"type":"object","$id":"io.k8s.api.resource.v1alpha1.ResourceClaimTemplateSpec"};
...
const schema3 = {"$ref":"io.k8s.api.resource.v1alpha1.ResourceClaimSpec#"};
const schema4 = {};

import { validate as validate6 } from "././ResourceClaimSpec.js";
...
/*# sourceURL="io.k8s.api.resource.v1alpha1.ResourceClaimTemplateSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
