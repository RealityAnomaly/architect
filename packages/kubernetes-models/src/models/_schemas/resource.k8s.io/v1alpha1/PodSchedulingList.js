...
const schema2 = {"items":{"$ref":"Kvym5qeCBmekpjszgwbajjEBIEo1jW_1KtgufvT-1bE"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.resource.v1alpha1.PodScheduling#"};
const schema4 = {};

import { validate as validate5 } from "././PodScheduling.js";
...
const schema5 = {"type":"string","enum":["PodSchedulingList"]};
...
/*# sourceURL="io.k8s.api.resource.v1alpha1.PodSchedulingList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
