...
const schema0 = {"properties":{"caBundle":{"$ref":"-qMnViG9CEC-V8_TFn4WYpvO2NOwI2XARBIst170yi0"},"service":{"$ref":"ydm6Fe1e1hT5avRa6bubqg6wsbx2kaYP8mT_VH6yucg"},"url":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"}},"type":"object","$id":"io.k8s.api.auditregistration.v1alpha1.WebhookClientConfig"};
...
const schema2 = {"nullableRef":"io.k8s.api.auditregistration.v1alpha1.ServiceReference#"};
const schema3 = {};
...
/*# sourceURL="io.k8s.api.auditregistration.v1alpha1.WebhookClientConfig" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
