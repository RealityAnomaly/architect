/* @ts-self-types="./ClusterTrustBundleList.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"n3xtg1T9jN8N1pU9IaLp10RjIaf4oN87ggWC-Ea_RAQ"},"items":{"$ref":"RCgywK8bQYP0FBcI4PLmwiNk0kPF2ObytllLclKfGKY"},"kind":{"$ref":"doPJkQlhqG9L9hBXcaFIbj8x_yY8OeoA8P9GaqI5jqo"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.certificates.v1alpha1.ClusterTrustBundleList"};
const schema1 = {"type":"string","enum":["certificates.k8s.io/v1alpha1"]};
...
if(!(data === "certificates.k8s.io/v1alpha1")){
...
const schema2 = {"items":{"$ref":"rWJjS-You2ZHN5m1IZHXXjFvaBSJdlUS3tX5LpQ6mkM"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.certificates.v1alpha1.ClusterTrustBundle#"};
const schema4 = {};

import { validate as validate5 } from "././ClusterTrustBundle.js";
...
const schema5 = {"type":"string","enum":["ClusterTrustBundleList"]};
...
if(!(data === "ClusterTrustBundleList")){
...
/*# sourceURL="io.k8s.api.certificates.v1alpha1.ClusterTrustBundleList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
