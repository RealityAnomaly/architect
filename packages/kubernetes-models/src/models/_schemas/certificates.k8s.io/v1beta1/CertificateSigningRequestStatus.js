/* @ts-self-types="./CertificateSigningRequestStatus.d.ts" */
import { formats } from "@glassway/kubernetes-types/validate";
export const validate = validate0;
const schema0 = {"properties":{"certificate":{"$ref":"-qMnViG9CEC-V8_TFn4WYpvO2NOwI2XARBIst170yi0"},"conditions":{"$ref":"ub8WIKuKDeI4HOWAfiWfLCu84UyYyeUOmJnxEicb6fo"}},"type":"object","$id":"io.k8s.api.certificates.v1beta1.CertificateSigningRequestStatus"};
...
const schema2 = {"items":{"$ref":"Jr9a9oLsIBiC9F90dpL1VzJRI_l4q03ESmHy19VJaLY"},"type":"array","nullable":true};
const schema3 = {"$ref":"io.k8s.api.certificates.v1beta1.CertificateSigningRequestCondition#"};
const schema4 = {};

import { validate as validate5 } from "././CertificateSigningRequestCondition.js";
...
/*# sourceURL="io.k8s.api.certificates.v1beta1.CertificateSigningRequestStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
