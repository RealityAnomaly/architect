...
/*# sourceURL="io.k8s.api.apiserverinternal.v1alpha1.StorageVersionCondition" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
const err3 = {instancePath,schemaPath:"#/required",keyword:"required",params:{missingProperty: "message"}};
if(vErrors === null){
vErrors = [err3];
}
else {
