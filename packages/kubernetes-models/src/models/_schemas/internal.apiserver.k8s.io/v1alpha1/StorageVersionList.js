...
const schema2 = {"items":{"$ref":"AJo_BenfJ_p_dN1qrvGASKZArHmQkVf_BRjkGFpp-Ws"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.apiserverinternal.v1alpha1.StorageVersion#"};
const schema4 = {};

import { validate as validate5 } from "././StorageVersion.js";
...
const schema5 = {"type":"string","enum":["StorageVersionList"]};
...
/*# sourceURL="io.k8s.api.apiserverinternal.v1alpha1.StorageVersionList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
