...
const schema0 = {"properties":{"apiVersion":{"$ref":"zF3dereDaUwF8jnOFGHqVQj8USBp1GUyP_XjRNx7wjk"},"kind":{"$ref":"f-PkBragTfJiCFvzoJqh5gnSC60ygBa0J3UWaRznG1M"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"status":{"$ref":"O8VaREUMtpeHKvnICme3Gfjo_3JqqTjljKJA9DGrJcA"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.authentication.v1beta1.SelfSubjectReview"};
...
const schema5 = {"nullableRef":"io.k8s.api.authentication.v1beta1.SelfSubjectReviewStatus#"};
const schema6 = {};
...
/*# sourceURL="io.k8s.api.authentication.v1beta1.SelfSubjectReview" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
