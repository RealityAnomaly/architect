/* @ts-self-types="./SelfSubjectReview.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"2dBH5krb-9V_zz6g-s8KjmQxGEcztyiu3l4QdNBLCeo"},"kind":{"$ref":"f-PkBragTfJiCFvzoJqh5gnSC60ygBa0J3UWaRznG1M"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"status":{"$ref":"lijb1OmI70kvPqxqsCDll-EcViu0wmjgxvpUDdfkTbQ"}},"type":"object","required":["apiVersion","kind"],"$id":"io.k8s.api.authentication.v1.SelfSubjectReview"};
...
const schema2 = {"type":"string","enum":["SelfSubjectReview"]};
...
const schema5 = {"nullableRef":"io.k8s.api.authentication.v1.SelfSubjectReviewStatus#"};
const schema6 = {};

import { validate as validate10 } from "././SelfSubjectReviewStatus.js";
...
/*# sourceURL="io.k8s.api.authentication.v1.SelfSubjectReview" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
const _errs4 = errors;
if(!(validate9(data3, {instancePath:instancePath+"/status",parentData:data,parentDataProperty:"status",rootData}))){
