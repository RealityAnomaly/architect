/* @ts-self-types="./CronJobSpec.d.ts" */
import { formats } from "@glassway/kubernetes-types/validate";
export const validate = validate1;
const schema1 = {"properties":{"concurrencyPolicy":{"$ref":"ldoCEsh0ARg8F2aeji6S38NFl7aLPSuz1hGlgX2tjuQ"},"failedJobsHistoryLimit":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"jobTemplate":{"$ref":"zyx5ND8qFIVYt-GL3TxVP6u-ZGFr5pZvxjJ9RwCl-3k"},"schedule":{"$ref":"sLlNkWhANXZ15lvmcujppy1mXxqn6f-GaeQpWRYm_dw"},"startingDeadlineSeconds":{"$ref":"otlW-2SioSJxw2ZRa8bQrFi14CUkm_yS2tfdShK98Vk"},"successfulJobsHistoryLimit":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"suspend":{"$ref":"CTX4WtafS9K1Gv7k2X1H0J3M9LziUVVRBMOR0rDDzTk"}},"required":["schedule","jobTemplate"],"type":"object","$id":"io.k8s.api.batch.v2alpha1.CronJobSpec"};
...
const schema3 = {"$ref":"io.k8s.api.batch.v2alpha1.JobTemplateSpec#"};
const schema4 = {};

import { validate as validate6 } from "././JobTemplateSpec.js";
...
/*# sourceURL="io.k8s.api.batch.v2alpha1.CronJobSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
const _errs1 = errors;
if(!(validate2(data0, {instancePath:instancePath+"/concurrencyPolicy",parentData:data,parentDataProperty:"concurrencyPolicy",rootData}))){
