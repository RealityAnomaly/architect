/* @ts-self-types="./ControllerRevisionList.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"RDQeBsM8HVHjCtmNbr9yR2YpAM4M6c1514F3xJQr2qg"},"items":{"$ref":"8Pm633zscTvadDGbKskAotA7dwpRHx_ok9i7ufKWwQo"},"kind":{"$ref":"txqLzhvETF84IuHjgpRZx5G88dKTXtDPZltpzhdUVbM"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.apps.v1beta2.ControllerRevisionList"};
...
const schema2 = {"items":{"$ref":"CITr_mEcQ7B6ex1q8GftyKvUly3iXhDebU1CQrmhwIE"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.apps.v1beta2.ControllerRevision#"};
const schema4 = {};

import { validate as validate5 } from "././ControllerRevision.js";
...
const schema5 = {"type":"string","enum":["ControllerRevisionList"]};
...
if(!(data === "ControllerRevisionList")){
...
/*# sourceURL="io.k8s.api.apps.v1beta2.ControllerRevisionList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
