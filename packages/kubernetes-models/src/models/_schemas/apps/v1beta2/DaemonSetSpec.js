...
const schema1 = {"properties":{"minReadySeconds":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"revisionHistoryLimit":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"selector":{"$ref":"v9UPpZq80i3gaZjVxpGblXzp_E4dULDId73TGAJeg5U"},"template":{"$ref":"SbN1rvaZBSVKM0AiyQONz32lv4L14pFnWFUIJk4xq20"},"updateStrategy":{"$ref":"9woUcr7fuyu7K86nKV_ndDHO0GiwHfnmJdqNSdG4bxQ"}},"required":["selector","template"],"type":"object","$id":"io.k8s.api.apps.v1beta2.DaemonSetSpec"};
...
const schema6 = {"nullableRef":"io.k8s.api.apps.v1beta2.DaemonSetUpdateStrategy#"};
const schema7 = {};

import { validate as validate13 } from "././DaemonSetUpdateStrategy.js";
...
/*# sourceURL="io.k8s.api.apps.v1beta2.DaemonSetSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
