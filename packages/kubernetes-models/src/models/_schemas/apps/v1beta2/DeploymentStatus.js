...
const schema2 = {"items":{"$ref":"jkFJfAT_WKrClSQdht2LX5xD2dmIoiMkONM9e_VrdGA"},"type":"array","nullable":true};
const schema3 = {"$ref":"io.k8s.api.apps.v1beta2.DeploymentCondition#"};
const schema4 = {};
...
/*# sourceURL="io.k8s.api.apps.v1beta2.DeploymentStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
