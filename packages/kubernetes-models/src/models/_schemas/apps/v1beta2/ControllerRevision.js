/* @ts-self-types="./ControllerRevision.d.ts" */
import { formats } from "@glassway/kubernetes-types/validate";
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"RDQeBsM8HVHjCtmNbr9yR2YpAM4M6c1514F3xJQr2qg"},"data":{"$ref":"AR60lTNTcsDH6BJnxZoUAUNlYvqVW-t68_Wkfh7upnM"},"kind":{"$ref":"5uRz2pEAs69NhTHDoVfoiKqTSBS78sLY_7XNs4iwSCU"},"metadata":{"$ref":"P3srTZpWadQH4s4N9KfJR0iCqydQo9YAz7xMB2qf0GQ"},"revision":{"$ref":"0YQm7z5aN2fg7S8XlbxrquRU6pdIr97uCbtQYyjv3S4"}},"required":["revision","apiVersion","kind"],"type":"object","$id":"io.k8s.api.apps.v1beta2.ControllerRevision"};
const schema1 = {"type":"string","enum":["apps/v1beta2"]};
...
const schema2 = {"nullableRef":"io.k8s.apimachinery.pkg.runtime.RawExtension#"};
const schema3 = {};

import { validate as validate4 } from "./../../../../apimachinery/_schemas/runtime/RawExtension.js";
...
const schema4 = {"type":"string","enum":["ControllerRevision"]};
...
import { validate as validate10 } from "./../../../../apimachinery/_schemas/apis/meta/v1/ObjectMeta.js";
...
const schema7 = {"format":"int64","type":"integer"};
...
/*# sourceURL="io.k8s.api.apps.v1beta2.ControllerRevision" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
if(data && typeof data == "object" && !Array.isArray(data)){
if(data.revision === undefined){
const err0 = {instancePath,schemaPath:"#/required",keyword:"required",params:{missingProperty: "revision"}};
if(vErrors === null){
vErrors = [err0];
}
else {
...
const _errs5 = errors;
if(!(validate13(data4, {instancePath:instancePath+"/revision",parentData:data,parentDataProperty:"revision",rootData}))){
