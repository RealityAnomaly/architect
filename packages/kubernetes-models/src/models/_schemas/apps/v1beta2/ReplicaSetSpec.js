/* @ts-self-types="./ReplicaSetSpec.d.ts" */
import { formats } from "@glassway/kubernetes-types/validate";
export const validate = validate1;
const schema1 = {"properties":{"minReadySeconds":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"replicas":{"$ref":"j4SBnKFzNWrJQU4F8rp8qSB0IqehV1dh50NKzJhlTjs"},"selector":{"$ref":"v9UPpZq80i3gaZjVxpGblXzp_E4dULDId73TGAJeg5U"},"template":{"$ref":"trtzTcIsxeXk13WCzQpY_Zt3woih-nHQQGJY4vO3rEM"}},"required":["selector"],"type":"object","$id":"io.k8s.api.apps.v1beta2.ReplicaSetSpec"};
...
/*# sourceURL="io.k8s.api.apps.v1beta2.ReplicaSetSpec" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
