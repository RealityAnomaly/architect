/* @ts-self-types="./StatefulSetList.d.ts" */
export const validate = validate0;
const schema0 = {"properties":{"apiVersion":{"$ref":"RDQeBsM8HVHjCtmNbr9yR2YpAM4M6c1514F3xJQr2qg"},"items":{"$ref":"e8rPPj9zRZTA8Gyu4obCz2b3TiMT9wVMhBZkgNJuHFY"},"kind":{"$ref":"jXLyHXPZ33j7N73KSmf9Gjmu1yng5CUiJd1nOA4xeGk"},"metadata":{"$ref":"ltKCbb6Afl8nUl7eHOXxCc7fTyKPDEePIkmfx-Al-5U"}},"required":["items","apiVersion","kind"],"type":"object","$id":"io.k8s.api.apps.v1beta2.StatefulSetList"};
...
const schema2 = {"items":{"$ref":"OkPr539J63BMusF8X3wXbIkqmb8138mzCMRozNirgFw"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.apps.v1beta2.StatefulSet#"};
const schema4 = {};

import { validate as validate5 } from "././StatefulSet.js";
...
const schema5 = {"type":"string","enum":["StatefulSetList"]};
...
/*# sourceURL="io.k8s.api.apps.v1beta2.StatefulSetList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
