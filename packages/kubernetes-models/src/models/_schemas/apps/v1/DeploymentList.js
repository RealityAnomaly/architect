...
const schema2 = {"items":{"$ref":"RjY_LpxuFrhCyGST-1KEzY_nKgimI6cktJDN7N3AxS4"},"type":"array"};
const schema3 = {"$ref":"io.k8s.api.apps.v1.Deployment#"};
const schema4 = {};
...
/*# sourceURL="io.k8s.api.apps.v1.DeploymentList" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
