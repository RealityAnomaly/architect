...
const schema2 = {"items":{"$ref":"7RLrX4jPHWcPwTCwW4T4NjG5HHDaTxogVDIBA6vw7ls"},"type":"array","nullable":true};
const schema3 = {"$ref":"io.k8s.api.apps.v1.DeploymentCondition#"};
const schema4 = {};

import { validate as validate6 } from "././DeploymentCondition.js";
...
/*# sourceURL="io.k8s.api.apps.v1.DeploymentStatus" */;
let vErrors = null;
let errors = 0;
const _errs0 = errors;
...
let data7 = data.unavailableReplicas;
const _errs8 = errors;
if(!(validate0(data7, {instancePath:instancePath+"/unavailableReplicas",parentData:data,parentDataProperty:"unavailableReplicas",rootData}))){
vErrors = vErrors === null ? validate0.errors : vErrors.concat(validate0.errors);
errors = vErrors.length;
}
else {
