...
const schema3 = {"items":{"$ref":"RoBLWc4O56D8K33ogK-cCgo-7V9StsN5GbspqgVIPio"},"type":"array","nullable":true};
const schema4 = {"$ref":"io.k8s.api.apps.v1.DaemonSetCondition#"};
const schema5 = {};
