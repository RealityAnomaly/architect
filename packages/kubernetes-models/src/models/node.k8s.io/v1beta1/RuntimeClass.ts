...
import { IIoK8sApiNodeV1beta1Overhead } from "./Overhead.ts";
import { IIoK8sApiNodeV1beta1Scheduling } from "./Scheduling.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/kubernetes-types/meta";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/node.k8s.io/v1beta1/RuntimeClass.js";
...
static apiVersion: IRuntimeClass["apiVersion"] = "node.k8s.io/v1beta1";
...
export type {
  IRuntimeClass as IIoK8sApiNodeV1beta1RuntimeClass,
  RuntimeClass as IoK8sApiNodeV1beta1RuntimeClass
};
