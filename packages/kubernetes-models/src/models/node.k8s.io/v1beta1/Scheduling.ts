...
import { validate } from "../../_schemas/node.k8s.io/v1beta1/Scheduling.js";
...
export type {
  IScheduling as IIoK8sApiNodeV1beta1Scheduling,
  Scheduling as IoK8sApiNodeV1beta1Scheduling
};
