import { IIoK8sApiNodeV1alpha1RuntimeClass } from "./RuntimeClass.ts";
import { IIoK8sApimachineryPkgApisMetaV1ListMeta } from "../../../apimachinery/apis/meta/v1/ListMeta.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/kubernetes-types/meta";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/node.k8s.io/v1alpha1/RuntimeClassList.js";
...
static apiVersion: IRuntimeClassList["apiVersion"] = "node.k8s.io/v1alpha1";
...
export type {
  IRuntimeClassList as IIoK8sApiNodeV1alpha1RuntimeClassList,
  RuntimeClassList as IoK8sApiNodeV1alpha1RuntimeClassList
};
