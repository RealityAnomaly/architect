...
import { validate } from "../../_schemas/node.k8s.io/v1alpha1/Scheduling.js";
...
export type {
  IScheduling as IIoK8sApiNodeV1alpha1Scheduling,
  Scheduling as IoK8sApiNodeV1alpha1Scheduling
};
