...
import { validate } from "../../_schemas/rbac.authorization.k8s.io/v1alpha1/AggregationRule.js";
...
export type {
  IAggregationRule as IIoK8sApiRbacV1alpha1AggregationRule,
  AggregationRule as IoK8sApiRbacV1alpha1AggregationRule
};
