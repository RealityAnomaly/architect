...
import { validate } from "../../_schemas/rbac.authorization.k8s.io/v1alpha1/RoleBinding.js";
...
static apiVersion: IRoleBinding["apiVersion"] = "rbac.authorization.k8s.io/v1alpha1";
static kind: IRoleBinding["kind"] = "RoleBinding";
static is: TypeMetaGuard<IRoleBinding> = createTypeMetaGuard<IRoleBinding>(RoleBinding);
...
export type {
  IRoleBinding as IIoK8sApiRbacV1alpha1RoleBinding,
  RoleBinding as IoK8sApiRbacV1alpha1RoleBinding
};
