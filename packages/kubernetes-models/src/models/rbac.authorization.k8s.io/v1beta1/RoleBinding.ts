...
import { validate } from "../../_schemas/rbac.authorization.k8s.io/v1beta1/RoleBinding.js";
...
static apiVersion: IRoleBinding["apiVersion"] = "rbac.authorization.k8s.io/v1beta1";
...
export type {
  IRoleBinding as IIoK8sApiRbacV1beta1RoleBinding,
  RoleBinding as IoK8sApiRbacV1beta1RoleBinding
};
