...
import { validate } from "../../_schemas/rbac.authorization.k8s.io/v1/AggregationRule.js";
...
export type {
  IAggregationRule as IIoK8sApiRbacV1AggregationRule,
  AggregationRule as IoK8sApiRbacV1AggregationRule
};
