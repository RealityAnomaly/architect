...
import { validate } from "../../_schemas/internal.apiserver.k8s.io/v1alpha1/StorageVersion.js";
...
static is: TypeMetaGuard<IStorageVersion> = createTypeMetaGuard<IStorageVersion>(StorageVersion);
