import { IIoK8sApiAdmissionregistrationV1beta1MutatingAdmissionPolicyBinding } from "./MutatingAdmissionPolicyBinding.ts";
import { IIoK8sApimachineryPkgApisMetaV1ListMeta } from "../../../apimachinery/apis/meta/v1/ListMeta.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/kubernetes-types/meta";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/admissionregistration.k8s.io/v1beta1/MutatingAdmissionPolicyBindingList.js";
 ...
 */
"items": Array<IIoK8sApiAdmissionregistrationV1beta1MutatingAdmissionPolicyBinding>;
...
static apiVersion: IMutatingAdmissionPolicyBindingList["apiVersion"] = "admissionregistration.k8s.io/v1beta1";
static kind: IMutatingAdmissionPolicyBindingList["kind"] = "MutatingAdmissionPolicyBindingList";
static is: TypeMetaGuard<IMutatingAdmissionPolicyBindingList> = createTypeMetaGuard<IMutatingAdmissionPolicyBindingList>(MutatingAdmissionPolicyBindingList);
...
export type {
  IMutatingAdmissionPolicyBindingList as IIoK8sApiAdmissionregistrationV1beta1MutatingAdmissionPolicyBindingList,
  MutatingAdmissionPolicyBindingList as IoK8sApiAdmissionregistrationV1beta1MutatingAdmissionPolicyBindingList
};
