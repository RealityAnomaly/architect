...
import { validate } from "../../_schemas/admissionregistration.k8s.io/v1beta1/ParamRef.js";
...
export type {
  IParamRef as IIoK8sApiAdmissionregistrationV1beta1ParamRef,
  ParamRef as IoK8sApiAdmissionregistrationV1beta1ParamRef
};
