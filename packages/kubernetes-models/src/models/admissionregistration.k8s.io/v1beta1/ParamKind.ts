...
import { validate } from "../../_schemas/admissionregistration.k8s.io/v1beta1/ParamKind.js";
...
export type {
  IParamKind as IIoK8sApiAdmissionregistrationV1beta1ParamKind,
  ParamKind as IoK8sApiAdmissionregistrationV1beta1ParamKind
};
