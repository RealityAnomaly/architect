import { IIoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicyBinding } from "./ValidatingAdmissionPolicyBinding.ts";
import { IIoK8sApimachineryPkgApisMetaV1ListMeta } from "../../../apimachinery/apis/meta/v1/ListMeta.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/kubernetes-types/meta";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/admissionregistration.k8s.io/v1/ValidatingAdmissionPolicyBindingList.js";
 ...
 */
"items": Array<IIoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicyBinding>;
...
static apiVersion: IValidatingAdmissionPolicyBindingList["apiVersion"] = "admissionregistration.k8s.io/v1";
...
export type {
  IValidatingAdmissionPolicyBindingList as IIoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicyBindingList,
  ValidatingAdmissionPolicyBindingList as IoK8sApiAdmissionregistrationV1ValidatingAdmissionPolicyBindingList
};
