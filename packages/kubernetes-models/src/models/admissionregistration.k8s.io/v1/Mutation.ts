import { IIoK8sApiAdmissionregistrationV1ApplyConfiguration } from "./ApplyConfiguration.ts";
import { IIoK8sApiAdmissionregistrationV1JSONPatch } from "./JSONPatch.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/admissionregistration.k8s.io/v1/Mutation.js";
...
export type {
  IMutation as IIoK8sApiAdmissionregistrationV1Mutation,
  Mutation as IoK8sApiAdmissionregistrationV1Mutation
};
