...
import { validate } from "../../_schemas/admissionregistration.k8s.io/v1/MutatingWebhook.js";
 ...
 * MutatingWebhook describes an admission webhook and the resources and operations it applies to.
 */
export class MutatingWebhook extends Model<IMutatingWebhook> implements IMutatingWebhook {
  "admissionReviewVersions": Array<string>;
"clientConfig": IIoK8sApiAdmissionregistrationV1WebhookClientConfig;
"failurePolicy"?: string;
"matchConditions"?: Array<IIoK8sApiAdmissionregistrationV1MatchCondition>;
...
setValidateFunc(MutatingWebhook, validate as ValidateFunc<IMutatingWebhook>);

export type {
  IMutatingWebhook as IIoK8sApiAdmissionregistrationV1MutatingWebhook,
  MutatingWebhook as IoK8sApiAdmissionregistrationV1MutatingWebhook
};
