...
import { validate } from "../../_schemas/admissionregistration.k8s.io/v1alpha1/ParamRef.js";
...
export type {
  IParamRef as IIoK8sApiAdmissionregistrationV1alpha1ParamRef,
  ParamRef as IoK8sApiAdmissionregistrationV1alpha1ParamRef
};
