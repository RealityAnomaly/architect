...
import { validate } from "../../_schemas/resource.k8s.io/v1beta1/DeviceToleration.js";

/**
 * The ResourceClaim this DeviceToleration is attached to tolerates any taint that matches the triple <key,value,effect> using the matching operator <operator>.
 */
export interface IDeviceToleration {
  /**
 ...
 * The ResourceClaim this DeviceToleration is attached to tolerates any taint that matches the triple <key,value,effect> using the matching operator <operator>.
 */
export class DeviceToleration extends Model<IDeviceToleration> implements IDeviceToleration {
  "effect"?: string;
"key"?: string;
"operator"?: string;
"tolerationSeconds"?: number;
...
constructor(data?: ModelData<IDeviceToleration>) {
  super();
...
setValidateFunc(DeviceToleration, validate as ValidateFunc<IDeviceToleration>);

export type {
  IDeviceToleration as IIoK8sApiResourceV1beta1DeviceToleration,
  DeviceToleration as IoK8sApiResourceV1beta1DeviceToleration
};
