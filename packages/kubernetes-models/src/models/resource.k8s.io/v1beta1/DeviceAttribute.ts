...
import { validate } from "../../_schemas/resource.k8s.io/v1beta1/DeviceAttribute.js";
...
export type {
  IDeviceAttribute as IIoK8sApiResourceV1beta1DeviceAttribute,
  DeviceAttribute as IoK8sApiResourceV1beta1DeviceAttribute
};
