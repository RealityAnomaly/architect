...
import { IIoK8sApiResourceV1beta1ResourceClaimTemplateSpec } from "./ResourceClaimTemplateSpec.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/kubernetes-types/meta";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/resource.k8s.io/v1beta1/ResourceClaimTemplate.js";
 ...
 */
"spec": IIoK8sApiResourceV1beta1ResourceClaimTemplateSpec;
}
...
static apiVersion: IResourceClaimTemplate["apiVersion"] = "resource.k8s.io/v1beta1";
...
export type {
  IResourceClaimTemplate as IIoK8sApiResourceV1beta1ResourceClaimTemplate,
  ResourceClaimTemplate as IoK8sApiResourceV1beta1ResourceClaimTemplate
};
