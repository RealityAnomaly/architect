...
import { IIoK8sApiResourceV1beta2ResourceClaimTemplateSpec } from "./ResourceClaimTemplateSpec.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/kubernetes-types/meta";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/resource.k8s.io/v1beta2/ResourceClaimTemplate.js";
 ...
 */
"spec": IIoK8sApiResourceV1beta2ResourceClaimTemplateSpec;
}
...
static apiVersion: IResourceClaimTemplate["apiVersion"] = "resource.k8s.io/v1beta2";
...
export type {
  IResourceClaimTemplate as IIoK8sApiResourceV1beta2ResourceClaimTemplate,
  ResourceClaimTemplate as IoK8sApiResourceV1beta2ResourceClaimTemplate
};
