...
import { validate } from "../../_schemas/resource.k8s.io/v1beta2/DeviceSubRequest.js";
...
export type {
  IDeviceSubRequest as IIoK8sApiResourceV1beta2DeviceSubRequest,
  DeviceSubRequest as IoK8sApiResourceV1beta2DeviceSubRequest
};
