...
import { validate } from "../../_schemas/resource.k8s.io/v1beta2/DeviceTaint.js";
...
export type {
  IDeviceTaint as IIoK8sApiResourceV1beta2DeviceTaint,
  DeviceTaint as IoK8sApiResourceV1beta2DeviceTaint
};
