...
import { validate } from "../../_schemas/resource.k8s.io/v1beta2/NodeAllocatableResourceMapping.js";
 ...
 */
export interface INodeAllocatableResourceMapping {
  /**
 ...
 */
"allocationMultiplier"?: IIoK8sApimachineryPkgApiResourceQuantity;
/**
 ...
 * NodeAllocatableResourceMapping defines the translation between the DRA device/capacity units requested to the corresponding quantity of the node allocatable resource.
 */
export class NodeAllocatableResourceMapping extends Model<INodeAllocatableResourceMapping> implements INodeAllocatableResourceMapping {
  "allocationMultiplier"?: IIoK8sApimachineryPkgApiResourceQuantity;
"capacityKey"?: string;

constructor(data?: ModelData<INodeAllocatableResourceMapping>) {
  super();
...
setValidateFunc(NodeAllocatableResourceMapping, validate as ValidateFunc<INodeAllocatableResourceMapping>);

export type {
  INodeAllocatableResourceMapping as IIoK8sApiResourceV1beta2NodeAllocatableResourceMapping,
  NodeAllocatableResourceMapping as IoK8sApiResourceV1beta2NodeAllocatableResourceMapping
};
