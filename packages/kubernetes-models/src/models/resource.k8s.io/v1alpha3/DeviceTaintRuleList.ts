import { IIoK8sApiResourceV1alpha3DeviceTaintRule } from "./DeviceTaintRule.ts";
import { IIoK8sApimachineryPkgApisMetaV1ListMeta } from "../../../apimachinery/apis/meta/v1/ListMeta.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/kubernetes-types/meta";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/resource.k8s.io/v1alpha3/DeviceTaintRuleList.js";
 ...
 */
"items": Array<IIoK8sApiResourceV1alpha3DeviceTaintRule>;
...
static apiVersion: IDeviceTaintRuleList["apiVersion"] = "resource.k8s.io/v1alpha3";
static kind: IDeviceTaintRuleList["kind"] = "DeviceTaintRuleList";
static is: TypeMetaGuard<IDeviceTaintRuleList> = createTypeMetaGuard<IDeviceTaintRuleList>(DeviceTaintRuleList);
...
export type {
  IDeviceTaintRuleList as IIoK8sApiResourceV1alpha3DeviceTaintRuleList,
  DeviceTaintRuleList as IoK8sApiResourceV1alpha3DeviceTaintRuleList
};
