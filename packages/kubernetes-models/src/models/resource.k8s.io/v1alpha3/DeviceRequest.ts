...
import { validate } from "../../_schemas/resource.k8s.io/v1alpha3/DeviceRequest.js";
...
export type {
  IDeviceRequest as IIoK8sApiResourceV1alpha3DeviceRequest,
  DeviceRequest as IoK8sApiResourceV1alpha3DeviceRequest
};
