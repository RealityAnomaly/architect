...
import { validate } from "../../_schemas/resource.k8s.io/v1alpha3/ResourceClaimConsumerReference.js";
...
export type {
  IResourceClaimConsumerReference as IIoK8sApiResourceV1alpha3ResourceClaimConsumerReference,
  ResourceClaimConsumerReference as IoK8sApiResourceV1alpha3ResourceClaimConsumerReference
};
