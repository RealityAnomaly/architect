...
import { IIoK8sApiResourceV1alpha1ResourceClaimTemplateSpec } from "./ResourceClaimTemplateSpec.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/kubernetes-types/meta";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/resource.k8s.io/v1alpha1/ResourceClaimTemplate.js";
 ...
 */
"spec": IIoK8sApiResourceV1alpha1ResourceClaimTemplateSpec;
}
...
static apiVersion: IResourceClaimTemplate["apiVersion"] = "resource.k8s.io/v1alpha1";
...
export type {
  IResourceClaimTemplate as IIoK8sApiResourceV1alpha1ResourceClaimTemplate,
  ResourceClaimTemplate as IoK8sApiResourceV1alpha1ResourceClaimTemplate
};
