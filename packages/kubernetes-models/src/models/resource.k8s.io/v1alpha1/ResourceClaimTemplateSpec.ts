...
import { validate } from "../../_schemas/resource.k8s.io/v1alpha1/ResourceClaimTemplateSpec.js";
...
export type {
  IResourceClaimTemplateSpec as IIoK8sApiResourceV1alpha1ResourceClaimTemplateSpec,
  ResourceClaimTemplateSpec as IoK8sApiResourceV1alpha1ResourceClaimTemplateSpec
};
