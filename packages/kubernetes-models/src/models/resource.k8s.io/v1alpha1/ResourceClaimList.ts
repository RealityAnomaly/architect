import { IIoK8sApiResourceV1alpha1ResourceClaim } from "./ResourceClaim.ts";
import { IIoK8sApimachineryPkgApisMetaV1ListMeta } from "../../../apimachinery/apis/meta/v1/ListMeta.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { TypeMeta, TypeMetaGuard, createTypeMetaGuard } from "@glassway/kubernetes-types/meta";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/resource.k8s.io/v1alpha1/ResourceClaimList.js";
 ...
 */
"items": Array<IIoK8sApiResourceV1alpha1ResourceClaim>;
...
static apiVersion: IResourceClaimList["apiVersion"] = "resource.k8s.io/v1alpha1";
...
export type {
  IResourceClaimList as IIoK8sApiResourceV1alpha1ResourceClaimList,
  ResourceClaimList as IoK8sApiResourceV1alpha1ResourceClaimList
};
