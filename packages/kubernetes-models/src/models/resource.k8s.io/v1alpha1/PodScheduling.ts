...
import { validate } from "../../_schemas/resource.k8s.io/v1alpha1/PodScheduling.js";
...
static is: TypeMetaGuard<IPodScheduling> = createTypeMetaGuard<IPodScheduling>(PodScheduling);
