import { IIoK8sApiResourceV1DeviceClassConfiguration } from "./DeviceClassConfiguration.ts";
import { IIoK8sApiResourceV1DeviceSelector } from "./DeviceSelector.ts";
import { ModelData, Model, setValidateFunc } from "@glassway/kubernetes-types/model";
import { ValidateFunc } from "@glassway/kubernetes-types/validate";
import { validate } from "../../_schemas/resource.k8s.io/v1/DeviceClassSpec.js";
...
export type {
  IDeviceClassSpec as IIoK8sApiResourceV1DeviceClassSpec,
  DeviceClassSpec as IoK8sApiResourceV1DeviceClassSpec
};
