...
import { validate } from "../../_schemas/resource.k8s.io/v1/NetworkDeviceData.js";
...
export type {
  INetworkDeviceData as IIoK8sApiResourceV1NetworkDeviceData,
  NetworkDeviceData as IoK8sApiResourceV1NetworkDeviceData
};
