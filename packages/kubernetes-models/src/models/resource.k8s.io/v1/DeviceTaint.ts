...
import { validate } from "../../_schemas/resource.k8s.io/v1/DeviceTaint.js";
...
export type {
  IDeviceTaint as IIoK8sApiResourceV1DeviceTaint,
  DeviceTaint as IoK8sApiResourceV1DeviceTaint
};
